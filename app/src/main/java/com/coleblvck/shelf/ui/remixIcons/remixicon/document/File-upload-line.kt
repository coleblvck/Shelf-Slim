...
public val DocumentGroup.`File-upload-line`: ImageVector
    get() {
        if (`_file-upload-line` != null) {
            return `_file-upload-line`!!
        }
        `_file-upload-line` = Builder(name = "File-upload-line", defaultWidth = 24.0.dp,
...
private var `_file-upload-line`: ImageVector? = null
