...
public val MediaGroup.`Vidicon-fill`: ImageVector
    get() {
        if (`_vidicon-fill` != null) {
            return `_vidicon-fill`!!
        }
        `_vidicon-fill` = Builder(name = "Vidicon-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_vidicon-fill`: ImageVector? = null
