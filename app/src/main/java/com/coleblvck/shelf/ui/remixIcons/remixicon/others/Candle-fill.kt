...
public val OthersGroup.`Candle-fill`: ImageVector
    get() {
        if (`_candle-fill` != null) {
            return `_candle-fill`!!
        }
        `_candle-fill` = Builder(name = "Candle-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_candle-fill`: ImageVector? = null
