...
public val BuildingsGroup.`Home-5-fill`: ImageVector
    get() {
        if (`_home-5-fill` != null) {
            return `_home-5-fill`!!
        }
        `_home-5-fill` = Builder(name = "Home-5-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-5-fill`: ImageVector? = null
