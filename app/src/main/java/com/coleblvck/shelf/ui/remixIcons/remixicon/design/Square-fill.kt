...
public val DesignGroup.`Square-fill`: ImageVector
    get() {
        if (`_square-fill` != null) {
            return `_square-fill`!!
        }
        `_square-fill` = Builder(name = "Square-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_square-fill`: ImageVector? = null
