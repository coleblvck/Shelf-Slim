...
public val OthersGroup.`Dice-5-line`: ImageVector
    get() {
        if (`_dice-5-line` != null) {
            return `_dice-5-line`!!
        }
        `_dice-5-line` = Builder(name = "Dice-5-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(15.5f, 17.0f)
                curveTo(16.3284f, 17.0f, 17.0f, 16.3284f, 17.0f, 15.5f)
                curveTo(17.0f, 14.6716f, 16.3284f, 14.0f, 15.5f, 14.0f)
                curveTo(14.6716f, 14.0f, 14.0f, 14.6716f, 14.0f, 15.5f)
                curveTo(14.0f, 16.3284f, 14.6716f, 17.0f, 15.5f, 17.0f)
                close()
                moveTo(10.0f, 15.5f)
...
private var `_dice-5-line`: ImageVector? = null
