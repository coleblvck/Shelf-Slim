...
public val DeviceGroup.`Cast-fill`: ImageVector
    get() {
        if (`_cast-fill` != null) {
            return `_cast-fill`!!
        }
        `_cast-fill` = Builder(name = "Cast-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.093f, 13.0376f, 9.9624f, 9.907f, 6.0f, 8.627f)
                verticalLineTo(7.0f)
...
private var `_cast-fill`: ImageVector? = null
