...
public val BusinessGroup.`Briefcase-3-fill`: ImageVector
    get() {
        if (`_briefcase-3-fill` != null) {
            return `_briefcase-3-fill`!!
        }
        `_briefcase-3-fill` = Builder(name = "Briefcase-3-fill", defaultWidth = 24.0.dp,
...
private var `_briefcase-3-fill`: ImageVector? = null
