...
public val MapGroup.`Traffic-light-line`: ImageVector
    get() {
        if (`_traffic-light-line` != null) {
            return `_traffic-light-line`!!
        }
        `_traffic-light-line` = Builder(name = "Traffic-light-line", defaultWidth = 24.0.dp,
...
private var `_traffic-light-line`: ImageVector? = null
