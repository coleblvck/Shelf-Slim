...
public val DesignGroup.`T-box-fill`: ImageVector
    get() {
        if (`_t-box-fill` != null) {
            return `_t-box-fill`!!
        }
        `_t-box-fill` = Builder(name = "T-box-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_t-box-fill`: ImageVector? = null
