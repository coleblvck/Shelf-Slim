...
public val BuildingsGroup.`Home-4-fill`: ImageVector
    get() {
        if (`_home-4-fill` != null) {
            return `_home-4-fill`!!
        }
        `_home-4-fill` = Builder(name = "Home-4-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-4-fill`: ImageVector? = null
