...
public val CommunicationGroup.`Feedback-line`: ImageVector
    get() {
        if (`_feedback-line` != null) {
            return `_feedback-line`!!
        }
        `_feedback-line` = Builder(name = "Feedback-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_feedback-line`: ImageVector? = null
