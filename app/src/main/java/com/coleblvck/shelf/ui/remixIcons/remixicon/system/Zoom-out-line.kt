...
public val SystemGroup.`Zoom-out-line`: ImageVector
    get() {
        if (`_zoom-out-line` != null) {
            return `_zoom-out-line`!!
        }
        `_zoom-out-line` = Builder(name = "Zoom-out-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_zoom-out-line`: ImageVector? = null
