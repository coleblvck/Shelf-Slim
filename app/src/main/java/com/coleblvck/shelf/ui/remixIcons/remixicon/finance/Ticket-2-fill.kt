...
public val FinanceGroup.`Ticket-2-fill`: ImageVector
    get() {
        if (`_ticket-2-fill` != null) {
            return `_ticket-2-fill`!!
        }
        `_ticket-2-fill` = Builder(name = "Ticket-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ticket-2-fill`: ImageVector? = null
