...
public val MediaGroup.`Film-fill`: ImageVector
    get() {
        if (`_film-fill` != null) {
            return `_film-fill`!!
        }
        `_film-fill` = Builder(name = "Film-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_film-fill`: ImageVector? = null
