...
public val DocumentGroup.`File-add-fill`: ImageVector
    get() {
        if (`_file-add-fill` != null) {
            return `_file-add-fill`!!
        }
        `_file-add-fill` = Builder(name = "File-add-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-add-fill`: ImageVector? = null
