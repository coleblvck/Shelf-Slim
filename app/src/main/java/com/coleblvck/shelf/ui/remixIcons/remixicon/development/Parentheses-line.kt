...
public val DevelopmentGroup.`Parentheses-line`: ImageVector
    get() {
        if (`_parentheses-line` != null) {
            return `_parentheses-line`!!
        }
        `_parentheses-line` = Builder(name = "Parentheses-line", defaultWidth = 24.0.dp,
...
private var `_parentheses-line`: ImageVector? = null
