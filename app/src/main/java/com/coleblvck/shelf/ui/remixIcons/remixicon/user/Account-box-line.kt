...
public val UserGroup.`Account-box-line`: ImageVector
    get() {
        if (`_account-box-line` != null) {
            return `_account-box-line`!!
        }
        `_account-box-line` = Builder(name = "Account-box-line", defaultWidth = 24.0.dp,
...
private var `_account-box-line`: ImageVector? = null
