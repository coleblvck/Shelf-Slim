...
public val DeviceGroup.`Sim-card-2-line`: ImageVector
    get() {
        if (`_sim-card-2-line` != null) {
            return `_sim-card-2-line`!!
        }
        `_sim-card-2-line` = Builder(name = "Sim-card-2-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_sim-card-2-line`: ImageVector? = null
