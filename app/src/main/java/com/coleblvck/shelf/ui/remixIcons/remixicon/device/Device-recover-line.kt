...
public val DeviceGroup.`Device-recover-line`: ImageVector
    get() {
        if (`_device-recover-line` != null) {
            return `_device-recover-line`!!
        }
        `_device-recover-line` = Builder(name = "Device-recover-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.0f, 13.7973f, 16.0517f, 15.3731f, 14.6282f, 16.2544f)
                lineTo(12.5f, 12.0f)
                ...
                lineTo(12.9552f, 16.9089f)
                curveTo(12.646f, 16.9687f, 12.3267f, 17.0f, 12.0f, 17.0f)
...
private var `_device-recover-line`: ImageVector? = null
