...
public val SystemGroup.`Sidebar-fold-fill`: ImageVector
    get() {
        if (`_sidebar-fold-fill` != null) {
            return `_sidebar-fold-fill`!!
        }
        `_sidebar-fold-fill` = Builder(name = "Sidebar-fold-fill", defaultWidth = 24.0.dp,
...
private var `_sidebar-fold-fill`: ImageVector? = null
