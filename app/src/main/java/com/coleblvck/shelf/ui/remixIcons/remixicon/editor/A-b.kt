...
public val EditorGroup.`A-b`: ImageVector
    get() {
        if (`_a-b` != null) {
            return `_a-b`!!
        }
        `_a-b` = Builder(name = "A-b", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.0f, 18.0544f, 5.95f, 19.0f, 7.0f, 19.0f)
                ...
                close()
                moveTo(17.0f, 12.8852f)
                lineTo(15.753f, 16.0f)
                horizontalLineTo(18.245f)
                lineTo(17.0f, 12.8852f)
                close()
                moveTo(3.0f, 3.0f)
                horizontalLineTo(9.0f)
                curveTo(10.6569f, 3.0f, 12.0f, 4.3432f, 12.0f, 6.0f)
                curveTo(12.0f, 6.7688f, 11.7108f, 7.47f, 11.2353f, 8.0009f)
                curveTo(11.7112f, 8.5308f, 12.0f, 9.2317f, 12.0f, 10.0f)
                curveTo(12.0f, 11.6569f, 10.6569f, 13.0f, 9.0f, 13.0f)
                ...
                verticalLineTo(7.0f)
                horizontalLineTo(9.0f)
                curveTo(9.5523f, 7.0f, 10.0f, 6.5523f, 10.0f, 6.0f)
...
private var `_a-b`: ImageVector? = null
