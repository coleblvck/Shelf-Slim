...
public val DocumentGroup.`Folder-2-fill`: ImageVector
    get() {
        if (`_folder-2-fill` != null) {
            return `_folder-2-fill`!!
        }
        `_folder-2-fill` = Builder(name = "Folder-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_folder-2-fill`: ImageVector? = null
