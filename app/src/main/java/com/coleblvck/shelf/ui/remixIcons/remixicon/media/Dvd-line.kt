...
public val MediaGroup.`Dvd-line`: ImageVector
    get() {
        if (`_dvd-line` != null) {
            return `_dvd-line`!!
        }
        `_dvd-line` = Builder(name = "Dvd-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_dvd-line`: ImageVector? = null
