...
public val SystemGroup.`Progress-2-line`: ImageVector
    get() {
        if (`_progress-2-line` != null) {
            return `_progress-2-line`!!
        }
        `_progress-2-line` = Builder(name = "Progress-2-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_progress-2-line`: ImageVector? = null
