...
public val LogosGroup.`Alipay-fill`: ImageVector
    get() {
        if (`_alipay-fill` != null) {
            return `_alipay-fill`!!
        }
        `_alipay-fill` = Builder(name = "Alipay-fill", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.4224f, 15.3576f)
                curveTo(17.5929f, 14.2048f, 15.3667f, 13.5176f, 14.744f, 13.296f)
                ...
                curveTo(14.9346f, 15.2619f, 17.1059f, 16.2293f, 20.2819f, 17.6062f)
                curveTo(18.4835f, 20.2577f, 15.4452f, 22.0f, 12.0f, 22.0f)
                curveTo(6.4771f, 22.0f, 2.0f, 17.5228f, 2.0f, 12.0f)
                curveTo(2.0f, 6.4771f, 6.4771f, 2.0f, 12.0f, 2.0f)
                curveTo(17.5228f, 2.0f, 22.0f, 6.4771f, 22.0f, 12.0f)
                curveTo(22.0f, 13.1778f, 21.7964f, 14.3081f, 21.4224f, 15.3576f)
                close()
...
private var `_alipay-fill`: ImageVector? = null
