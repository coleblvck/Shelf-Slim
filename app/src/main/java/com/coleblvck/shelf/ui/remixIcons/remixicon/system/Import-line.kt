...
public val SystemGroup.`Import-line`: ImageVector
    get() {
        if (`_import-line` != null) {
            return `_import-line`!!
        }
        `_import-line` = Builder(name = "Import-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_import-line`: ImageVector? = null
