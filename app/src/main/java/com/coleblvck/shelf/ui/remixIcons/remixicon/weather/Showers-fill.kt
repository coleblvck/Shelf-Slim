...
public val WeatherGroup.`Showers-fill`: ImageVector
    get() {
        if (`_showers-fill` != null) {
            return `_showers-fill`!!
        }
        `_showers-fill` = Builder(name = "Showers-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_showers-fill`: ImageVector? = null
