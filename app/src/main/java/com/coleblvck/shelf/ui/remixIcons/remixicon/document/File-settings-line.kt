...
public val DocumentGroup.`File-settings-line`: ImageVector
    get() {
        if (`_file-settings-line` != null) {
            return `_file-settings-line`!!
        }
        `_file-settings-line` = Builder(name = "File-settings-line", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.5946f, 12.8115f)
                curveTo(8.5327f, 12.5511f, 8.5f, 12.2794f, 8.5f, 12.0f)
                curveTo(8.5f, 11.7207f, 8.5327f, 11.449f, 8.5945f, 11.1886f)
                lineTo(7.6029f, 10.6161f)
                lineTo(8.6029f, 8.884f)
                lineTo(9.5952f, 9.4569f)
                curveTo(9.9883f, 9.0851f, 10.4676f, 8.8034f, 11.0f, 8.6449f)
                verticalLineTo(7.5f)
                horizontalLineTo(13.0f)
                verticalLineTo(8.6449f)
                curveTo(13.5324f, 8.8034f, 14.0116f, 9.0851f, 14.4047f, 9.4569f)
                lineTo(15.3971f, 8.8839f)
                lineTo(16.3972f, 10.616f)
                lineTo(15.4054f, 11.1885f)
                curveTo(15.4673f, 11.449f, 15.5f, 11.7207f, 15.5f, 12.0f)
                curveTo(15.5f, 12.2793f, 15.4673f, 12.551f, 15.4055f, 12.8114f)
                lineTo(16.3972f, 13.3839f)
                lineTo(15.3972f, 15.116f)
                lineTo(14.4048f, 14.543f)
                curveTo(14.0117f, 14.9149f, 13.5325f, 15.1966f, 13.0001f, 15.355f)
                verticalLineTo(16.5f)
                horizontalLineTo(11.0001f)
                verticalLineTo(15.3551f)
                curveTo(10.4677f, 15.1967f, 9.9884f, 14.915f, 9.5953f, 14.5431f)
                lineTo(8.603f, 15.1161f)
                lineTo(7.6029f, 13.384f)
                lineTo(8.5946f, 12.8115f)
                close()
                moveTo(12.0f, 13.5f)
...
private var `_file-settings-line`: ImageVector? = null
