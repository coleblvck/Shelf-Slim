...
public val DocumentGroup.`File-transfer-line`: ImageVector
    get() {
        if (`_file-transfer-line` != null) {
            return `_file-transfer-line`!!
        }
        `_file-transfer-line` = Builder(name = "File-transfer-line", defaultWidth = 24.0.dp,
...
private var `_file-transfer-line`: ImageVector? = null
