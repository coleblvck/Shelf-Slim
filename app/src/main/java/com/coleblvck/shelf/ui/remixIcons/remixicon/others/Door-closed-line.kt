...
public val OthersGroup.`Door-closed-line`: ImageVector
    get() {
        if (`_door-closed-line` != null) {
            return `_door-closed-line`!!
        }
        `_door-closed-line` = Builder(name = "Door-closed-line", defaultWidth = 24.0.dp,
...
private var `_door-closed-line`: ImageVector? = null
