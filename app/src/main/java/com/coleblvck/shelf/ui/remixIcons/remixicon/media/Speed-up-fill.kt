...
public val MediaGroup.`Speed-up-fill`: ImageVector
    get() {
        if (`_speed-up-fill` != null) {
            return `_speed-up-fill`!!
        }
        `_speed-up-fill` = Builder(name = "Speed-up-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_speed-up-fill`: ImageVector? = null
