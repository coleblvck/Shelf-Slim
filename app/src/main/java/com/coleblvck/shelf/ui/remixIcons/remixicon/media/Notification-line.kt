...
public val MediaGroup.`Notification-line`: ImageVector
    get() {
        if (`_notification-line` != null) {
            return `_notification-line`!!
        }
        `_notification-line` = Builder(name = "Notification-line", defaultWidth = 24.0.dp,
...
private var `_notification-line`: ImageVector? = null
