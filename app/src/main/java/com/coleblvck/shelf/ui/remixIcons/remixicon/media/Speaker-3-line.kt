...
public val MediaGroup.`Speaker-3-line`: ImageVector
    get() {
        if (`_speaker-3-line` != null) {
            return `_speaker-3-line`!!
        }
        `_speaker-3-line` = Builder(name = "Speaker-3-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.0f, 8.0f)
                curveTo(16.4477f, 8.0f, 16.0f, 7.5523f, 16.0f, 7.0f)
                curveTo(16.0f, 6.4477f, 16.4477f, 6.0f, 17.0f, 6.0f)
                curveTo(17.5523f, 6.0f, 18.0f, 6.4477f, 18.0f, 7.0f)
                curveTo(18.0f, 7.5523f, 17.5523f, 8.0f, 17.0f, 8.0f)
                close()
                moveTo(17.0f, 18.0f)
...
private var `_speaker-3-line`: ImageVector? = null
