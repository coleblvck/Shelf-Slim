...
public val MediaGroup.`Radio-2-line`: ImageVector
    get() {
        if (`_radio-2-line` != null) {
            return `_radio-2-line`!!
        }
        `_radio-2-line` = Builder(name = "Radio-2-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.6569f, 9.0f, 12.0f, 10.3431f, 12.0f, 12.0f)
                curveTo(12.0f, 13.6569f, 10.6569f, 15.0f, 9.0f, 15.0f)
                close()
                moveTo(14.0f, 9.0f)
...
private var `_radio-2-line`: ImageVector? = null
