...
public val SystemGroup.`Zoom-in-line`: ImageVector
    get() {
        if (`_zoom-in-line` != null) {
            return `_zoom-in-line`!!
        }
        `_zoom-in-line` = Builder(name = "Zoom-in-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_zoom-in-line`: ImageVector? = null
