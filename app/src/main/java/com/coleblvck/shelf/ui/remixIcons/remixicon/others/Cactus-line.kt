...
public val OthersGroup.`Cactus-line`: ImageVector
    get() {
        if (`_cactus-line` != null) {
            return `_cactus-line`!!
        }
        `_cactus-line` = Builder(name = "Cactus-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.998f, 4.0f)
                curveTo(10.8935f, 4.0f, 9.998f, 4.8954f, 9.998f, 6.0f)
                verticalLineTo(20.0f)
                horizontalLineTo(13.998f)
                verticalLineTo(6.0f)
                curveTo(13.998f, 4.8954f, 13.1026f, 4.0f, 11.998f, 4.0f)
                close()
            }
        }
        .build()
...
private var `_cactus-line`: ImageVector? = null
