...
public val DesignGroup.`Layout-column-line`: ImageVector
    get() {
        if (`_layout-column-line` != null) {
            return `_layout-column-line`!!
        }
        `_layout-column-line` = Builder(name = "Layout-column-line", defaultWidth = 24.0.dp,
...
private var `_layout-column-line`: ImageVector? = null
