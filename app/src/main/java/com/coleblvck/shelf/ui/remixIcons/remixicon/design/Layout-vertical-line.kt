...
public val DesignGroup.`Layout-vertical-line`: ImageVector
    get() {
        if (`_layout-vertical-line` != null) {
            return `_layout-vertical-line`!!
        }
        `_layout-vertical-line` = Builder(name = "Layout-vertical-line", defaultWidth = 24.0.dp,
...
private var `_layout-vertical-line`: ImageVector? = null
