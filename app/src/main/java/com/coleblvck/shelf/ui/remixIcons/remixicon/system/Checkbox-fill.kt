...
public val SystemGroup.`Checkbox-fill`: ImageVector
    get() {
        if (`_checkbox-fill` != null) {
            return `_checkbox-fill`!!
        }
        `_checkbox-fill` = Builder(name = "Checkbox-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_checkbox-fill`: ImageVector? = null
