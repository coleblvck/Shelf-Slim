...
public val DocumentGroup.`Article-line`: ImageVector
    get() {
        if (`_article-line` != null) {
            return `_article-line`!!
        }
        `_article-line` = Builder(name = "Article-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_article-line`: ImageVector? = null
