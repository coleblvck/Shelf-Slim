...
public val DeviceGroup.`Smartphone-line`: ImageVector
    get() {
        if (`_smartphone-line` != null) {
            return `_smartphone-line`!!
        }
        `_smartphone-line` = Builder(name = "Smartphone-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_smartphone-line`: ImageVector? = null
