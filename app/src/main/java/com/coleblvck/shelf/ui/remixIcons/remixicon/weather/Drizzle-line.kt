...
public val WeatherGroup.`Drizzle-line`: ImageVector
    get() {
        if (`_drizzle-line` != null) {
            return `_drizzle-line`!!
        }
        `_drizzle-line` = Builder(name = "Drizzle-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_drizzle-line`: ImageVector? = null
