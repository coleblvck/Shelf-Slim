...
public val ArrowsGroup.`Arrow-down-circle-line`: ImageVector
    get() {
        if (`_arrow-down-circle-line` != null) {
            return `_arrow-down-circle-line`!!
        }
        `_arrow-down-circle-line` = Builder(name = "Arrow-down-circle-line", defaultWidth = 24.0.dp,
...
private var `_arrow-down-circle-line`: ImageVector? = null
