...
public val SystemGroup.`Sidebar-fold-line`: ImageVector
    get() {
        if (`_sidebar-fold-line` != null) {
            return `_sidebar-fold-line`!!
        }
        `_sidebar-fold-line` = Builder(name = "Sidebar-fold-line", defaultWidth = 24.0.dp,
...
private var `_sidebar-fold-line`: ImageVector? = null
