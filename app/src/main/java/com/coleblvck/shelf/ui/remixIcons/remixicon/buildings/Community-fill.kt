...
public val BuildingsGroup.`Community-fill`: ImageVector
    get() {
        if (`_community-fill` != null) {
            return `_community-fill`!!
        }
        `_community-fill` = Builder(name = "Community-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_community-fill`: ImageVector? = null
