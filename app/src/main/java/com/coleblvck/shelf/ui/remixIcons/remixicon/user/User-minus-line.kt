...
public val UserGroup.`User-minus-line`: ImageVector
    get() {
        if (`_user-minus-line` != null) {
            return `_user-minus-line`!!
        }
        `_user-minus-line` = Builder(name = "User-minus-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_user-minus-line`: ImageVector? = null
