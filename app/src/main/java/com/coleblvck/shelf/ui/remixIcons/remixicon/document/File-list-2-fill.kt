...
public val DocumentGroup.`File-list-2-fill`: ImageVector
    get() {
        if (`_file-list-2-fill` != null) {
            return `_file-list-2-fill`!!
        }
        `_file-list-2-fill` = Builder(name = "File-list-2-fill", defaultWidth = 24.0.dp,
...
private var `_file-list-2-fill`: ImageVector? = null
