...
public val BusinessGroup.`Links-line`: ImageVector
    get() {
        if (`_links-line` != null) {
            return `_links-line`!!
        }
        `_links-line` = Builder(name = "Links-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_links-line`: ImageVector? = null
