...
public val CommunicationGroup.`Chat-check-line`: ImageVector
    get() {
        if (`_chat-check-line` != null) {
            return `_chat-check-line`!!
        }
        `_chat-check-line` = Builder(name = "Chat-check-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_chat-check-line`: ImageVector? = null
