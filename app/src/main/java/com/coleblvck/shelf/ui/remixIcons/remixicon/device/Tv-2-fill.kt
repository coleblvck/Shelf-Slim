...
public val DeviceGroup.`Tv-2-fill`: ImageVector
    get() {
        if (`_tv-2-fill` != null) {
            return `_tv-2-fill`!!
        }
        `_tv-2-fill` = Builder(name = "Tv-2-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tv-2-fill`: ImageVector? = null
