...
public val SystemGroup.`Search-2-line`: ImageVector
    get() {
        if (`_search-2-line` != null) {
            return `_search-2-line`!!
        }
        `_search-2-line` = Builder(name = "Search-2-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.0f, 18.0f)
                curveTo(14.8675f, 18.0f, 18.0f, 14.8675f, 18.0f, 11.0f)
...
private var `_search-2-line`: ImageVector? = null
