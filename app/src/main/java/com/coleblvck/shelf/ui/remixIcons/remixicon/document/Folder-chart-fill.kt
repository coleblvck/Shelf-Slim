...
public val DocumentGroup.`Folder-chart-fill`: ImageVector
    get() {
        if (`_folder-chart-fill` != null) {
            return `_folder-chart-fill`!!
        }
        `_folder-chart-fill` = Builder(name = "Folder-chart-fill", defaultWidth = 24.0.dp,
...
private var `_folder-chart-fill`: ImageVector? = null
