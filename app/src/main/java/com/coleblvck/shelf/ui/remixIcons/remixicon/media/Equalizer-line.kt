...
public val MediaGroup.`Equalizer-line`: ImageVector
    get() {
        if (`_equalizer-line` != null) {
            return `_equalizer-line`!!
        }
        `_equalizer-line` = Builder(name = "Equalizer-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.0f, 4.4477f, 9.5523f, 4.0f, 9.0f, 4.0f)
                ...
                close()
                moveTo(9.0f, 20.0f)
                curveTo(9.5523f, 20.0f, 10.0f, 19.5523f, 10.0f, 19.0f)
                curveTo(10.0f, 18.4477f, 9.5523f, 18.0f, 9.0f, 18.0f)
...
private var `_equalizer-line`: ImageVector? = null
