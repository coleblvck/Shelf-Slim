...
public val DeviceGroup.`Battery-2-charge-fill`: ImageVector
    get() {
        if (`_battery-2-charge-fill` != null) {
            return `_battery-2-charge-fill`!!
        }
        `_battery-2-charge-fill` = Builder(name = "Battery-2-charge-fill", defaultWidth = 24.0.dp,
...
private var `_battery-2-charge-fill`: ImageVector? = null
