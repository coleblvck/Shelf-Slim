...
public val MediaGroup.`Repeat-2-fill`: ImageVector
    get() {
        if (`_repeat-2-fill` != null) {
            return `_repeat-2-fill`!!
        }
        `_repeat-2-fill` = Builder(name = "Repeat-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_repeat-2-fill`: ImageVector? = null
