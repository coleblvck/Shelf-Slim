...
public val CommunicationGroup.`Message-2-line`: ImageVector
    get() {
        if (`_message-2-line` != null) {
            return `_message-2-line`!!
        }
        `_message-2-line` = Builder(name = "Message-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-2-line`: ImageVector? = null
