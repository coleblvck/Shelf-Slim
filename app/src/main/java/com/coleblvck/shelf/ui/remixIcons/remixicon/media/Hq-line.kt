...
public val MediaGroup.`Hq-line`: ImageVector
    get() {
        if (`_hq-line` != null) {
            return `_hq-line`!!
        }
        `_hq-line` = Builder(name = "Hq-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_hq-line`: ImageVector? = null
