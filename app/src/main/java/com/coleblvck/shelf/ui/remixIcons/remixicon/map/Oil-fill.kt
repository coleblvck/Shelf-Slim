...
public val MapGroup.`Oil-fill`: ImageVector
    get() {
        if (`_oil-fill` != null) {
            return `_oil-fill`!!
        }
        `_oil-fill` = Builder(name = "Oil-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_oil-fill`: ImageVector? = null
