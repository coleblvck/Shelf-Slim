...
public val DesignGroup.`Layout-line`: ImageVector
    get() {
        if (`_layout-line` != null) {
            return `_layout-line`!!
        }
        `_layout-line` = Builder(name = "Layout-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_layout-line`: ImageVector? = null
