...
public val MediaGroup.`Picture-in-picture-fill`: ImageVector
    get() {
        if (`_picture-in-picture-fill` != null) {
            return `_picture-in-picture-fill`!!
        }
        `_picture-in-picture-fill` = Builder(name = "Picture-in-picture-fill", defaultWidth =
...
private var `_picture-in-picture-fill`: ImageVector? = null
