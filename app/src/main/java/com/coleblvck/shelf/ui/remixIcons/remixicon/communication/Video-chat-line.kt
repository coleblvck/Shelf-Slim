...
public val CommunicationGroup.`Video-chat-line`: ImageVector
    get() {
        if (`_video-chat-line` != null) {
            return `_video-chat-line`!!
        }
        `_video-chat-line` = Builder(name = "Video-chat-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_video-chat-line`: ImageVector? = null
