...
public val DocumentGroup.`File-word-2-fill`: ImageVector
    get() {
        if (`_file-word-2-fill` != null) {
            return `_file-word-2-fill`!!
        }
        `_file-word-2-fill` = Builder(name = "File-word-2-fill", defaultWidth = 24.0.dp,
...
private var `_file-word-2-fill`: ImageVector? = null
