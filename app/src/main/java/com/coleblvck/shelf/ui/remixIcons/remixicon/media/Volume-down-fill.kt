...
public val MediaGroup.`Volume-down-fill`: ImageVector
    get() {
        if (`_volume-down-fill` != null) {
            return `_volume-down-fill`!!
        }
        `_volume-down-fill` = Builder(name = "Volume-down-fill", defaultWidth = 24.0.dp,
...
private var `_volume-down-fill`: ImageVector? = null
