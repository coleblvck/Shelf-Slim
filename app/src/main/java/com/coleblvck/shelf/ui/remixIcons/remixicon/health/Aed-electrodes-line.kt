...
public val HealthGroup.`Aed-electrodes-line`: ImageVector
    get() {
        if (`_aed-electrodes-line` != null) {
            return `_aed-electrodes-line`!!
        }
        `_aed-electrodes-line` = Builder(name = "Aed-electrodes-line", defaultWidth = 24.0.dp,
...
private var `_aed-electrodes-line`: ImageVector? = null
