...
public val BusinessGroup.`Pass-expired-line`: ImageVector
    get() {
        if (`_pass-expired-line` != null) {
            return `_pass-expired-line`!!
        }
        `_pass-expired-line` = Builder(name = "Pass-expired-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.7929f, 8.7929f)
                lineTo(16.0f, 10.5858f)
                lineTo(14.2071f, 8.7929f)
                lineTo(12.7929f, 10.2071f)
                lineTo(14.5858f, 12.0f)
                lineTo(12.7929f, 13.7929f)
                lineTo(14.2071f, 15.2071f)
                lineTo(16.0f, 13.4142f)
                lineTo(17.7929f, 15.2071f)
                lineTo(19.2071f, 13.7929f)
                lineTo(17.4142f, 12.0f)
                lineTo(19.2071f, 10.2071f)
                lineTo(17.7929f, 8.7929f)
                close()
            }
        }
        .build()
...
private var `_pass-expired-line`: ImageVector? = null
