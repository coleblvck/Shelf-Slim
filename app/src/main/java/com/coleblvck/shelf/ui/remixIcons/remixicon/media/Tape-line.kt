...
public val MediaGroup.`Tape-line`: ImageVector
    get() {
        if (`_tape-line` != null) {
            return `_tape-line`!!
        }
        `_tape-line` = Builder(name = "Tape-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tape-line`: ImageVector? = null
