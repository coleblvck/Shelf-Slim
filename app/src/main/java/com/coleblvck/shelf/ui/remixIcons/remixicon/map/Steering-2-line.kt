...
public val MapGroup.`Steering-2-line`: ImageVector
    get() {
        if (`_steering-2-line` != null) {
            return `_steering-2-line`!!
        }
        `_steering-2-line` = Builder(name = "Steering-2-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_steering-2-line`: ImageVector? = null
