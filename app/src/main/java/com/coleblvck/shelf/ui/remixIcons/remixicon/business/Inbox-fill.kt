...
public val BusinessGroup.`Inbox-fill`: ImageVector
    get() {
        if (`_inbox-fill` != null) {
            return `_inbox-fill`!!
        }
        `_inbox-fill` = Builder(name = "Inbox-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_inbox-fill`: ImageVector? = null
