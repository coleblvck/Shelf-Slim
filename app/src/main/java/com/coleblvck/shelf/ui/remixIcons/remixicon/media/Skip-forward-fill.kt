...
public val MediaGroup.`Skip-forward-fill`: ImageVector
    get() {
        if (`_skip-forward-fill` != null) {
            return `_skip-forward-fill`!!
        }
        `_skip-forward-fill` = Builder(name = "Skip-forward-fill", defaultWidth = 24.0.dp,
...
private var `_skip-forward-fill`: ImageVector? = null
