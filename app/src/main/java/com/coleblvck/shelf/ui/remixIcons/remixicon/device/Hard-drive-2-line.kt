...
public val DeviceGroup.`Hard-drive-2-line`: ImageVector
    get() {
        if (`_hard-drive-2-line` != null) {
            return `_hard-drive-2-line`!!
        }
        `_hard-drive-2-line` = Builder(name = "Hard-drive-2-line", defaultWidth = 24.0.dp,
...
private var `_hard-drive-2-line`: ImageVector? = null
