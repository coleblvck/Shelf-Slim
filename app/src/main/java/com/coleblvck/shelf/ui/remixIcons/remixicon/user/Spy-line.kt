...
public val UserGroup.`Spy-line`: ImageVector
    get() {
        if (`_spy-line` != null) {
            return `_spy-line`!!
        }
        `_spy-line` = Builder(name = "Spy-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.7909f, 21.0f, 13.0f, 19.2091f, 13.0f, 17.0f)
                ...
                close()
                moveTo(7.0f, 15.0f)
                curveTo(5.8954f, 15.0f, 5.0f, 15.8954f, 5.0f, 17.0f)
                curveTo(5.0f, 18.1046f, 5.8954f, 19.0f, 7.0f, 19.0f)
                curveTo(8.1046f, 19.0f, 9.0f, 18.1046f, 9.0f, 17.0f)
                curveTo(9.0f, 15.8954f, 8.1046f, 15.0f, 7.0f, 15.0f)
                close()
                moveTo(17.0f, 15.0f)
                curveTo(15.8954f, 15.0f, 15.0f, 15.8954f, 15.0f, 17.0f)
                curveTo(15.0f, 18.1046f, 15.8954f, 19.0f, 17.0f, 19.0f)
                curveTo(18.1046f, 19.0f, 19.0f, 18.1046f, 19.0f, 17.0f)
                curveTo(19.0f, 15.8954f, 18.1046f, 15.0f, 17.0f, 15.0f)
                close()
                moveTo(16.0f, 3.0f)
                ...
                curveTo(6.9456f, 5.0f, 6.0f, 5.95f, 6.0f, 7.0f)
                verticalLineTo(10.0f)
                horizontalLineTo(18.0f)
                verticalLineTo(7.0f)
                curveTo(18.0f, 5.9456f, 17.05f, 5.0f, 16.0f, 5.0f)
                close()
            }
        }
        .build()
...
private var `_spy-line`: ImageVector? = null
