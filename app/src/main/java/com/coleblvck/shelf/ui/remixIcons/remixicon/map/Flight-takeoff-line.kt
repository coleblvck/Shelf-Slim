...
public val MapGroup.`Flight-takeoff-line`: ImageVector
    get() {
        if (`_flight-takeoff-line` != null) {
            return `_flight-takeoff-line`!!
        }
        `_flight-takeoff-line` = Builder(name = "Flight-takeoff-line", defaultWidth = 24.0.dp,
...
private var `_flight-takeoff-line`: ImageVector? = null
