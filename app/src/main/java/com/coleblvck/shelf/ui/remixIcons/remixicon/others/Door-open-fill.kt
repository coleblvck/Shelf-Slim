...
public val OthersGroup.`Door-open-fill`: ImageVector
    get() {
        if (`_door-open-fill` != null) {
            return `_door-open-fill`!!
        }
        `_door-open-fill` = Builder(name = "Door-open-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_door-open-fill`: ImageVector? = null
