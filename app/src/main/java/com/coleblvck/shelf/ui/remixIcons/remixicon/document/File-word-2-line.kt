...
public val DocumentGroup.`File-word-2-line`: ImageVector
    get() {
        if (`_file-word-2-line` != null) {
            return `_file-word-2-line`!!
        }
        `_file-word-2-line` = Builder(name = "File-word-2-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(7.0108f, 13.0f)
                lineTo(9.0f, 11.0f)
                lineTo(11.0f, 12.989f)
                verticalLineTo(8.0f)
                close()
            }
        }
...
private var `_file-word-2-line`: ImageVector? = null
