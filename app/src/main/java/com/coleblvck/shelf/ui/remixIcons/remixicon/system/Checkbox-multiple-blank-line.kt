...
public val SystemGroup.`Checkbox-multiple-blank-line`: ImageVector
    get() {
        if (`_checkbox-multiple-blank-line` != null) {
            return `_checkbox-multiple-blank-line`!!
        }
        `_checkbox-multiple-blank-line` = Builder(name = "Checkbox-multiple-blank-line",
...
private var `_checkbox-multiple-blank-line`: ImageVector? = null
