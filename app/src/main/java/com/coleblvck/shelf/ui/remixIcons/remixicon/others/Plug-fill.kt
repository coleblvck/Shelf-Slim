...
public val OthersGroup.`Plug-fill`: ImageVector
    get() {
        if (`_plug-fill` != null) {
            return `_plug-fill`!!
        }
        `_plug-fill` = Builder(name = "Plug-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_plug-fill`: ImageVector? = null
