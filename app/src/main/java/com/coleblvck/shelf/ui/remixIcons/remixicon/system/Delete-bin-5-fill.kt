...
public val SystemGroup.`Delete-bin-5-fill`: ImageVector
    get() {
        if (`_delete-bin-5-fill` != null) {
            return `_delete-bin-5-fill`!!
        }
        `_delete-bin-5-fill` = Builder(name = "Delete-bin-5-fill", defaultWidth = 24.0.dp,
...
private var `_delete-bin-5-fill`: ImageVector? = null
