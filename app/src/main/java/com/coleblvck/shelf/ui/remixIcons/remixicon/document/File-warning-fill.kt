...
public val DocumentGroup.`File-warning-fill`: ImageVector
    get() {
        if (`_file-warning-fill` != null) {
            return `_file-warning-fill`!!
        }
        `_file-warning-fill` = Builder(name = "File-warning-fill", defaultWidth = 24.0.dp,
...
private var `_file-warning-fill`: ImageVector? = null
