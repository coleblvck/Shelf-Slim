...
public val DeviceGroup.`Router-line`: ImageVector
    get() {
        if (`_router-line` != null) {
            return `_router-line`!!
        }
        `_router-line` = Builder(name = "Router-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_router-line`: ImageVector? = null
