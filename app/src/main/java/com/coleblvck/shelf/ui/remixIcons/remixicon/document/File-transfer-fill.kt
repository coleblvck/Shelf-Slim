...
public val DocumentGroup.`File-transfer-fill`: ImageVector
    get() {
        if (`_file-transfer-fill` != null) {
            return `_file-transfer-fill`!!
        }
        `_file-transfer-fill` = Builder(name = "File-transfer-fill", defaultWidth = 24.0.dp,
...
private var `_file-transfer-fill`: ImageVector? = null
