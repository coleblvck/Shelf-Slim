...
public val FoodGroup.`Cake-line`: ImageVector
    get() {
        if (`_cake-line` != null) {
            return `_cake-line`!!
        }
        `_cake-line` = Builder(name = "Cake-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cake-line`: ImageVector? = null
