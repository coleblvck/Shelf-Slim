...
public val WeatherGroup.`Moon-cloudy-fill`: ImageVector
    get() {
        if (`_moon-cloudy-fill` != null) {
            return `_moon-cloudy-fill`!!
        }
        `_moon-cloudy-fill` = Builder(name = "Moon-cloudy-fill", defaultWidth = 24.0.dp,
...
private var `_moon-cloudy-fill`: ImageVector? = null
