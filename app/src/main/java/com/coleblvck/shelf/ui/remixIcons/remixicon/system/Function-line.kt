...
public val SystemGroup.`Function-line`: ImageVector
    get() {
        if (`_function-line` != null) {
            return `_function-line`!!
        }
        `_function-line` = Builder(name = "Function-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.0f, 10.5523f, 10.5523f, 11.0f, 10.0f, 11.0f)
...
private var `_function-line`: ImageVector? = null
