...
public val DevelopmentGroup.`Git-fork-line`: ImageVector
    get() {
        if (`_git-fork-line` != null) {
            return `_git-fork-line`!!
        }
        `_git-fork-line` = Builder(name = "Git-fork-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_git-fork-line`: ImageVector? = null
