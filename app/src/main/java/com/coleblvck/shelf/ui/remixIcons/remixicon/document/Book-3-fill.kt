...
public val DocumentGroup.`Book-3-fill`: ImageVector
    get() {
        if (`_book-3-fill` != null) {
            return `_book-3-fill`!!
        }
        `_book-3-fill` = Builder(name = "Book-3-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_book-3-fill`: ImageVector? = null
