...
public val MediaGroup.`Video-upload-fill`: ImageVector
    get() {
        if (`_video-upload-fill` != null) {
            return `_video-upload-fill`!!
        }
        `_video-upload-fill` = Builder(name = "Video-upload-fill", defaultWidth = 24.0.dp,
...
private var `_video-upload-fill`: ImageVector? = null
