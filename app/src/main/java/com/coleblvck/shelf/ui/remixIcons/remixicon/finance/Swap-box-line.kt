...
public val FinanceGroup.`Swap-box-line`: ImageVector
    get() {
        if (`_swap-box-line` != null) {
            return `_swap-box-line`!!
        }
        `_swap-box-line` = Builder(name = "Swap-box-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_swap-box-line`: ImageVector? = null
