...
public val BusinessGroup.`Calculator-line`: ImageVector
    get() {
        if (`_calculator-line` != null) {
            return `_calculator-line`!!
        }
        `_calculator-line` = Builder(name = "Calculator-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_calculator-line`: ImageVector? = null
