...
public val BuildingsGroup.`Home-4-line`: ImageVector
    get() {
        if (`_home-4-line` != null) {
            return `_home-4-line`!!
        }
        `_home-4-line` = Builder(name = "Home-4-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-4-line`: ImageVector? = null
