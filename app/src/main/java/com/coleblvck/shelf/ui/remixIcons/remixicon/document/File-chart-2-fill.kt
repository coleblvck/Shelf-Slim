...
public val DocumentGroup.`File-chart-2-fill`: ImageVector
    get() {
        if (`_file-chart-2-fill` != null) {
            return `_file-chart-2-fill`!!
        }
        `_file-chart-2-fill` = Builder(name = "File-chart-2-fill", defaultWidth = 24.0.dp,
...
private var `_file-chart-2-fill`: ImageVector? = null
