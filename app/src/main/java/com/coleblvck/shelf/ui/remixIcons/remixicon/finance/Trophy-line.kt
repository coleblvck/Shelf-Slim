...
public val FinanceGroup.`Trophy-line`: ImageVector
    get() {
        if (`_trophy-line` != null) {
            return `_trophy-line`!!
        }
        `_trophy-line` = Builder(name = "Trophy-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(6.0049f, 5.0027f)
                verticalLineTo(9.0028f)
                curveTo(6.0049f, 12.3165f, 8.6912f, 15.0027f, 12.0049f, 15.0027f)
                curveTo(15.3186f, 15.0027f, 18.0049f, 12.3165f, 18.0049f, 9.0028f)
...
private var `_trophy-line`: ImageVector? = null
