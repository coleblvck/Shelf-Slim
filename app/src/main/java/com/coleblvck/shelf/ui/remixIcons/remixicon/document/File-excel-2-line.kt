...
public val DocumentGroup.`File-excel-2-line`: ImageVector
    get() {
        if (`_file-excel-2-line` != null) {
            return `_file-excel-2-line`!!
        }
        `_file-excel-2-line` = Builder(name = "File-excel-2-line", defaultWidth = 24.0.dp,
...
private var `_file-excel-2-line`: ImageVector? = null
