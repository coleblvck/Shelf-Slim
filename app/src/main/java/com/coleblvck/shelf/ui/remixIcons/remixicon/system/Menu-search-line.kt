...
public val SystemGroup.`Menu-search-line`: ImageVector
    get() {
        if (`_menu-search-line` != null) {
            return `_menu-search-line`!!
        }
        `_menu-search-line` = Builder(name = "Menu-search-line", defaultWidth = 24.0.dp,
...
private var `_menu-search-line`: ImageVector? = null
