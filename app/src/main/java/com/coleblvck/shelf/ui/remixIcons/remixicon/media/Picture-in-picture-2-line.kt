...
public val MediaGroup.`Picture-in-picture-2-line`: ImageVector
    get() {
        if (`_picture-in-picture-2-line` != null) {
            return `_picture-in-picture-2-line`!!
        }
        `_picture-in-picture-2-line` = Builder(name = "Picture-in-picture-2-line", defaultWidth =
...
private var `_picture-in-picture-2-line`: ImageVector? = null
