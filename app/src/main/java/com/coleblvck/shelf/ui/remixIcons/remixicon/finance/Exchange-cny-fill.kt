...
public val FinanceGroup.`Exchange-cny-fill`: ImageVector
    get() {
        if (`_exchange-cny-fill` != null) {
            return `_exchange-cny-fill`!!
        }
        `_exchange-cny-fill` = Builder(name = "Exchange-cny-fill", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.0049f, 13.5383f)
                horizontalLineTo(16.0049f)
                verticalLineTo(15.5383f)
                horizontalLineTo(13.0049f)
                verticalLineTo(17.5383f)
                horizontalLineTo(11.0049f)
                verticalLineTo(15.5383f)
                horizontalLineTo(8.0049f)
                verticalLineTo(13.5383f)
                horizontalLineTo(11.0049f)
                verticalLineTo(12.5383f)
                horizontalLineTo(8.0049f)
                verticalLineTo(10.5383f)
                horizontalLineTo(10.5907f)
                lineTo(8.4693f, 8.417f)
                lineTo(9.8836f, 7.0027f)
                lineTo(12.0049f, 9.1241f)
                lineTo(14.1262f, 7.0027f)
                lineTo(15.5404f, 8.417f)
                lineTo(13.4191f, 10.5383f)
                horizontalLineTo(16.0049f)
                verticalLineTo(12.5383f)
                horizontalLineTo(13.0049f)
                verticalLineTo(13.5383f)
...
private var `_exchange-cny-fill`: ImageVector? = null
