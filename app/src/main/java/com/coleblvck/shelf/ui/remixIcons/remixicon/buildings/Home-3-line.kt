...
public val BuildingsGroup.`Home-3-line`: ImageVector
    get() {
        if (`_home-3-line` != null) {
            return `_home-3-line`!!
        }
        `_home-3-line` = Builder(name = "Home-3-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-3-line`: ImageVector? = null
