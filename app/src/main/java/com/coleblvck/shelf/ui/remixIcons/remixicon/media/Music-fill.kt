...
public val MediaGroup.`Music-fill`: ImageVector
    get() {
        if (`_music-fill` != null) {
            return `_music-fill`!!
        }
        `_music-fill` = Builder(name = "Music-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_music-fill`: ImageVector? = null
