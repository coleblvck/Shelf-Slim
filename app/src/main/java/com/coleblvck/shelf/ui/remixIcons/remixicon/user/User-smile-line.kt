...
public val UserGroup.`User-smile-line`: ImageVector
    get() {
        if (`_user-smile-line` != null) {
            return `_user-smile-line`!!
        }
        `_user-smile-line` = Builder(name = "User-smile-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_user-smile-line`: ImageVector? = null
