...
public val DesignGroup.`Focus-line`: ImageVector
    get() {
        if (`_focus-line` != null) {
            return `_focus-line`!!
        }
        `_focus-line` = Builder(name = "Focus-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_focus-line`: ImageVector? = null
