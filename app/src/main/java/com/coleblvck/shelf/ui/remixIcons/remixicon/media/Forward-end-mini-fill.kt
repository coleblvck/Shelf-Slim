...
public val MediaGroup.`Forward-end-mini-fill`: ImageVector
    get() {
        if (`_forward-end-mini-fill` != null) {
            return `_forward-end-mini-fill`!!
        }
        `_forward-end-mini-fill` = Builder(name = "Forward-end-mini-fill", defaultWidth = 24.0.dp,
...
private var `_forward-end-mini-fill`: ImageVector? = null
