...
public val SystemGroup.`Delete-bin-7-fill`: ImageVector
    get() {
        if (`_delete-bin-7-fill` != null) {
            return `_delete-bin-7-fill`!!
        }
        `_delete-bin-7-fill` = Builder(name = "Delete-bin-7-fill", defaultWidth = 24.0.dp,
...
private var `_delete-bin-7-fill`: ImageVector? = null
