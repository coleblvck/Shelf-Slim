...
public val SystemGroup.`Checkbox-blank-fill`: ImageVector
    get() {
        if (`_checkbox-blank-fill` != null) {
            return `_checkbox-blank-fill`!!
        }
        `_checkbox-blank-fill` = Builder(name = "Checkbox-blank-fill", defaultWidth = 24.0.dp,
...
private var `_checkbox-blank-fill`: ImageVector? = null
