...
public val WeatherGroup.`Fahrenheit-fill`: ImageVector
    get() {
        if (`_fahrenheit-fill` != null) {
            return `_fahrenheit-fill`!!
        }
        `_fahrenheit-fill` = Builder(name = "Fahrenheit-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_fahrenheit-fill`: ImageVector? = null
