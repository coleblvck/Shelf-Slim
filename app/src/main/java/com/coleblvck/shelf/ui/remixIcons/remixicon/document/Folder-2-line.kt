...
public val DocumentGroup.`Folder-2-line`: ImageVector
    get() {
        if (`_folder-2-line` != null) {
            return `_folder-2-line`!!
        }
        `_folder-2-line` = Builder(name = "Folder-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_folder-2-line`: ImageVector? = null
