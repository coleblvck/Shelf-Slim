...
public val DesignGroup.`Crosshair-2-fill`: ImageVector
    get() {
        if (`_crosshair-2-fill` != null) {
            return `_crosshair-2-fill`!!
        }
        `_crosshair-2-fill` = Builder(name = "Crosshair-2-fill", defaultWidth = 24.0.dp,
...
private var `_crosshair-2-fill`: ImageVector? = null
