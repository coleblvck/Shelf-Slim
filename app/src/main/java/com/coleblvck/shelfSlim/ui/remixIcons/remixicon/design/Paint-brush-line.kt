...
public val DesignGroup.`Paint-brush-line`: ImageVector
    get() {
        if (`_paint-brush-line` != null) {
            return `_paint-brush-line`!!
        }
        `_paint-brush-line` = Builder(name = "Paint-brush-line", defaultWidth = 24.0.dp,
...
private var `_paint-brush-line`: ImageVector? = null
