...
public val MapGroup.`Walk-fill`: ImageVector
    get() {
        if (`_walk-fill` != null) {
            return `_walk-fill`!!
        }
        `_walk-fill` = Builder(name = "Walk-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_walk-fill`: ImageVector? = null
