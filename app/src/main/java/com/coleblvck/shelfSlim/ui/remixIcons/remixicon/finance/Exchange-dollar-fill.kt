...
public val FinanceGroup.`Exchange-dollar-fill`: ImageVector
    get() {
        if (`_exchange-dollar-fill` != null) {
            return `_exchange-dollar-fill`!!
        }
        `_exchange-dollar-fill` = Builder(name = "Exchange-dollar-fill", defaultWidth = 24.0.dp,
...
private var `_exchange-dollar-fill`: ImageVector? = null
