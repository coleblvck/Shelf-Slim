...
public val MediaGroup.`Headphone-line`: ImageVector
    get() {
        if (`_headphone-line` != null) {
            return `_headphone-line`!!
        }
        `_headphone-line` = Builder(name = "Headphone-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_headphone-line`: ImageVector? = null
