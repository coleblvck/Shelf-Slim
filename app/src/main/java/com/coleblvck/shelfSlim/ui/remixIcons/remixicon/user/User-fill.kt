...
public val UserGroup.`User-fill`: ImageVector
    get() {
        if (`_user-fill` != null) {
            return `_user-fill`!!
        }
        `_user-fill` = Builder(name = "User-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_user-fill`: ImageVector? = null
