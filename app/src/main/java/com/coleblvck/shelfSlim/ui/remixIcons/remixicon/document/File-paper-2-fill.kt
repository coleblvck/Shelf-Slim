...
public val DocumentGroup.`File-paper-2-fill`: ImageVector
    get() {
        if (`_file-paper-2-fill` != null) {
            return `_file-paper-2-fill`!!
        }
        `_file-paper-2-fill` = Builder(name = "File-paper-2-fill", defaultWidth = 24.0.dp,
...
private var `_file-paper-2-fill`: ImageVector? = null
