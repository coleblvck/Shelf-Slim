...
public val DocumentGroup.`Folder-info-line`: ImageVector
    get() {
        if (`_folder-info-line` != null) {
            return `_folder-info-line`!!
        }
        `_folder-info-line` = Builder(name = "Folder-info-line", defaultWidth = 24.0.dp,
...
private var `_folder-info-line`: ImageVector? = null
