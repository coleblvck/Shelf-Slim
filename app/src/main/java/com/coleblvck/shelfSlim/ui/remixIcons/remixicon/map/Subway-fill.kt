...
public val MapGroup.`Subway-fill`: ImageVector
    get() {
        if (`_subway-fill` != null) {
            return `_subway-fill`!!
        }
        `_subway-fill` = Builder(name = "Subway-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_subway-fill`: ImageVector? = null
