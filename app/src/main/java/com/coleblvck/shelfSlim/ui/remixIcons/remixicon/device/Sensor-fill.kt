...
public val DeviceGroup.`Sensor-fill`: ImageVector
    get() {
        if (`_sensor-fill` != null) {
            return `_sensor-fill`!!
        }
        `_sensor-fill` = Builder(name = "Sensor-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sensor-fill`: ImageVector? = null
