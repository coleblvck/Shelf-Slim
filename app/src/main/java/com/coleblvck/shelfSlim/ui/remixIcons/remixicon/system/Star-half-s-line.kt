...
public val SystemGroup.`Star-half-s-line`: ImageVector
    get() {
        if (`_star-half-s-line` != null) {
            return `_star-half-s-line`!!
        }
        `_star-half-s-line` = Builder(name = "Star-half-s-line", defaultWidth = 24.0.dp,
...
private var `_star-half-s-line`: ImageVector? = null
