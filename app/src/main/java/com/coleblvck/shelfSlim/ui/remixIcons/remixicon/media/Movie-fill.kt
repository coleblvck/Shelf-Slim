...
public val MediaGroup.`Movie-fill`: ImageVector
    get() {
        if (`_movie-fill` != null) {
            return `_movie-fill`!!
        }
        `_movie-fill` = Builder(name = "Movie-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_movie-fill`: ImageVector? = null
