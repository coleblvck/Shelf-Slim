...
public val EditorGroup.`Split-cells-vertical`: ImageVector
    get() {
        if (`_split-cells-vertical` != null) {
            return `_split-cells-vertical`!!
        }
        `_split-cells-vertical` = Builder(name = "Split-cells-vertical", defaultWidth = 24.0.dp,
...
private var `_split-cells-vertical`: ImageVector? = null
