...
public val LogosGroup.`Android-line`: ImageVector
    get() {
        if (`_android-line` != null) {
            return `_android-line`!!
        }
        `_android-line` = Builder(name = "Android-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.0f, 8.5523f, 9.5523f, 9.0f, 9.0f, 9.0f)
                close()
                moveTo(15.0f, 9.0f)
                curveTo(14.4477f, 9.0f, 14.0f, 8.5523f, 14.0f, 8.0f)
                curveTo(14.0f, 7.4477f, 14.4477f, 7.0f, 15.0f, 7.0f)
                curveTo(15.5523f, 7.0f, 16.0f, 7.4477f, 16.0f, 8.0f)
...
private var `_android-line`: ImageVector? = null
