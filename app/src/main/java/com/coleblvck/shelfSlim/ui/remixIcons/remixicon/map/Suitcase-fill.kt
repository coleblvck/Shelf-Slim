...
public val MapGroup.`Suitcase-fill`: ImageVector
    get() {
        if (`_suitcase-fill` != null) {
            return `_suitcase-fill`!!
        }
        `_suitcase-fill` = Builder(name = "Suitcase-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_suitcase-fill`: ImageVector? = null
