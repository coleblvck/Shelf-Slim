...
public val DesignGroup.`Brush-2-fill`: ImageVector
    get() {
        if (`_brush-2-fill` != null) {
            return `_brush-2-fill`!!
        }
        `_brush-2-fill` = Builder(name = "Brush-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brush-2-fill`: ImageVector? = null
