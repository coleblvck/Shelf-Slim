...
public val DocumentGroup.`File-gif-line`: ImageVector
    get() {
        if (`_file-gif-line` != null) {
            return `_file-gif-line`!!
        }
        `_file-gif-line` = Builder(name = "File-gif-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(12.0f)
                curveTo(7.0f, 10.8954f, 7.8954f, 10.0f, 9.0f, 10.0f)
                horizontalLineTo(11.0f)
                close()
                moveTo(17.0f, 10.0f)
                verticalLineTo(11.0f)
...
private var `_file-gif-line`: ImageVector? = null
