...
public val MediaGroup.`Vidicon-2-line`: ImageVector
    get() {
        if (`_vidicon-2-line` != null) {
            return `_vidicon-2-line`!!
        }
        `_vidicon-2-line` = Builder(name = "Vidicon-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_vidicon-2-line`: ImageVector? = null
