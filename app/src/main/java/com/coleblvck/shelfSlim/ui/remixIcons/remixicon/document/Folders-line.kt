...
public val DocumentGroup.`Folders-line`: ImageVector
    get() {
        if (`_folders-line` != null) {
            return `_folders-line`!!
        }
        `_folders-line` = Builder(name = "Folders-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(7.0f)
                horizontalLineTo(14.5858f)
                lineTo(12.5858f, 5.0f)
...
private var `_folders-line`: ImageVector? = null
