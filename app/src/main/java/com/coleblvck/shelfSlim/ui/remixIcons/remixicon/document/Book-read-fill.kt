...
public val DocumentGroup.`Book-read-fill`: ImageVector
    get() {
        if (`_book-read-fill` != null) {
            return `_book-read-fill`!!
        }
        `_book-read-fill` = Builder(name = "Book-read-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_book-read-fill`: ImageVector? = null
