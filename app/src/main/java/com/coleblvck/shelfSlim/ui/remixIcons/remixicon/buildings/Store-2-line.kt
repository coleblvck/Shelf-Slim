...
public val BuildingsGroup.`Store-2-line`: ImageVector
    get() {
        if (`_store-2-line` != null) {
            return `_store-2-line`!!
        }
        `_store-2-line` = Builder(name = "Store-2-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.0f, 13.2422f)
                ...
                close()
                moveTo(19.0f, 13.9725f)
                curveTo(18.8358f, 13.9907f, 18.669f, 14.0f, 18.5f, 14.0f)
                curveTo(17.2409f, 14.0f, 16.0789f, 13.478f, 15.25f, 12.6132f)
                curveTo(14.4211f, 13.478f, 13.2591f, 14.0f, 12.0f, 14.0f)
                curveTo(10.7409f, 14.0f, 9.5789f, 13.478f, 8.75f, 12.6132f)
                curveTo(7.9211f, 13.478f, 6.7591f, 14.0f, 5.5f, 14.0f)
                curveTo(5.331f, 14.0f, 5.1642f, 13.9907f, 5.0f, 13.9725f)
                verticalLineTo(20.0f)
                horizontalLineTo(19.0f)
                verticalLineTo(13.9725f)
                close()
                moveTo(5.7887f, 4.0f)
...
private var `_store-2-line`: ImageVector? = null
