...
public val FinanceGroup.`Bank-card-line`: ImageVector
    get() {
        if (`_bank-card-line` != null) {
            return `_bank-card-line`!!
        }
        `_bank-card-line` = Builder(name = "Bank-card-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bank-card-line`: ImageVector? = null
