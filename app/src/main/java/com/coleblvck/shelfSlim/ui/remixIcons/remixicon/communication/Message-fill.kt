...
public val CommunicationGroup.`Message-fill`: ImageVector
    get() {
        if (`_message-fill` != null) {
            return `_message-fill`!!
        }
        `_message-fill` = Builder(name = "Message-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-fill`: ImageVector? = null
