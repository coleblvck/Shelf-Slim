...
public val SystemGroup.`Progress-8-line`: ImageVector
    get() {
        if (`_progress-8-line` != null) {
            return `_progress-8-line`!!
        }
        `_progress-8-line` = Builder(name = "Progress-8-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_progress-8-line`: ImageVector? = null
