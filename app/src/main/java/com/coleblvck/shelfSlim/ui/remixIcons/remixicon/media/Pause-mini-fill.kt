...
public val MediaGroup.`Pause-mini-fill`: ImageVector
    get() {
        if (`_pause-mini-fill` != null) {
            return `_pause-mini-fill`!!
        }
        `_pause-mini-fill` = Builder(name = "Pause-mini-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_pause-mini-fill`: ImageVector? = null
