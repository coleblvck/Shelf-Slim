...
public val SystemGroup.`Sidebar-unfold-fill`: ImageVector
    get() {
        if (`_sidebar-unfold-fill` != null) {
            return `_sidebar-unfold-fill`!!
        }
        `_sidebar-unfold-fill` = Builder(name = "Sidebar-unfold-fill", defaultWidth = 24.0.dp,
...
private var `_sidebar-unfold-fill`: ImageVector? = null
