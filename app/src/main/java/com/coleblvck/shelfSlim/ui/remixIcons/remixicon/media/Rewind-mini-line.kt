...
public val MediaGroup.`Rewind-mini-line`: ImageVector
    get() {
        if (`_rewind-mini-line` != null) {
            return `_rewind-mini-line`!!
        }
        `_rewind-mini-line` = Builder(name = "Rewind-mini-line", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.0002f, 9.8598f)
                lineTo(5.9683f, 12.0f)
                lineTo(9.0002f, 14.1402f)
                verticalLineTo(9.8598f)
                close()
                moveTo(10.9087f, 17.3234f)
                ...
                close()
                moveTo(18.0002f, 14.1402f)
                verticalLineTo(9.8598f)
                lineTo(14.9683f, 12.0f)
                lineTo(18.0002f, 14.1402f)
                close()
...
private var `_rewind-mini-line`: ImageVector? = null
