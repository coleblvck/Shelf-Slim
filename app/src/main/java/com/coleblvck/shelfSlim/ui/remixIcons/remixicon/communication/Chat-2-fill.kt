...
public val CommunicationGroup.`Chat-2-fill`: ImageVector
    get() {
        if (`_chat-2-fill` != null) {
            return `_chat-2-fill`!!
        }
        `_chat-2-fill` = Builder(name = "Chat-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_chat-2-fill`: ImageVector? = null
