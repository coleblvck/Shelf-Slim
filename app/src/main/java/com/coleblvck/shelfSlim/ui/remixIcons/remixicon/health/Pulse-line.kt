...
public val HealthGroup.`Pulse-line`: ImageVector
    get() {
        if (`_pulse-line` != null) {
            return `_pulse-line`!!
        }
        `_pulse-line` = Builder(name = "Pulse-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pulse-line`: ImageVector? = null
