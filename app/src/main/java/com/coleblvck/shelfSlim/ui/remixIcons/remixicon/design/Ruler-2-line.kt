...
public val DesignGroup.`Ruler-2-line`: ImageVector
    get() {
        if (`_ruler-2-line` != null) {
            return `_ruler-2-line`!!
        }
        `_ruler-2-line` = Builder(name = "Ruler-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ruler-2-line`: ImageVector? = null
