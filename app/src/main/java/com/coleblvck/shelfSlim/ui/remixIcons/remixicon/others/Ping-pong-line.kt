...
public val OthersGroup.`Ping-pong-line`: ImageVector
    get() {
        if (`_ping-pong-line` != null) {
            return `_ping-pong-line`!!
        }
        `_ping-pong-line` = Builder(name = "Ping-pong-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.5f, 4.0f)
                curveTo(7.3579f, 4.0f, 4.0f, 7.3579f, 4.0f, 11.5f)
                curveTo(4.0f, 14.1135f, 5.3368f, 16.4148f, 7.3639f, 17.7574f)
                lineTo(17.7574f, 7.3639f)
                curveTo(16.4148f, 5.3368f, 14.1135f, 4.0f, 11.5f, 4.0f)
                close()
            }
        }
        .build()
...
private var `_ping-pong-line`: ImageVector? = null
