...
public val DeviceGroup.`Battery-2-line`: ImageVector
    get() {
        if (`_battery-2-line` != null) {
            return `_battery-2-line`!!
        }
        `_battery-2-line` = Builder(name = "Battery-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_battery-2-line`: ImageVector? = null
