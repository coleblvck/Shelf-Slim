...
public val DesignGroup.`Grid-fill`: ImageVector
    get() {
        if (`_grid-fill` != null) {
            return `_grid-fill`!!
        }
        `_grid-fill` = Builder(name = "Grid-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_grid-fill`: ImageVector? = null
