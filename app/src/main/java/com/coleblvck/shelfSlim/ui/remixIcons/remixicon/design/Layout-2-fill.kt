...
public val DesignGroup.`Layout-2-fill`: ImageVector
    get() {
        if (`_layout-2-fill` != null) {
            return `_layout-2-fill`!!
        }
        `_layout-2-fill` = Builder(name = "Layout-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_layout-2-fill`: ImageVector? = null
