...
public val DocumentGroup.`Folder-upload-line`: ImageVector
    get() {
        if (`_folder-upload-line` != null) {
            return `_folder-upload-line`!!
        }
        `_folder-upload-line` = Builder(name = "Folder-upload-line", defaultWidth = 24.0.dp,
...
private var `_folder-upload-line`: ImageVector? = null
