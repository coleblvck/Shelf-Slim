...
public val UserGroup.`Emotion-2-line`: ImageVector
    get() {
        if (`_emotion-2-line` != null) {
            return `_emotion-2-line`!!
        }
        `_emotion-2-line` = Builder(name = "Emotion-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_emotion-2-line`: ImageVector? = null
