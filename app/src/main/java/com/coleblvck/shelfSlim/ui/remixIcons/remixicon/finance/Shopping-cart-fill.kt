...
public val FinanceGroup.`Shopping-cart-fill`: ImageVector
    get() {
        if (`_shopping-cart-fill` != null) {
            return `_shopping-cart-fill`!!
        }
        `_shopping-cart-fill` = Builder(name = "Shopping-cart-fill", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(6.0049f, 9.0f)
                horizontalLineTo(19.9433f)
...
private var `_shopping-cart-fill`: ImageVector? = null
