...
public val MapGroup.`Gas-station-line`: ImageVector
    get() {
        if (`_gas-station-line` != null) {
            return `_gas-station-line`!!
        }
        `_gas-station-line` = Builder(name = "Gas-station-line", defaultWidth = 24.0.dp,
...
private var `_gas-station-line`: ImageVector? = null
