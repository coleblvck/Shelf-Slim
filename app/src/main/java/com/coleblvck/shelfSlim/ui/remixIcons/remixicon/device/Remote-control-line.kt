...
public val DeviceGroup.`Remote-control-line`: ImageVector
    get() {
        if (`_remote-control-line` != null) {
            return `_remote-control-line`!!
        }
        `_remote-control-line` = Builder(name = "Remote-control-line", defaultWidth = 24.0.dp,
...
private var `_remote-control-line`: ImageVector? = null
