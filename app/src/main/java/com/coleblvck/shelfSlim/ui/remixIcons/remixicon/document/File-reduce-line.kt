...
public val DocumentGroup.`File-reduce-line`: ImageVector
    get() {
        if (`_file-reduce-line` != null) {
            return `_file-reduce-line`!!
        }
        `_file-reduce-line` = Builder(name = "File-reduce-line", defaultWidth = 24.0.dp,
...
private var `_file-reduce-line`: ImageVector? = null
