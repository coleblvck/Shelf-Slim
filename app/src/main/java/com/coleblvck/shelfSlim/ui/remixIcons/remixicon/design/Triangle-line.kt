...
public val DesignGroup.`Triangle-line`: ImageVector
    get() {
        if (`_triangle-line` != null) {
            return `_triangle-line`!!
        }
        `_triangle-line` = Builder(name = "Triangle-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_triangle-line`: ImageVector? = null
