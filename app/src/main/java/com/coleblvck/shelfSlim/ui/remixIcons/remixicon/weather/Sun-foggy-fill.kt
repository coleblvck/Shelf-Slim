...
public val WeatherGroup.`Sun-foggy-fill`: ImageVector
    get() {
        if (`_sun-foggy-fill` != null) {
            return `_sun-foggy-fill`!!
        }
        `_sun-foggy-fill` = Builder(name = "Sun-foggy-fill", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(6.3414f, 14.0f)
                curveTo(6.1203f, 13.3744f, 6.0f, 12.7013f, 6.0f, 12.0f)
...
private var `_sun-foggy-fill`: ImageVector? = null
