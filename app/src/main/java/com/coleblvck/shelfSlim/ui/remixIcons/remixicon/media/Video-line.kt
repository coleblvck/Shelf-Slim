...
public val MediaGroup.`Video-line`: ImageVector
    get() {
        if (`_video-line` != null) {
            return `_video-line`!!
        }
        `_video-line` = Builder(name = "Video-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_video-line`: ImageVector? = null
