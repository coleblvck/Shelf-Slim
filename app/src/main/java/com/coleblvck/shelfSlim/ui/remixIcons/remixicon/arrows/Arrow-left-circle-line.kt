...
public val ArrowsGroup.`Arrow-left-circle-line`: ImageVector
    get() {
        if (`_arrow-left-circle-line` != null) {
            return `_arrow-left-circle-line`!!
        }
        `_arrow-left-circle-line` = Builder(name = "Arrow-left-circle-line", defaultWidth = 24.0.dp,
...
private var `_arrow-left-circle-line`: ImageVector? = null
