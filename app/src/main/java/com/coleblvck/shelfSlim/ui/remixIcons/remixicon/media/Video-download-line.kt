...
public val MediaGroup.`Video-download-line`: ImageVector
    get() {
        if (`_video-download-line` != null) {
            return `_video-download-line`!!
        }
        `_video-download-line` = Builder(name = "Video-download-line", defaultWidth = 24.0.dp,
...
private var `_video-download-line`: ImageVector? = null
