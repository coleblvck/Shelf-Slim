...
public val DocumentGroup.`Folder-add-line`: ImageVector
    get() {
        if (`_folder-add-line` != null) {
            return `_folder-add-line`!!
        }
        `_folder-add-line` = Builder(name = "Folder-add-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_folder-add-line`: ImageVector? = null
