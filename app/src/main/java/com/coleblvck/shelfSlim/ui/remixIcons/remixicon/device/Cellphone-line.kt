...
public val DeviceGroup.`Cellphone-line`: ImageVector
    get() {
        if (`_cellphone-line` != null) {
            return `_cellphone-line`!!
        }
        `_cellphone-line` = Builder(name = "Cellphone-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cellphone-line`: ImageVector? = null
