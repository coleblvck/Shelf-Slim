...
public val UserGroup.`User-5-line`: ImageVector
    get() {
        if (`_user-5-line` != null) {
            return `_user-5-line`!!
        }
        `_user-5-line` = Builder(name = "User-5-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.1246f, 15.846f)
                lineTo(15.4567f, 14.905f)
                curveTo(17.041f, 13.7858f, 18.0f, 11.9752f, 18.0f, 10.0f)
                curveTo(18.0f, 6.6863f, 15.3137f, 4.0f, 12.0f, 4.0f)
                curveTo(8.6863f, 4.0f, 6.0f, 6.6863f, 6.0f, 10.0f)
                curveTo(6.0f, 11.9752f, 6.959f, 13.7858f, 8.5434f, 14.905f)
                lineTo(9.8754f, 15.846f)
                lineTo(8.058f, 20.0f)
                horizontalLineTo(15.942f)
                lineTo(14.1246f, 15.846f)
                close()
                moveTo(8.1185f, 10.9704f)
                lineTo(10.0593f, 10.4852f)
                curveTo(10.2761f, 11.3553f, 11.0628f, 12.0f, 12.0f, 12.0f)
                curveTo(12.9372f, 12.0f, 13.7239f, 11.3553f, 13.9407f, 10.4852f)
                lineTo(15.8815f, 10.9704f)
                curveTo(15.4478f, 12.7106f, 13.8745f, 14.0f, 12.0f, 14.0f)
                curveTo(10.1255f, 14.0f, 8.5522f, 12.7106f, 8.1185f, 10.9704f)
                close()
            }
        }
        .build()
...
private var `_user-5-line`: ImageVector? = null
