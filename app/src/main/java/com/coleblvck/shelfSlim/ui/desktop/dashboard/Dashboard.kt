...
import com.coleblvck.shelfSlim.ui.common.HorizontalSpacer
import com.coleblvck.shelfSlim.ui.common.VerticalSpacer
import com.coleblvck.shelfSlim.ui.desktop.pages.drawer.DrawerTypeDialog
            ...
            Modifier
                ...
                .pointerInput(Unit) {
                    detectHorizontalDragGestures { _, dragAmount ->
                        if (dragAmount < -50)
                            customDashboardActionToolBox.executeAction(
        ...
        { firstChildModifier: Modifier ->
            ...
            if (getActionTypeValue(customFunctionAction.value) != ActionType.NONE) {
                ...
                ActionIcon(
                    ...
                    longPressAction = {
                        customDashboardActionToolBox.setMappingDialogVisibility(true)
                    }
                )
            }
            getSpacer()
