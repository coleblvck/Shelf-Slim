...
public val DocumentGroup.`Todo-line`: ImageVector
    get() {
        if (`_todo-line` != null) {
            return `_todo-line`!!
        }
        `_todo-line` = Builder(name = "Todo-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_todo-line`: ImageVector? = null
