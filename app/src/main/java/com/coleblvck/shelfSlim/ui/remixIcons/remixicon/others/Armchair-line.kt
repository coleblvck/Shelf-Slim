...
public val OthersGroup.`Armchair-line`: ImageVector
    get() {
        if (`_armchair-line` != null) {
            return `_armchair-line`!!
        }
        `_armchair-line` = Builder(name = "Armchair-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.0f, 15.4055f, 4.7328f, 15.0277f, 4.3333f, 14.8865f)
...
private var `_armchair-line`: ImageVector? = null
