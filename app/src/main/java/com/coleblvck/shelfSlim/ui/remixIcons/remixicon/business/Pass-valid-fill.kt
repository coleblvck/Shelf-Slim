...
public val BusinessGroup.`Pass-valid-fill`: ImageVector
    get() {
        if (`_pass-valid-fill` != null) {
            return `_pass-valid-fill`!!
        }
        `_pass-valid-fill` = Builder(name = "Pass-valid-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_pass-valid-fill`: ImageVector? = null
