...
public val SystemGroup.`Zoom-out-fill`: ImageVector
    get() {
        if (`_zoom-out-fill` != null) {
            return `_zoom-out-fill`!!
        }
        `_zoom-out-fill` = Builder(name = "Zoom-out-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_zoom-out-fill`: ImageVector? = null
