...
public val MapGroup.`Suitcase-line`: ImageVector
    get() {
        if (`_suitcase-line` != null) {
            return `_suitcase-line`!!
        }
        `_suitcase-line` = Builder(name = "Suitcase-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_suitcase-line`: ImageVector? = null
