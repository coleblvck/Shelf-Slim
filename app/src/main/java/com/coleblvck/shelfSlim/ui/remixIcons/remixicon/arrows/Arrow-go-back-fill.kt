...
public val ArrowsGroup.`Arrow-go-back-fill`: ImageVector
    get() {
        if (`_arrow-go-back-fill` != null) {
            return `_arrow-go-back-fill`!!
        }
        `_arrow-go-back-fill` = Builder(name = "Arrow-go-back-fill", defaultWidth = 24.0.dp,
...
private var `_arrow-go-back-fill`: ImageVector? = null
