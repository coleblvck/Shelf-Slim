...
public val BusinessGroup.`Briefcase-2-line`: ImageVector
    get() {
        if (`_briefcase-2-line` != null) {
            return `_briefcase-2-line`!!
        }
        `_briefcase-2-line` = Builder(name = "Briefcase-2-line", defaultWidth = 24.0.dp,
...
private var `_briefcase-2-line`: ImageVector? = null
