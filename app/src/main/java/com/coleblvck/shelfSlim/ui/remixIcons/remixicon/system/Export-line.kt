...
public val SystemGroup.`Export-line`: ImageVector
    get() {
        if (`_export-line` != null) {
            return `_export-line`!!
        }
        `_export-line` = Builder(name = "Export-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.1876f, 16.7659f, 9.9497f, 18.0f, 12.0f, 18.0f)
                curveTo(14.0503f, 18.0f, 15.8124f, 16.7659f, 16.584f, 15.0f)
...
private var `_export-line`: ImageVector? = null
