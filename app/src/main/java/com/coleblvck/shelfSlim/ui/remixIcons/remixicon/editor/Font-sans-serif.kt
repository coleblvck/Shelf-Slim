...
public val EditorGroup.`Font-sans-serif`: ImageVector
    get() {
        if (`_font-sans-serif` != null) {
            return `_font-sans-serif`!!
        }
        `_font-sans-serif` = Builder(name = "Font-sans-serif", defaultWidth = 24.0.dp, defaultHeight
...
private var `_font-sans-serif`: ImageVector? = null
