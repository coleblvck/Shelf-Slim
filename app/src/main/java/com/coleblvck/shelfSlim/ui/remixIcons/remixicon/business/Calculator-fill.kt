...
public val BusinessGroup.`Calculator-fill`: ImageVector
    get() {
        if (`_calculator-fill` != null) {
            return `_calculator-fill`!!
        }
        `_calculator-fill` = Builder(name = "Calculator-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_calculator-fill`: ImageVector? = null
