...
public val DocumentGroup.`Folder-history-fill`: ImageVector
    get() {
        if (`_folder-history-fill` != null) {
            return `_folder-history-fill`!!
        }
        `_folder-history-fill` = Builder(name = "Folder-history-fill", defaultWidth = 24.0.dp,
...
private var `_folder-history-fill`: ImageVector? = null
