...
public val SystemGroup.`Alert-fill`: ImageVector
    get() {
        if (`_alert-fill` != null) {
            return `_alert-fill`!!
        }
        `_alert-fill` = Builder(name = "Alert-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_alert-fill`: ImageVector? = null
