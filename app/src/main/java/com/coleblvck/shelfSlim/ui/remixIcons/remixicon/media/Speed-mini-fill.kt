...
public val MediaGroup.`Speed-mini-fill`: ImageVector
    get() {
        if (`_speed-mini-fill` != null) {
            return `_speed-mini-fill`!!
        }
        `_speed-mini-fill` = Builder(name = "Speed-mini-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_speed-mini-fill`: ImageVector? = null
