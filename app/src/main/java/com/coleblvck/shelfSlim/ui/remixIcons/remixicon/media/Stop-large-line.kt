...
public val MediaGroup.`Stop-large-line`: ImageVector
    get() {
        if (`_stop-large-line` != null) {
            return `_stop-large-line`!!
        }
        `_stop-large-line` = Builder(name = "Stop-large-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_stop-large-line`: ImageVector? = null
