...
public val DeviceGroup.`Signal-wifi-2-fill`: ImageVector
    get() {
        if (`_signal-wifi-2-fill` != null) {
            return `_signal-wifi-2-fill`!!
        }
        `_signal-wifi-2-fill` = Builder(name = "Signal-wifi-2-fill", defaultWidth = 24.0.dp,
...
private var `_signal-wifi-2-fill`: ImageVector? = null
