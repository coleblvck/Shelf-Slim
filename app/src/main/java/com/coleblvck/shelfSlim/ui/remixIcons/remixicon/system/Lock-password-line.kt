...
public val SystemGroup.`Lock-password-line`: ImageVector
    get() {
        if (`_lock-password-line` != null) {
            return `_lock-password-line`!!
        }
        `_lock-password-line` = Builder(name = "Lock-password-line", defaultWidth = 24.0.dp,
...
private var `_lock-password-line`: ImageVector? = null
