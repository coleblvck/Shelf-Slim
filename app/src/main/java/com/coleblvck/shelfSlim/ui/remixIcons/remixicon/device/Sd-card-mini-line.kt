...
public val DeviceGroup.`Sd-card-mini-line`: ImageVector
    get() {
        if (`_sd-card-mini-line` != null) {
            return `_sd-card-mini-line`!!
        }
        `_sd-card-mini-line` = Builder(name = "Sd-card-mini-line", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.0f, 4.0f)
                verticalLineTo(9.7934f)
                curveTo(8.0f, 10.455f, 7.7377f, 11.0897f, 7.2705f, 11.5584f)
                lineTo(6.0f, 12.8329f)
...
private var `_sd-card-mini-line`: ImageVector? = null
