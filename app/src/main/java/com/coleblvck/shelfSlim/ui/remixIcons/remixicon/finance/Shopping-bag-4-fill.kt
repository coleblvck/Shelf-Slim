...
public val FinanceGroup.`Shopping-bag-4-fill`: ImageVector
    get() {
        if (`_shopping-bag-4-fill` != null) {
            return `_shopping-bag-4-fill`!!
        }
        `_shopping-bag-4-fill` = Builder(name = "Shopping-bag-4-fill", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(9.2386f, 1.0f, 7.0f, 3.2386f, 7.0f, 6.0f)
                close()
                moveTo(9.0f, 10.0f)
...
private var `_shopping-bag-4-fill`: ImageVector? = null
