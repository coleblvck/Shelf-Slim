...
public val SystemGroup.`More-2-line`: ImageVector
    get() {
        if (`_more-2-line` != null) {
            return `_more-2-line`!!
        }
        `_more-2-line` = Builder(name = "More-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_more-2-line`: ImageVector? = null
