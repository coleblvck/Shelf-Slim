...
public val DevelopmentGroup.`Terminal-fill`: ImageVector
    get() {
        if (`_terminal-fill` != null) {
            return `_terminal-fill`!!
        }
        `_terminal-fill` = Builder(name = "Terminal-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_terminal-fill`: ImageVector? = null
