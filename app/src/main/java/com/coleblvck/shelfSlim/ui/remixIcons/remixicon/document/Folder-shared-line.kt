...
public val DocumentGroup.`Folder-shared-line`: ImageVector
    get() {
        if (`_folder-shared-line` != null) {
            return `_folder-shared-line`!!
        }
        `_folder-shared-line` = Builder(name = "Folder-shared-line", defaultWidth = 24.0.dp,
...
private var `_folder-shared-line`: ImageVector? = null
