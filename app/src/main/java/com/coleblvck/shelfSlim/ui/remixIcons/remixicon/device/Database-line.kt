...
public val DeviceGroup.`Database-line`: ImageVector
    get() {
        if (`_database-line` != null) {
            return `_database-line`!!
        }
        `_database-line` = Builder(name = "Database-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_database-line`: ImageVector? = null
