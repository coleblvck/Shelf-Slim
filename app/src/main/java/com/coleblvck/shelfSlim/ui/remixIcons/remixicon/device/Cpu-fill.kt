...
public val DeviceGroup.`Cpu-fill`: ImageVector
    get() {
        if (`_cpu-fill` != null) {
            return `_cpu-fill`!!
        }
        `_cpu-fill` = Builder(name = "Cpu-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cpu-fill`: ImageVector? = null
