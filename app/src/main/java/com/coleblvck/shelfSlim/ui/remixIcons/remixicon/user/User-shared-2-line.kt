...
public val UserGroup.`User-shared-2-line`: ImageVector
    get() {
        if (`_user-shared-2-line` != null) {
            return `_user-shared-2-line`!!
        }
        `_user-shared-2-line` = Builder(name = "User-shared-2-line", defaultWidth = 24.0.dp,
...
private var `_user-shared-2-line`: ImageVector? = null
