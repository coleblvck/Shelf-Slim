...
public val MediaGroup.`Repeat-2-line`: ImageVector
    get() {
        if (`_repeat-2-line` != null) {
            return `_repeat-2-line`!!
        }
        `_repeat-2-line` = Builder(name = "Repeat-2-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.0f, 20.0f)
                verticalLineTo(21.9324f)
                curveTo(8.0f, 22.2086f, 7.7761f, 22.4324f, 7.5f, 22.4324f)
                curveTo(7.383f, 22.4324f, 7.2698f, 22.3914f, 7.1799f, 22.3165f)
                ...
                lineTo(18.0f, 18.0f)
                curveTo(19.1046f, 18.0f, 20.0f, 17.1045f, 20.0f, 16.0f)
                verticalLineTo(8.0f)
                ...
                verticalLineTo(8.0f)
                curveTo(2.0f, 5.7908f, 3.7909f, 4.0f, 6.0f, 4.0f)
...
private var `_repeat-2-line`: ImageVector? = null
