...
public val MediaGroup.`Play-reverse-mini-fill`: ImageVector
    get() {
        if (`_play-reverse-mini-fill` != null) {
            return `_play-reverse-mini-fill`!!
        }
        `_play-reverse-mini-fill` = Builder(name = "Play-reverse-mini-fill", defaultWidth = 24.0.dp,
...
private var `_play-reverse-mini-fill`: ImageVector? = null
