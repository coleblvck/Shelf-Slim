...
public val DesignGroup.`Paint-fill`: ImageVector
    get() {
        if (`_paint-fill` != null) {
            return `_paint-fill`!!
        }
        `_paint-fill` = Builder(name = "Paint-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_paint-fill`: ImageVector? = null
