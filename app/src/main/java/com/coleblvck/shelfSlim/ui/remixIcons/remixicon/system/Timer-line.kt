...
public val SystemGroup.`Timer-line`: ImageVector
    get() {
        if (`_timer-line` != null) {
            return `_timer-line`!!
        }
        `_timer-line` = Builder(name = "Timer-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_timer-line`: ImageVector? = null
