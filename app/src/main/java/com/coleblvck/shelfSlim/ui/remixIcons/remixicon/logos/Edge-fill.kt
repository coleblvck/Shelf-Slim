...
public val LogosGroup.`Edge-fill`: ImageVector
    get() {
        if (`_edge-fill` != null) {
            return `_edge-fill`!!
        }
        `_edge-fill` = Builder(name = "Edge-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_edge-fill`: ImageVector? = null
