...
public val DeviceGroup.`Base-station-fill`: ImageVector
    get() {
        if (`_base-station-fill` != null) {
            return `_base-station-fill`!!
        }
        `_base-station-fill` = Builder(name = "Base-station-fill", defaultWidth = 24.0.dp,
...
private var `_base-station-fill`: ImageVector? = null
