...
public val EditorGroup.`Bring-forward`: ImageVector
    get() {
        if (`_bring-forward` != null) {
            return `_bring-forward`!!
        }
        `_bring-forward` = Builder(name = "Bring-forward", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bring-forward`: ImageVector? = null
