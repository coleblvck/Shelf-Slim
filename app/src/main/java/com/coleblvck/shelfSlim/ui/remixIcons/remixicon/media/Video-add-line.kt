...
public val MediaGroup.`Video-add-line`: ImageVector
    get() {
        if (`_video-add-line` != null) {
            return `_video-add-line`!!
        }
        `_video-add-line` = Builder(name = "Video-add-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_video-add-line`: ImageVector? = null
