...
public val BusinessGroup.`Slideshow-2-fill`: ImageVector
    get() {
        if (`_slideshow-2-fill` != null) {
            return `_slideshow-2-fill`!!
        }
        `_slideshow-2-fill` = Builder(name = "Slideshow-2-fill", defaultWidth = 24.0.dp,
...
private var `_slideshow-2-fill`: ImageVector? = null
