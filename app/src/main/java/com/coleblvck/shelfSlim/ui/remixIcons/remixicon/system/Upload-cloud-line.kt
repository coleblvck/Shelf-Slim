...
public val SystemGroup.`Upload-cloud-line`: ImageVector
    get() {
        if (`_upload-cloud-line` != null) {
            return `_upload-cloud-line`!!
        }
        `_upload-cloud-line` = Builder(name = "Upload-cloud-line", defaultWidth = 24.0.dp,
...
private var `_upload-cloud-line`: ImageVector? = null
