...
public val UserGroup.`User-add-line`: ImageVector
    get() {
        if (`_user-add-line` != null) {
            return `_user-add-line`!!
        }
        `_user-add-line` = Builder(name = "User-add-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_user-add-line`: ImageVector? = null
