...
public val MapGroup.`Plane-line`: ImageVector
    get() {
        if (`_plane-line` != null) {
            return `_plane-line`!!
        }
        `_plane-line` = Builder(name = "Plane-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_plane-line`: ImageVector? = null
