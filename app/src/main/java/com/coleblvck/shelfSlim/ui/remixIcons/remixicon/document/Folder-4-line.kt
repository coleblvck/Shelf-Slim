...
public val DocumentGroup.`Folder-4-line`: ImageVector
    get() {
        if (`_folder-4-line` != null) {
            return `_folder-4-line`!!
        }
        `_folder-4-line` = Builder(name = "Folder-4-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_folder-4-line`: ImageVector? = null
