...
public val DevelopmentGroup.`Bug-line`: ImageVector
    get() {
        if (`_bug-line` != null) {
            return `_bug-line`!!
        }
        `_bug-line` = Builder(name = "Bug-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(13.0f, 19.9f)
                curveTo(15.2822f, 19.4367f, 17.0f, 17.419f, 17.0f, 15.0f)
                verticalLineTo(12.0f)
                curveTo(17.0f, 11.299f, 16.8564f, 10.6219f, 16.5846f, 10.0f)
                horizontalLineTo(7.4154f)
                curveTo(7.1436f, 10.6219f, 7.0f, 11.299f, 7.0f, 12.0f)
                verticalLineTo(15.0f)
                curveTo(7.0f, 17.419f, 8.7178f, 19.4367f, 11.0f, 19.9f)
                ...
                curveTo(16.1549f, 20.9893f, 14.1955f, 22.0f, 12.0f, 22.0f)
                curveTo(9.8045f, 22.0f, 7.8451f, 20.9893f, 6.5617f, 19.4077f)
...
private var `_bug-line`: ImageVector? = null
