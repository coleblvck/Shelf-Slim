...
public val DeviceGroup.`Battery-charge-line`: ImageVector
    get() {
        if (`_battery-charge-line` != null) {
            return `_battery-charge-line`!!
        }
        `_battery-charge-line` = Builder(name = "Battery-charge-line", defaultWidth = 24.0.dp,
...
private var `_battery-charge-line`: ImageVector? = null
