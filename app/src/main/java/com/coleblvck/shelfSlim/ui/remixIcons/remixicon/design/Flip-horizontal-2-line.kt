...
public val DesignGroup.`Flip-horizontal-2-line`: ImageVector
    get() {
        if (`_flip-horizontal-2-line` != null) {
            return `_flip-horizontal-2-line`!!
        }
        `_flip-horizontal-2-line` = Builder(name = "Flip-horizontal-2-line", defaultWidth = 24.0.dp,
...
private var `_flip-horizontal-2-line`: ImageVector? = null
