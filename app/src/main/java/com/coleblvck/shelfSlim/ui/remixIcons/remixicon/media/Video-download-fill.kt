...
public val MediaGroup.`Video-download-fill`: ImageVector
    get() {
        if (`_video-download-fill` != null) {
            return `_video-download-fill`!!
        }
        `_video-download-fill` = Builder(name = "Video-download-fill", defaultWidth = 24.0.dp,
...
private var `_video-download-fill`: ImageVector? = null
