...
public val MediaGroup.`Forward-15-line`: ImageVector
    get() {
        if (`_forward-15-line` != null) {
            return `_forward-15-line`!!
        }
        `_forward-15-line` = Builder(name = "Forward-15-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_forward-15-line`: ImageVector? = null
