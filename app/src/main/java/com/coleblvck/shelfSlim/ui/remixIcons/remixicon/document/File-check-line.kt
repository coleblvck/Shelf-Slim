...
public val DocumentGroup.`File-check-line`: ImageVector
    get() {
        if (`_file-check-line` != null) {
            return `_file-check-line`!!
        }
        `_file-check-line` = Builder(name = "File-check-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_file-check-line`: ImageVector? = null
