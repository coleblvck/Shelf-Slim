...
public val MediaGroup.`Video-on-fill`: ImageVector
    get() {
        if (`_video-on-fill` != null) {
            return `_video-on-fill`!!
        }
        `_video-on-fill` = Builder(name = "Video-on-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_video-on-fill`: ImageVector? = null
