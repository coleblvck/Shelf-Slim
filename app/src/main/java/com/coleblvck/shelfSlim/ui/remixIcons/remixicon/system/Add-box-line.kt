...
public val SystemGroup.`Add-box-line`: ImageVector
    get() {
        if (`_add-box-line` != null) {
            return `_add-box-line`!!
        }
        `_add-box-line` = Builder(name = "Add-box-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_add-box-line`: ImageVector? = null
