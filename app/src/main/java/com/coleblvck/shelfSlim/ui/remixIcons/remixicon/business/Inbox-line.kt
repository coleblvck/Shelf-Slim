...
public val BusinessGroup.`Inbox-line`: ImageVector
    get() {
        if (`_inbox-line` != null) {
            return `_inbox-line`!!
        }
        `_inbox-line` = Builder(name = "Inbox-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_inbox-line`: ImageVector? = null
