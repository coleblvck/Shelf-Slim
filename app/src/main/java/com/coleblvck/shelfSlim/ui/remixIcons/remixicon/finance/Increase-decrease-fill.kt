...
public val FinanceGroup.`Increase-decrease-fill`: ImageVector
    get() {
        if (`_increase-decrease-fill` != null) {
            return `_increase-decrease-fill`!!
        }
        `_increase-decrease-fill` = Builder(name = "Increase-decrease-fill", defaultWidth = 24.0.dp,
...
private var `_increase-decrease-fill`: ImageVector? = null
