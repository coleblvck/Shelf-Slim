...
public val DocumentGroup.`File-copy-2-fill`: ImageVector
    get() {
        if (`_file-copy-2-fill` != null) {
            return `_file-copy-2-fill`!!
        }
        `_file-copy-2-fill` = Builder(name = "File-copy-2-fill", defaultWidth = 24.0.dp,
...
private var `_file-copy-2-fill`: ImageVector? = null
