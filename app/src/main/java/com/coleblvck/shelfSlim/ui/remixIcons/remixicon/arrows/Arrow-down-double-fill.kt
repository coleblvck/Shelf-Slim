...
public val ArrowsGroup.`Arrow-down-double-fill`: ImageVector
    get() {
        if (`_arrow-down-double-fill` != null) {
            return `_arrow-down-double-fill`!!
        }
        `_arrow-down-double-fill` = Builder(name = "Arrow-down-double-fill", defaultWidth = 24.0.dp,
...
private var `_arrow-down-double-fill`: ImageVector? = null
