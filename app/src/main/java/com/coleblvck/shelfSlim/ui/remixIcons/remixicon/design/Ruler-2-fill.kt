...
public val DesignGroup.`Ruler-2-fill`: ImageVector
    get() {
        if (`_ruler-2-fill` != null) {
            return `_ruler-2-fill`!!
        }
        `_ruler-2-fill` = Builder(name = "Ruler-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ruler-2-fill`: ImageVector? = null
