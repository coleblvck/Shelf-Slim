...
public val FinanceGroup.`Money-rupee-circle-line`: ImageVector
    get() {
        if (`_money-rupee-circle-line` != null) {
            return `_money-rupee-circle-line`!!
        }
        `_money-rupee-circle-line` = Builder(name = "Money-rupee-circle-line", defaultWidth =
...
private var `_money-rupee-circle-line`: ImageVector? = null
