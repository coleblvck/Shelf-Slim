...
public val LogosGroup.`Firefox-line`: ImageVector
    get() {
        if (`_firefox-line` != null) {
            return `_firefox-line`!!
        }
        `_firefox-line` = Builder(name = "Firefox-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(6.8755f, 7.7048f)
                curveTo(4.6226f, 8.4863f, 3.3747f, 10.8751f, 4.2974f, 14.165f)
                curveTo(5.2201f, 17.4549f, 8.1936f, 19.8873f, 11.7518f, 19.9962f)
                lineTo(12.001f, 20.0f)
                curveTo(16.2525f, 20.0f, 19.7295f, 16.6835f, 19.9858f, 12.4965f)
                lineTo(19.995f, 12.284f)
                curveTo(19.8654f, 12.6327f, 19.7118f, 12.958f, 19.5321f, 13.2648f)
                lineTo(19.3925f, 13.4914f)
                curveTo(17.2881f, 16.7299f, 12.7109f, 17.5664f, 9.9117f, 14.8388f)
                curveTo(9.5274f, 14.4661f, 9.2045f, 14.042f, 8.9496f, 13.5821f)
                lineTo(8.844f, 13.381f)
                curveTo(7.1079f, 12.994f, 6.2603f, 12.0549f, 6.3012f, 10.5637f)
                curveTo(6.3283f, 9.5728f, 6.5318f, 8.6049f, 6.8755f, 7.7048f)
                close()
            }
        }
        .build()
...
private var `_firefox-line`: ImageVector? = null
