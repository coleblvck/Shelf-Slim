...
public val BusinessGroup.`Briefcase-5-line`: ImageVector
    get() {
        if (`_briefcase-5-line` != null) {
            return `_briefcase-5-line`!!
        }
        `_briefcase-5-line` = Builder(name = "Briefcase-5-line", defaultWidth = 24.0.dp,
...
private var `_briefcase-5-line`: ImageVector? = null
