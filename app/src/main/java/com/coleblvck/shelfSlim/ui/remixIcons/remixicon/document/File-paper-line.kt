...
public val DocumentGroup.`File-paper-line`: ImageVector
    get() {
        if (`_file-paper-line` != null) {
            return `_file-paper-line`!!
        }
        `_file-paper-line` = Builder(name = "File-paper-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_file-paper-line`: ImageVector? = null
