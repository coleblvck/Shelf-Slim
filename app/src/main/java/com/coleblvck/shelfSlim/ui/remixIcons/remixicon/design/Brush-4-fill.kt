...
public val DesignGroup.`Brush-4-fill`: ImageVector
    get() {
        if (`_brush-4-fill` != null) {
            return `_brush-4-fill`!!
        }
        `_brush-4-fill` = Builder(name = "Brush-4-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brush-4-fill`: ImageVector? = null
