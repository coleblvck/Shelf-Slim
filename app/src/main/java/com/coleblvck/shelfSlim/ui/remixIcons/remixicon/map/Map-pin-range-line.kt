...
public val MapGroup.`Map-pin-range-line`: ImageVector
    get() {
        if (`_map-pin-range-line` != null) {
            return `_map-pin-range-line`!!
        }
        `_map-pin-range-line` = Builder(name = "Map-pin-range-line", defaultWidth = 24.0.dp,
...
private var `_map-pin-range-line`: ImageVector? = null
