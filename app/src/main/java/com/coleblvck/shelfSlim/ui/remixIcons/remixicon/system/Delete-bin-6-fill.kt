...
public val SystemGroup.`Delete-bin-6-fill`: ImageVector
    get() {
        if (`_delete-bin-6-fill` != null) {
            return `_delete-bin-6-fill`!!
        }
        `_delete-bin-6-fill` = Builder(name = "Delete-bin-6-fill", defaultWidth = 24.0.dp,
...
private var `_delete-bin-6-fill`: ImageVector? = null
