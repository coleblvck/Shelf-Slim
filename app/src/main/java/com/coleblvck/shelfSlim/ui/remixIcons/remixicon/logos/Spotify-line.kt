...
public val LogosGroup.`Spotify-line`: ImageVector
    get() {
        if (`_spotify-line` != null) {
            return `_spotify-line`!!
        }
        `_spotify-line` = Builder(name = "Spotify-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.001f, 4.0f)
                curveTo(7.6055f, 4.0f, 4.001f, 7.6046f, 4.001f, 12.0f)
                curveTo(4.001f, 16.3954f, 7.6055f, 20.0f, 12.001f, 20.0f)
                curveTo(16.3964f, 20.0f, 20.001f, 16.3954f, 20.001f, 12.0f)
                curveTo(20.001f, 7.5857f, 16.4276f, 4.0f, 12.001f, 4.0f)
                close()
...
private var `_spotify-line`: ImageVector? = null
