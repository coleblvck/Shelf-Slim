...
public val HealthGroup.`Dossier-line`: ImageVector
    get() {
        if (`_dossier-line` != null) {
            return `_dossier-line`!!
        }
        `_dossier-line` = Builder(name = "Dossier-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_dossier-line`: ImageVector? = null
