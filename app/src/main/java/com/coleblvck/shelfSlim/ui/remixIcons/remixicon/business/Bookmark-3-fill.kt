...
public val BusinessGroup.`Bookmark-3-fill`: ImageVector
    get() {
        if (`_bookmark-3-fill` != null) {
            return `_bookmark-3-fill`!!
        }
        `_bookmark-3-fill` = Builder(name = "Bookmark-3-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_bookmark-3-fill`: ImageVector? = null
