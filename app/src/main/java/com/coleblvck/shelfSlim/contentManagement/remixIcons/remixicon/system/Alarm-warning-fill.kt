...
public val SystemGroup.`Alarm-warning-fill`: ImageVector
    get() {
        if (`_alarm-warning-fill` != null) {
            return `_alarm-warning-fill`!!
        }
        `_alarm-warning-fill` = Builder(name = "Alarm-warning-fill", defaultWidth = 24.0.dp,
...
private var `_alarm-warning-fill`: ImageVector? = null
