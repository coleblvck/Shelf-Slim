...
public val DeviceGroup.`Usb-fill`: ImageVector
    get() {
        if (`_usb-fill` != null) {
            return `_usb-fill`!!
        }
        `_usb-fill` = Builder(name = "Usb-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_usb-fill`: ImageVector? = null
