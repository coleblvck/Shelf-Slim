...
public val DevelopmentGroup.`Git-branch-line`: ImageVector
    get() {
        if (`_git-branch-line` != null) {
            return `_git-branch-line`!!
        }
        `_git-branch-line` = Builder(name = "Git-branch-line", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.0f, 5.0f)
                curveTo(17.4477f, 5.0f, 17.0f, 5.4477f, 17.0f, 6.0f)
                curveTo(17.0f, 6.5523f, 17.4477f, 7.0f, 18.0f, 7.0f)
...
private var `_git-branch-line`: ImageVector? = null
