...
public val DocumentGroup.`File-chart-fill`: ImageVector
    get() {
        if (`_file-chart-fill` != null) {
            return `_file-chart-fill`!!
        }
        `_file-chart-fill` = Builder(name = "File-chart-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_file-chart-fill`: ImageVector? = null
