...
public val DeviceGroup.`Save-2-line`: ImageVector
    get() {
        if (`_save-2-line` != null) {
            return `_save-2-line`!!
        }
        `_save-2-line` = Builder(name = "Save-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_save-2-line`: ImageVector? = null
