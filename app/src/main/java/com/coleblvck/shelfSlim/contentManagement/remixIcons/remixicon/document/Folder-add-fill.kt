...
public val DocumentGroup.`Folder-add-fill`: ImageVector
    get() {
        if (`_folder-add-fill` != null) {
            return `_folder-add-fill`!!
        }
        `_folder-add-fill` = Builder(name = "Folder-add-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_folder-add-fill`: ImageVector? = null
