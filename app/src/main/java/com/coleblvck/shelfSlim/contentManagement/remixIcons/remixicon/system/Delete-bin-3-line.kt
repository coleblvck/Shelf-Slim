...
public val SystemGroup.`Delete-bin-3-line`: ImageVector
    get() {
        if (`_delete-bin-3-line` != null) {
            return `_delete-bin-3-line`!!
        }
        `_delete-bin-3-line` = Builder(name = "Delete-bin-3-line", defaultWidth = 24.0.dp,
...
private var `_delete-bin-3-line`: ImageVector? = null
