...
public val WeatherGroup.`Sparkling-fill`: ImageVector
    get() {
        if (`_sparkling-fill` != null) {
            return `_sparkling-fill`!!
        }
        `_sparkling-fill` = Builder(name = "Sparkling-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sparkling-fill`: ImageVector? = null
