...
public val DesignGroup.`Contrast-drop-line`: ImageVector
    get() {
        if (`_contrast-drop-line` != null) {
            return `_contrast-drop-line`!!
        }
        `_contrast-drop-line` = Builder(name = "Contrast-drop-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 17.9968f)
                verticalLineTo(7.9968f)
                curveTo(14.7614f, 7.9968f, 17.0f, 10.2354f, 17.0f, 12.9968f)
...
private var `_contrast-drop-line`: ImageVector? = null
