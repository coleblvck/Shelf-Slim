...
public val DesignGroup.`Mark-pen-line`: ImageVector
    get() {
        if (`_mark-pen-line` != null) {
            return `_mark-pen-line`!!
        }
        `_mark-pen-line` = Builder(name = "Mark-pen-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(15.2427f, 4.5115f)
                lineTo(8.5055f, 11.2487f)
                lineTo(7.7984f, 13.37f)
                lineTo(6.7574f, 14.411f)
                lineTo(9.5858f, 17.2394f)
                lineTo(10.6268f, 16.1985f)
                lineTo(12.7481f, 15.4913f)
                lineTo(19.4853f, 8.7541f)
                lineTo(15.2427f, 4.5115f)
                close()
                moveTo(21.6066f, 8.047f)
                ...
                close()
                moveTo(15.2427f, 7.3399f)
                lineTo(16.6569f, 8.7541f)
                lineTo(11.7071f, 13.7039f)
                lineTo(10.2929f, 12.2897f)
                lineTo(15.2427f, 7.3399f)
                close()
...
private var `_mark-pen-line`: ImageVector? = null
