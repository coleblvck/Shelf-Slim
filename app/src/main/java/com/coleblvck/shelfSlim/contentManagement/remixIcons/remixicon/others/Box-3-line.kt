...
public val OthersGroup.`Box-3-line`: ImageVector
    get() {
        if (`_box-3-line` != null) {
            return `_box-3-line`!!
        }
        `_box-3-line` = Builder(name = "Box-3-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.0001f, 10.8444f)
                lineTo(18.5062f, 7.0777f)
                lineTo(12.0f, 3.311f)
                ...
                lineTo(4.5f, 8.8133f)
                close()
                moveTo(13.0001f, 20.11f)
                lineTo(19.5f, 16.3469f)
                verticalLineTo(8.8134f)
                lineTo(13.0001f, 12.5765f)
...
private var `_box-3-line`: ImageVector? = null
