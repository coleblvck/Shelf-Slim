...
public val FinanceGroup.`Money-dollar-box-fill`: ImageVector
    get() {
        if (`_money-dollar-box-fill` != null) {
            return `_money-dollar-box-fill`!!
        }
        `_money-dollar-box-fill` = Builder(name = "Money-dollar-box-fill", defaultWidth = 24.0.dp,
...
private var `_money-dollar-box-fill`: ImageVector? = null
