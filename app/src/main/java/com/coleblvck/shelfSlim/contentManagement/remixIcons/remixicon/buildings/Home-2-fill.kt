...
public val BuildingsGroup.`Home-2-fill`: ImageVector
    get() {
        if (`_home-2-fill` != null) {
            return `_home-2-fill`!!
        }
        `_home-2-fill` = Builder(name = "Home-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-2-fill`: ImageVector? = null
