...
public val EditorGroup.`Insert-column-right`: ImageVector
    get() {
        if (`_insert-column-right` != null) {
            return `_insert-column-right`!!
        }
        `_insert-column-right` = Builder(name = "Insert-column-right", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.0f, 9.2386f, 15.2386f, 7.0f, 18.0f, 7.0f)
                close()
                moveTo(19.0f, 9.0f)
...
private var `_insert-column-right`: ImageVector? = null
