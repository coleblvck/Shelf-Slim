...
public val MapGroup.`E-bike-2-fill`: ImageVector
    get() {
        if (`_e-bike-2-fill` != null) {
            return `_e-bike-2-fill`!!
        }
        `_e-bike-2-fill` = Builder(name = "E-bike-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_e-bike-2-fill`: ImageVector? = null
