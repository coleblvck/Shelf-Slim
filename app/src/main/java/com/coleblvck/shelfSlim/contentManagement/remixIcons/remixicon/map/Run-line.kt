...
public val MapGroup.`Run-line`: ImageVector
    get() {
        if (`_run-line` != null) {
            return `_run-line`!!
        }
        `_run-line` = Builder(name = "Run-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.9008f, 14.4085f)
                lineTo(15.0f, 16.17f)
                verticalLineTo(23.0f)
                horizontalLineTo(13.0f)
                verticalLineTo(17.1025f)
                lineTo(10.7307f, 15.1984f)
...
private var `_run-line`: ImageVector? = null
