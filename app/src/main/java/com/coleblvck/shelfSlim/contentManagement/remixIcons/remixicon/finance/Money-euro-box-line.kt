...
public val FinanceGroup.`Money-euro-box-line`: ImageVector
    get() {
        if (`_money-euro-box-line` != null) {
            return `_money-euro-box-line`!!
        }
        `_money-euro-box-line` = Builder(name = "Money-euro-box-line", defaultWidth = 24.0.dp,
...
private var `_money-euro-box-line`: ImageVector? = null
