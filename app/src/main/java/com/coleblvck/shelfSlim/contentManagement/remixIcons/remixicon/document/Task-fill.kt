...
public val DocumentGroup.`Task-fill`: ImageVector
    get() {
        if (`_task-fill` != null) {
            return `_task-fill`!!
        }
        `_task-fill` = Builder(name = "Task-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_task-fill`: ImageVector? = null
