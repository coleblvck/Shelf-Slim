...
public val FinanceGroup.`Money-dollar-circle-line`: ImageVector
    get() {
        if (`_money-dollar-circle-line` != null) {
            return `_money-dollar-circle-line`!!
        }
        `_money-dollar-circle-line` = Builder(name = "Money-dollar-circle-line", defaultWidth =
...
private var `_money-dollar-circle-line`: ImageVector? = null
