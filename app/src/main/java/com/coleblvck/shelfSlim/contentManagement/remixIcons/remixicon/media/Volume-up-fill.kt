...
public val MediaGroup.`Volume-up-fill`: ImageVector
    get() {
        if (`_volume-up-fill` != null) {
            return `_volume-up-fill`!!
        }
        `_volume-up-fill` = Builder(name = "Volume-up-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_volume-up-fill`: ImageVector? = null
