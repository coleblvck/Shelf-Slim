...
public val SystemGroup.`Settings-2-line`: ImageVector
    get() {
        if (`_settings-2-line` != null) {
            return `_settings-2-line`!!
        }
        `_settings-2-line` = Builder(name = "Settings-2-line", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(6.0001f, 6.0001f)
                verticalLineTo(9.5148f)
                lineTo(3.5148f, 12.0001f)
                lineTo(6.0001f, 14.4854f)
                verticalLineTo(18.0001f)
                horizontalLineTo(9.5148f)
                lineTo(12.0001f, 20.4854f)
                lineTo(14.4854f, 18.0001f)
                horizontalLineTo(18.0001f)
                verticalLineTo(14.4854f)
                lineTo(20.4854f, 12.0001f)
                lineTo(18.0001f, 9.5148f)
                verticalLineTo(6.0001f)
                horizontalLineTo(14.4854f)
                lineTo(12.0001f, 3.5148f)
                lineTo(9.5148f, 6.0001f)
                horizontalLineTo(6.0001f)
                close()
                moveTo(12.0001f, 16.0001f)
                curveTo(9.7909f, 16.0001f, 8.0001f, 14.2092f, 8.0001f, 12.0001f)
                curveTo(8.0001f, 9.7909f, 9.7909f, 8.0001f, 12.0001f, 8.0001f)
                curveTo(14.2092f, 8.0001f, 16.0001f, 9.7909f, 16.0001f, 12.0001f)
                curveTo(16.0001f, 14.2092f, 14.2092f, 16.0001f, 12.0001f, 16.0001f)
                close()
                moveTo(12.0001f, 14.0001f)
                curveTo(13.1047f, 14.0001f, 14.0001f, 13.1047f, 14.0001f, 12.0001f)
                curveTo(14.0001f, 10.8955f, 13.1047f, 10.0001f, 12.0001f, 10.0001f)
                curveTo(10.8955f, 10.0001f, 10.0001f, 10.8955f, 10.0001f, 12.0001f)
                curveTo(10.0001f, 13.1047f, 10.8955f, 14.0001f, 12.0001f, 14.0001f)
                close()
            }
        }
        .build()
...
private var `_settings-2-line`: ImageVector? = null
