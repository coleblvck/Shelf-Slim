...
public val CommunicationGroup.`Message-line`: ImageVector
    get() {
        if (`_message-line` != null) {
            return `_message-line`!!
        }
        `_message-line` = Builder(name = "Message-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-line`: ImageVector? = null
