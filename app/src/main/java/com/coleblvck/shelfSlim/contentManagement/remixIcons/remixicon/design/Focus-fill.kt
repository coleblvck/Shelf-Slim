...
public val DesignGroup.`Focus-fill`: ImageVector
    get() {
        if (`_focus-fill` != null) {
            return `_focus-fill`!!
        }
        `_focus-fill` = Builder(name = "Focus-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_focus-fill`: ImageVector? = null
