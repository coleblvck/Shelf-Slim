...
public val SystemGroup.`Star-half-line`: ImageVector
    get() {
        if (`_star-half-line` != null) {
            return `_star-half-line`!!
        }
        `_star-half-line` = Builder(name = "Star-half-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_star-half-line`: ImageVector? = null
