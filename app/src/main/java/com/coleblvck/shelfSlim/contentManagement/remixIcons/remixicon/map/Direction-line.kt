...
public val MapGroup.`Direction-line`: ImageVector
    get() {
        if (`_direction-line` != null) {
            return `_direction-line`!!
        }
        `_direction-line` = Builder(name = "Direction-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0001f, 3.5148f)
...
private var `_direction-line`: ImageVector? = null
