...
public val HealthGroup.`Health-book-line`: ImageVector
    get() {
        if (`_health-book-line` != null) {
            return `_health-book-line`!!
        }
        `_health-book-line` = Builder(name = "Health-book-line", defaultWidth = 24.0.dp,
...
private var `_health-book-line`: ImageVector? = null
