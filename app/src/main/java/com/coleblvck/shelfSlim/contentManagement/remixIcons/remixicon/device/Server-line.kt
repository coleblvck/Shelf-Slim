...
public val DeviceGroup.`Server-line`: ImageVector
    get() {
        if (`_server-line` != null) {
            return `_server-line`!!
        }
        `_server-line` = Builder(name = "Server-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_server-line`: ImageVector? = null
