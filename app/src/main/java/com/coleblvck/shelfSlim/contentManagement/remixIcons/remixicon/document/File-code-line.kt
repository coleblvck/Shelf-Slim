...
public val DocumentGroup.`File-code-line`: ImageVector
    get() {
        if (`_file-code-line` != null) {
            return `_file-code-line`!!
        }
        `_file-code-line` = Builder(name = "File-code-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-code-line`: ImageVector? = null
