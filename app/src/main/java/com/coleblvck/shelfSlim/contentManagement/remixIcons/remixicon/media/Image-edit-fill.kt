...
public val MediaGroup.`Image-edit-fill`: ImageVector
    get() {
        if (`_image-edit-fill` != null) {
            return `_image-edit-fill`!!
        }
        `_image-edit-fill` = Builder(name = "Image-edit-fill", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.0012f, 14.7562f)
                lineTo(11.995f, 18.995f)
                lineTo(16.2414f, 19.0012f)
                lineTo(17.571f, 17.671f)
...
private var `_image-edit-fill`: ImageVector? = null
