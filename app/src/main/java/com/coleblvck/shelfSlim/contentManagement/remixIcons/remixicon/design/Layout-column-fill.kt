...
public val DesignGroup.`Layout-column-fill`: ImageVector
    get() {
        if (`_layout-column-fill` != null) {
            return `_layout-column-fill`!!
        }
        `_layout-column-fill` = Builder(name = "Layout-column-fill", defaultWidth = 24.0.dp,
...
private var `_layout-column-fill`: ImageVector? = null
