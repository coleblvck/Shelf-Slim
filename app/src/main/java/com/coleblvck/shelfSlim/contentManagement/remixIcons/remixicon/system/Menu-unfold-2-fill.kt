...
public val SystemGroup.`Menu-unfold-2-fill`: ImageVector
    get() {
        if (`_menu-unfold-2-fill` != null) {
            return `_menu-unfold-2-fill`!!
        }
        `_menu-unfold-2-fill` = Builder(name = "Menu-unfold-2-fill", defaultWidth = 24.0.dp,
...
private var `_menu-unfold-2-fill`: ImageVector? = null
