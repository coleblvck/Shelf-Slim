...
public val MapGroup.`Map-pin-add-line`: ImageVector
    get() {
        if (`_map-pin-add-line` != null) {
            return `_map-pin-add-line`!!
        }
        `_map-pin-add-line` = Builder(name = "Map-pin-add-line", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0f, 20.8995f)
...
private var `_map-pin-add-line`: ImageVector? = null
