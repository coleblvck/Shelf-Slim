...
public val EditorGroup.`Page-separator`: ImageVector
    get() {
        if (`_page-separator` != null) {
            return `_page-separator`!!
        }
        `_page-separator` = Builder(name = "Page-separator", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.5523f, 15.0f, 19.0f, 15.4477f, 19.0f, 16.0f)
                verticalLineTo(21.0f)
...
private var `_page-separator`: ImageVector? = null
