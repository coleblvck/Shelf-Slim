...
public val DocumentGroup.`Pages-line`: ImageVector
    get() {
        if (`_pages-line` != null) {
            return `_pages-line`!!
        }
        `_pages-line` = Builder(name = "Pages-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_pages-line`: ImageVector? = null
