...
public val MediaGroup.`Record-circle-fill`: ImageVector
    get() {
        if (`_record-circle-fill` != null) {
            return `_record-circle-fill`!!
        }
        `_record-circle-fill` = Builder(name = "Record-circle-fill", defaultWidth = 24.0.dp,
...
private var `_record-circle-fill`: ImageVector? = null
