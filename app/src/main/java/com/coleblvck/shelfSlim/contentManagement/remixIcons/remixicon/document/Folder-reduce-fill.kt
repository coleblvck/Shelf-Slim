...
public val DocumentGroup.`Folder-reduce-fill`: ImageVector
    get() {
        if (`_folder-reduce-fill` != null) {
            return `_folder-reduce-fill`!!
        }
        `_folder-reduce-fill` = Builder(name = "Folder-reduce-fill", defaultWidth = 24.0.dp,
...
private var `_folder-reduce-fill`: ImageVector? = null
