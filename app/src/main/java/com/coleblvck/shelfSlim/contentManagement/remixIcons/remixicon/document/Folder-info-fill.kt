...
public val DocumentGroup.`Folder-info-fill`: ImageVector
    get() {
        if (`_folder-info-fill` != null) {
            return `_folder-info-fill`!!
        }
        `_folder-info-fill` = Builder(name = "Folder-info-fill", defaultWidth = 24.0.dp,
...
private var `_folder-info-fill`: ImageVector? = null
