...
public val DocumentGroup.`File-pdf-line`: ImageVector
    get() {
        if (`_file-pdf-line` != null) {
            return `_file-pdf-line`!!
        }
        `_file-pdf-line` = Builder(name = "File-pdf-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-pdf-line`: ImageVector? = null
