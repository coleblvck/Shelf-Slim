...
public val SystemGroup.`Loader-4-fill`: ImageVector
    get() {
        if (`_loader-4-fill` != null) {
            return `_loader-4-fill`!!
        }
        `_loader-4-fill` = Builder(name = "Loader-4-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_loader-4-fill`: ImageVector? = null
