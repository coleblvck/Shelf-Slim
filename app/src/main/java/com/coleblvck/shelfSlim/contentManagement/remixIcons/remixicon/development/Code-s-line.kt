...
public val DevelopmentGroup.`Code-s-line`: ImageVector
    get() {
        if (`_code-s-line` != null) {
            return `_code-s-line`!!
        }
        `_code-s-line` = Builder(name = "Code-s-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_code-s-line`: ImageVector? = null
