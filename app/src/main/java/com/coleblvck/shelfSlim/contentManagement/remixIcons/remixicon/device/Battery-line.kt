...
public val DeviceGroup.`Battery-line`: ImageVector
    get() {
        if (`_battery-line` != null) {
            return `_battery-line`!!
        }
        `_battery-line` = Builder(name = "Battery-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_battery-line`: ImageVector? = null
