...
public val SystemGroup.`Import-fill`: ImageVector
    get() {
        if (`_import-fill` != null) {
            return `_import-fill`!!
        }
        `_import-fill` = Builder(name = "Import-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_import-fill`: ImageVector? = null
