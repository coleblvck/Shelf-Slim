...
public val EditorGroup.`Table-3`: ImageVector
    get() {
        if (`_table-3` != null) {
            return `_table-3`!!
        }
        `_table-3` = Builder(name = "Table-3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_table-3`: ImageVector? = null
