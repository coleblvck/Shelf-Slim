...
public val MediaGroup.`Image-2-line`: ImageVector
    get() {
        if (`_image-2-line` != null) {
            return `_image-2-line`!!
        }
        `_image-2-line` = Builder(name = "Image-2-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.0f, 13.9289f)
                verticalLineTo(19.0f)
                horizontalLineTo(8.1005f)
                lineTo(11.0858f, 16.0147f)
                lineTo(7.0f, 11.9289f)
                lineTo(5.0f, 13.9289f)
                close()
                moveTo(10.9289f, 19.0f)
                horizontalLineTo(19.0f)
                verticalLineTo(16.9289f)
                lineTo(16.0f, 13.9289f)
                lineTo(10.9289f, 19.0f)
                close()
                moveTo(4.0f, 3.0f)
...
private var `_image-2-line`: ImageVector? = null
