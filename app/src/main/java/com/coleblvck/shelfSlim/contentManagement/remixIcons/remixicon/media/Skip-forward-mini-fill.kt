...
public val MediaGroup.`Skip-forward-mini-fill`: ImageVector
    get() {
        if (`_skip-forward-mini-fill` != null) {
            return `_skip-forward-mini-fill`!!
        }
        `_skip-forward-mini-fill` = Builder(name = "Skip-forward-mini-fill", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.7883f, 17.4435f)
...
private var `_skip-forward-mini-fill`: ImageVector? = null
