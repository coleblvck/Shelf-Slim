...
public val DevelopmentGroup.`Git-merge-line`: ImageVector
    get() {
        if (`_git-merge-line` != null) {
            return `_git-merge-line`!!
        }
        `_git-merge-line` = Builder(name = "Git-merge-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_git-merge-line`: ImageVector? = null
