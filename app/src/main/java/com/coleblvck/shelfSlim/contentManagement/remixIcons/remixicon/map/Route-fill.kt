...
public val MapGroup.`Route-fill`: ImageVector
    get() {
        if (`_route-fill` != null) {
            return `_route-fill`!!
        }
        `_route-fill` = Builder(name = "Route-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_route-fill`: ImageVector? = null
