...
public val DocumentGroup.`File-text-line`: ImageVector
    get() {
        if (`_file-text-line` != null) {
            return `_file-text-line`!!
        }
        `_file-text-line` = Builder(name = "File-text-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-text-line`: ImageVector? = null
