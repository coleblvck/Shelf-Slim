...
public val SystemGroup.`Hourglass-2-line`: ImageVector
    get() {
        if (`_hourglass-2-line` != null) {
            return `_hourglass-2-line`!!
        }
        `_hourglass-2-line` = Builder(name = "Hourglass-2-line", defaultWidth = 24.0.dp,
...
private var `_hourglass-2-line`: ImageVector? = null
