...
public val BusinessGroup.`Bookmark-2-fill`: ImageVector
    get() {
        if (`_bookmark-2-fill` != null) {
            return `_bookmark-2-fill`!!
        }
        `_bookmark-2-fill` = Builder(name = "Bookmark-2-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_bookmark-2-fill`: ImageVector? = null
