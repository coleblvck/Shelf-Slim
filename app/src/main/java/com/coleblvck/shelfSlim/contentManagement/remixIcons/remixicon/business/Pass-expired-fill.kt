...
public val BusinessGroup.`Pass-expired-fill`: ImageVector
    get() {
        if (`_pass-expired-fill` != null) {
            return `_pass-expired-fill`!!
        }
        `_pass-expired-fill` = Builder(name = "Pass-expired-fill", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.0001f, 10.0f)
                curveTo(9.0001f, 10.5523f, 8.5524f, 11.0f, 8.0001f, 11.0f)
                curveTo(7.4478f, 11.0f, 7.0001f, 10.5523f, 7.0001f, 10.0f)
                curveTo(7.0001f, 9.4477f, 7.4478f, 9.0f, 8.0001f, 9.0f)
                curveTo(8.5524f, 9.0f, 9.0001f, 9.4477f, 9.0001f, 10.0f)
                close()
                moveTo(2.0f, 4.0f)
                ...
                close()
                moveTo(16.0001f, 10.5858f)
                lineTo(17.793f, 8.7929f)
                lineTo(19.2072f, 10.2071f)
                lineTo(17.4143f, 12.0f)
                lineTo(19.2072f, 13.7929f)
                lineTo(17.793f, 15.2071f)
                lineTo(16.0001f, 13.4142f)
                lineTo(14.2072f, 15.2071f)
                lineTo(12.793f, 13.7929f)
                lineTo(14.5859f, 12.0f)
                lineTo(12.793f, 10.2071f)
                lineTo(14.2072f, 8.7929f)
                lineTo(16.0001f, 10.5858f)
                close()
            }
        }
        .build()
...
private var `_pass-expired-fill`: ImageVector? = null
