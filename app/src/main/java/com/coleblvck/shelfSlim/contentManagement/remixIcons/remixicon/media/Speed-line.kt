...
public val MediaGroup.`Speed-line`: ImageVector
    get() {
        if (`_speed-line` != null) {
            return `_speed-line`!!
        }
        `_speed-line` = Builder(name = "Speed-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.3944f, 12.0001f)
                lineTo(4.0f, 7.7371f)
                verticalLineTo(16.263f)
                lineTo(10.3944f, 12.0001f)
                close()
                moveTo(14.0f, 7.7371f)
                verticalLineTo(16.263f)
                lineTo(20.3944f, 12.0001f)
...
private var `_speed-line`: ImageVector? = null
