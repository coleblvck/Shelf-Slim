...
public val DocumentGroup.`Folder-warning-line`: ImageVector
    get() {
        if (`_folder-warning-line` != null) {
            return `_folder-warning-line`!!
        }
        `_folder-warning-line` = Builder(name = "Folder-warning-line", defaultWidth = 24.0.dp,
...
private var `_folder-warning-line`: ImageVector? = null
