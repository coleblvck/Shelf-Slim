...
public val DeviceGroup.`Battery-2-fill`: ImageVector
    get() {
        if (`_battery-2-fill` != null) {
            return `_battery-2-fill`!!
        }
        `_battery-2-fill` = Builder(name = "Battery-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_battery-2-fill`: ImageVector? = null
