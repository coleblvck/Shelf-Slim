...
public val MediaGroup.`Play-reverse-fill`: ImageVector
    get() {
        if (`_play-reverse-fill` != null) {
            return `_play-reverse-fill`!!
        }
        `_play-reverse-fill` = Builder(name = "Play-reverse-fill", defaultWidth = 24.0.dp,
...
private var `_play-reverse-fill`: ImageVector? = null
