...
public val WeatherGroup.`Celsius-fill`: ImageVector
    get() {
        if (`_celsius-fill` != null) {
            return `_celsius-fill`!!
        }
        `_celsius-fill` = Builder(name = "Celsius-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_celsius-fill`: ImageVector? = null
