...
public val MapGroup.`Suitcase-3-line`: ImageVector
    get() {
        if (`_suitcase-3-line` != null) {
            return `_suitcase-3-line`!!
        }
        `_suitcase-3-line` = Builder(name = "Suitcase-3-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_suitcase-3-line`: ImageVector? = null
