...
public val DeviceGroup.`Install-line`: ImageVector
    get() {
        if (`_install-line` != null) {
            return `_install-line`!!
        }
        `_install-line` = Builder(name = "Install-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_install-line`: ImageVector? = null
