...
public val DocumentGroup.`File-copy-line`: ImageVector
    get() {
        if (`_file-copy-line` != null) {
            return `_file-copy-line`!!
        }
        `_file-copy-line` = Builder(name = "File-copy-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-copy-line`: ImageVector? = null
