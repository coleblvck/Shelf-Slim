...
public val DeviceGroup.`Ram-fill`: ImageVector
    get() {
        if (`_ram-fill` != null) {
            return `_ram-fill`!!
        }
        `_ram-fill` = Builder(name = "Ram-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ram-fill`: ImageVector? = null
