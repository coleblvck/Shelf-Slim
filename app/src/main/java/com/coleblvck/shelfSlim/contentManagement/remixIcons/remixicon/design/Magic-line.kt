...
public val DesignGroup.`Magic-line`: ImageVector
    get() {
        if (`_magic-line` != null) {
            return `_magic-line`!!
        }
        `_magic-line` = Builder(name = "Magic-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(15.1986f, 9.9445f)
                curveTo(14.7649f, 9.5337f, 14.4859f, 8.9861f, 14.4085f, 8.3938f)
                lineTo(14.0056f, 5.3114f)
                lineTo(11.275f, 6.7972f)
                curveTo(10.7503f, 7.0827f, 10.1433f, 7.1789f, 9.5561f, 7.0695f)
                lineTo(6.5f, 6.5002f)
                lineTo(7.0693f, 9.5562f)
                curveTo(7.1787f, 10.1435f, 7.0826f, 10.7505f, 6.7971f, 11.2751f)
                lineTo(5.3112f, 14.0057f)
                lineTo(8.3937f, 14.4086f)
                curveTo(8.986f, 14.4861f, 9.5335f, 14.7651f, 9.9443f, 15.1987f)
                lineTo(12.0821f, 17.4557f)
                lineTo(13.4178f, 14.6486f)
                curveTo(13.6745f, 14.1092f, 14.109f, 13.6747f, 14.6484f, 13.418f)
                lineTo(17.4555f, 12.0823f)
                lineTo(15.1986f, 9.9445f)
                close()
...
private var `_magic-line`: ImageVector? = null
