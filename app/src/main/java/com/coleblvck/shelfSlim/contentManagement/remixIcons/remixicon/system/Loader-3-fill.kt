...
public val SystemGroup.`Loader-3-fill`: ImageVector
    get() {
        if (`_loader-3-fill` != null) {
            return `_loader-3-fill`!!
        }
        `_loader-3-fill` = Builder(name = "Loader-3-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_loader-3-fill`: ImageVector? = null
