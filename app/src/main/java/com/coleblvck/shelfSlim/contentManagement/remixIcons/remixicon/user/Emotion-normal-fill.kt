...
public val UserGroup.`Emotion-normal-fill`: ImageVector
    get() {
        if (`_emotion-normal-fill` != null) {
            return `_emotion-normal-fill`!!
        }
        `_emotion-normal-fill` = Builder(name = "Emotion-normal-fill", defaultWidth = 24.0.dp,
...
private var `_emotion-normal-fill`: ImageVector? = null
