...
public val UserGroup.`Account-pin-box-fill`: ImageVector
    get() {
        if (`_account-pin-box-fill` != null) {
            return `_account-pin-box-fill`!!
        }
        `_account-pin-box-fill` = Builder(name = "Account-pin-box-fill", defaultWidth = 24.0.dp,
...
private var `_account-pin-box-fill`: ImageVector? = null
