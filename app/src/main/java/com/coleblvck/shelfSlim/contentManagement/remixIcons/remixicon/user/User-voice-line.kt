...
public val UserGroup.`User-voice-line`: ImageVector
    get() {
        if (`_user-voice-line` != null) {
            return `_user-voice-line`!!
        }
        `_user-voice-line` = Builder(name = "User-voice-line", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(15.0f, 18.6863f, 12.3137f, 16.0f, 9.0f, 16.0f)
                curveTo(5.6863f, 16.0f, 3.0f, 18.6863f, 3.0f, 22.0f)
...
private var `_user-voice-line`: ImageVector? = null
