...
public val ArrowsGroup.`Arrow-down-circle-fill`: ImageVector
    get() {
        if (`_arrow-down-circle-fill` != null) {
            return `_arrow-down-circle-fill`!!
        }
        `_arrow-down-circle-fill` = Builder(name = "Arrow-down-circle-fill", defaultWidth = 24.0.dp,
...
private var `_arrow-down-circle-fill`: ImageVector? = null
