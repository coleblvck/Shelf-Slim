...
public val DocumentGroup.`File-ppt-line`: ImageVector
    get() {
        if (`_file-ppt-line` != null) {
            return `_file-ppt-line`!!
        }
        `_file-ppt-line` = Builder(name = "File-ppt-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-ppt-line`: ImageVector? = null
