...
public val MapGroup.`Charging-pile-fill`: ImageVector
    get() {
        if (`_charging-pile-fill` != null) {
            return `_charging-pile-fill`!!
        }
        `_charging-pile-fill` = Builder(name = "Charging-pile-fill", defaultWidth = 24.0.dp,
...
private var `_charging-pile-fill`: ImageVector? = null
