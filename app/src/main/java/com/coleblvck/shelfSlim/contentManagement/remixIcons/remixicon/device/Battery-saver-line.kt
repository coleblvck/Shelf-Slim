...
public val DeviceGroup.`Battery-saver-line`: ImageVector
    get() {
        if (`_battery-saver-line` != null) {
            return `_battery-saver-line`!!
        }
        `_battery-saver-line` = Builder(name = "Battery-saver-line", defaultWidth = 24.0.dp,
...
private var `_battery-saver-line`: ImageVector? = null
