...
public val DocumentGroup.`File-excel-line`: ImageVector
    get() {
        if (`_file-excel-line` != null) {
            return `_file-excel-line`!!
        }
        `_file-excel-line` = Builder(name = "File-excel-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_file-excel-line`: ImageVector? = null
