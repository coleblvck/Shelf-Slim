...
public val CommunicationGroup.`Chat-delete-line`: ImageVector
    get() {
        if (`_chat-delete-line` != null) {
            return `_chat-delete-line`!!
        }
        `_chat-delete-line` = Builder(name = "Chat-delete-line", defaultWidth = 24.0.dp,
...
private var `_chat-delete-line`: ImageVector? = null
