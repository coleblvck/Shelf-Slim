...
public val MediaGroup.`_4k-line`: ImageVector
    get() {
        if (`__4k-line` != null) {
            return `__4k-line`!!
        }
        `__4k-line` = Builder(name = "_4k-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `__4k-line`: ImageVector? = null
