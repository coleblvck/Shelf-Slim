...
public val DevelopmentGroup.`Code-s-slash-fill`: ImageVector
    get() {
        if (`_code-s-slash-fill` != null) {
            return `_code-s-slash-fill`!!
        }
        `_code-s-slash-fill` = Builder(name = "Code-s-slash-fill", defaultWidth = 24.0.dp,
...
private var `_code-s-slash-fill`: ImageVector? = null
