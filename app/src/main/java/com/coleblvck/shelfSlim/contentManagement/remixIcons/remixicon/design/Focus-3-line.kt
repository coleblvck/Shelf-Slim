...
public val DesignGroup.`Focus-3-line`: ImageVector
    get() {
        if (`_focus-3-line` != null) {
            return `_focus-3-line`!!
        }
        `_focus-3-line` = Builder(name = "Focus-3-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_focus-3-line`: ImageVector? = null
