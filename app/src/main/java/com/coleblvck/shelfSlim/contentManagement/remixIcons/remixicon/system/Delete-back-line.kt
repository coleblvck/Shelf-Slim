...
public val SystemGroup.`Delete-back-line`: ImageVector
    get() {
        if (`_delete-back-line` != null) {
            return `_delete-back-line`!!
        }
        `_delete-back-line` = Builder(name = "Delete-back-line", defaultWidth = 24.0.dp,
...
private var `_delete-back-line`: ImageVector? = null
