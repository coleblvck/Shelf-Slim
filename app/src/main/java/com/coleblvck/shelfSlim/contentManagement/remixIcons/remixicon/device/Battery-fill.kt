...
public val DeviceGroup.`Battery-fill`: ImageVector
    get() {
        if (`_battery-fill` != null) {
            return `_battery-fill`!!
        }
        `_battery-fill` = Builder(name = "Battery-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_battery-fill`: ImageVector? = null
