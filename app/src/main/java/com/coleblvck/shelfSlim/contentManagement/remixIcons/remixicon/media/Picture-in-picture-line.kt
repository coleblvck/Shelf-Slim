...
public val MediaGroup.`Picture-in-picture-line`: ImageVector
    get() {
        if (`_picture-in-picture-line` != null) {
            return `_picture-in-picture-line`!!
        }
        `_picture-in-picture-line` = Builder(name = "Picture-in-picture-line", defaultWidth =
...
private var `_picture-in-picture-line`: ImageVector? = null
