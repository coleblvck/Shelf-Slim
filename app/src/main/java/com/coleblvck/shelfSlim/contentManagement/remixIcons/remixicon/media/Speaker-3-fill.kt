...
public val MediaGroup.`Speaker-3-fill`: ImageVector
    get() {
        if (`_speaker-3-fill` != null) {
            return `_speaker-3-fill`!!
        }
        `_speaker-3-fill` = Builder(name = "Speaker-3-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_speaker-3-fill`: ImageVector? = null
