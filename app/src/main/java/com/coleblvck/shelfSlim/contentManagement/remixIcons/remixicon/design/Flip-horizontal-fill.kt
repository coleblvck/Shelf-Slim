...
public val DesignGroup.`Flip-horizontal-fill`: ImageVector
    get() {
        if (`_flip-horizontal-fill` != null) {
            return `_flip-horizontal-fill`!!
        }
        `_flip-horizontal-fill` = Builder(name = "Flip-horizontal-fill", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(6.0f)
                curveTo(9.0f, 4.8954f, 8.1046f, 4.0f, 7.0f, 4.0f)
                horizontalLineTo(4.0f)
                close()
                moveTo(15.0f, 6.0f)
                curveTo(15.0f, 4.8954f, 15.8954f, 4.0f, 17.0f, 4.0f)
                horizontalLineTo(20.0f)
                curveTo(21.1046f, 4.0f, 22.0f, 4.8954f, 22.0f, 6.0f)
                verticalLineTo(18.0f)
                curveTo(22.0f, 19.1046f, 21.1046f, 20.0f, 20.0f, 20.0f)
                horizontalLineTo(17.0f)
                curveTo(15.8954f, 20.0f, 15.0f, 19.1046f, 15.0f, 18.0f)
                verticalLineTo(6.0f)
                close()
            }
        }
