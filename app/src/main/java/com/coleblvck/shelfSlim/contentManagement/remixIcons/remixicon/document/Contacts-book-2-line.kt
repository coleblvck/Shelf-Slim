...
public val DocumentGroup.`Contacts-book-2-line`: ImageVector
    get() {
        if (`_contacts-book-2-line` != null) {
            return `_contacts-book-2-line`!!
        }
        `_contacts-book-2-line` = Builder(name = "Contacts-book-2-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.0f, 16.1707f)
                curveTo(5.3128f, 16.0602f, 5.6494f, 16.0f, 6.0f, 16.0f)
                horizontalLineTo(19.0f)
                verticalLineTo(4.0f)
                horizontalLineTo(6.0f)
                ...
                close()
                moveTo(9.0f, 14.0f)
                curveTo(9.0f, 12.3431f, 10.3431f, 11.0f, 12.0f, 11.0f)
                curveTo(13.6569f, 11.0f, 15.0f, 12.3431f, 15.0f, 14.0f)
...
private var `_contacts-book-2-line`: ImageVector? = null
