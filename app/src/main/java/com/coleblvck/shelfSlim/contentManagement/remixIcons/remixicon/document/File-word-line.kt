...
public val DocumentGroup.`File-word-line`: ImageVector
    get() {
        if (`_file-word-line` != null) {
            return `_file-word-line`!!
        }
        `_file-word-line` = Builder(name = "File-word-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-word-line`: ImageVector? = null
