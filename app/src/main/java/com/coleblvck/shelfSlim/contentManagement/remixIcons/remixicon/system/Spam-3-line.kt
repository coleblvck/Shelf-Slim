...
public val SystemGroup.`Spam-3-line`: ImageVector
    get() {
        if (`_spam-3-line` != null) {
            return `_spam-3-line`!!
        }
        `_spam-3-line` = Builder(name = "Spam-3-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_spam-3-line`: ImageVector? = null
