...
public val DeviceGroup.`Sim-card-fill`: ImageVector
    get() {
        if (`_sim-card-fill` != null) {
            return `_sim-card-fill`!!
        }
        `_sim-card-fill` = Builder(name = "Sim-card-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sim-card-fill`: ImageVector? = null
