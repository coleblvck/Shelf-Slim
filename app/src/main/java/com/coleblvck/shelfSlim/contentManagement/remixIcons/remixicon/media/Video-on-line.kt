...
public val MediaGroup.`Video-on-line`: ImageVector
    get() {
        if (`_video-on-line` != null) {
            return `_video-on-line`!!
        }
        `_video-on-line` = Builder(name = "Video-on-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_video-on-line`: ImageVector? = null
