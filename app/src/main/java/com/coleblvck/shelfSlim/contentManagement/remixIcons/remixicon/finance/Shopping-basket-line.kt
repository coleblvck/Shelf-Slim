...
public val FinanceGroup.`Shopping-basket-line`: ImageVector
    get() {
        if (`_shopping-basket-line` != null) {
            return `_shopping-basket-line`!!
        }
        `_shopping-basket-line` = Builder(name = "Shopping-basket-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.8309f, 11.0f)
                horizontalLineTo(5.1779f)
                lineTo(5.8449f, 19.0f)
                horizontalLineTo(18.1639f)
                lineTo(18.8309f, 11.0f)
                close()
...
private var `_shopping-basket-line`: ImageVector? = null
