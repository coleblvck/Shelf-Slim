...
public val DocumentGroup.`File-list-3-fill`: ImageVector
    get() {
        if (`_file-list-3-fill` != null) {
            return `_file-list-3-fill`!!
        }
        `_file-list-3-fill` = Builder(name = "File-list-3-fill", defaultWidth = 24.0.dp,
...
private var `_file-list-3-fill`: ImageVector? = null
