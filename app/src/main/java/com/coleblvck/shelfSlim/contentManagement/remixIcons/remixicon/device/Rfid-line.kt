...
public val DeviceGroup.`Rfid-line`: ImageVector
    get() {
        if (`_rfid-line` != null) {
            return `_rfid-line`!!
        }
        `_rfid-line` = Builder(name = "Rfid-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_rfid-line`: ImageVector? = null
