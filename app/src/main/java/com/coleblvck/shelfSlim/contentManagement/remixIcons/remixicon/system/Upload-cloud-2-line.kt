...
public val SystemGroup.`Upload-cloud-2-line`: ImageVector
    get() {
        if (`_upload-cloud-2-line` != null) {
            return `_upload-cloud-2-line`!!
        }
        `_upload-cloud-2-line` = Builder(name = "Upload-cloud-2-line", defaultWidth = 24.0.dp,
...
private var `_upload-cloud-2-line`: ImageVector? = null
