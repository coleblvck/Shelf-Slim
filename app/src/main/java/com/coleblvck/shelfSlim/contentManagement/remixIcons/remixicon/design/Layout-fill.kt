...
public val DesignGroup.`Layout-fill`: ImageVector
    get() {
        if (`_layout-fill` != null) {
            return `_layout-fill`!!
        }
        `_layout-fill` = Builder(name = "Layout-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_layout-fill`: ImageVector? = null
