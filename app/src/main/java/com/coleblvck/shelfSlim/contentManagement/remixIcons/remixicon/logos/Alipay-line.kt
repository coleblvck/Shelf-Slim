...
public val LogosGroup.`Alipay-line`: ImageVector
    get() {
        if (`_alipay-line` != null) {
            return `_alipay-line`!!
        }
        `_alipay-line` = Builder(name = "Alipay-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.4079f, 16.7903f)
                curveTo(16.2353f, 15.8398f, 14.6887f, 15.1443f, 13.768f, 14.704f)
                ...
                curveTo(15.2543f, 13.4776f, 16.841f, 13.9718f, 19.5043f, 14.7785f)
                curveTo(19.8249f, 13.913f, 20.0f, 12.977f, 20.0f, 12.0f)
                curveTo(20.0f, 7.5817f, 16.4183f, 4.0f, 12.0f, 4.0f)
                curveTo(7.5817f, 4.0f, 4.0f, 7.5817f, 4.0f, 12.0f)
                curveTo(4.0f, 16.4183f, 7.5817f, 20.0f, 12.0f, 20.0f)
                curveTo(14.6217f, 20.0f, 16.9488f, 18.7389f, 18.4079f, 16.7903f)
                close()
                moveTo(12.0f, 22.0f)
...
private var `_alipay-line`: ImageVector? = null
