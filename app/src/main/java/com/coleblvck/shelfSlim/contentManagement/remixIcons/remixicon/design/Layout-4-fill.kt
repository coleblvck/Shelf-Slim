...
public val DesignGroup.`Layout-4-fill`: ImageVector
    get() {
        if (`_layout-4-fill` != null) {
            return `_layout-4-fill`!!
        }
        `_layout-4-fill` = Builder(name = "Layout-4-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_layout-4-fill`: ImageVector? = null
