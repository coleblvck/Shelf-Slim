...
public val DeviceGroup.`Dual-sim-1-fill`: ImageVector
    get() {
        if (`_dual-sim-1-fill` != null) {
            return `_dual-sim-1-fill`!!
        }
        `_dual-sim-1-fill` = Builder(name = "Dual-sim-1-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_dual-sim-1-fill`: ImageVector? = null
