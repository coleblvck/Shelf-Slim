...
public val BuildingsGroup.`Hotel-line`: ImageVector
    get() {
        if (`_hotel-line` != null) {
            return `_hotel-line`!!
        }
        `_hotel-line` = Builder(name = "Hotel-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hotel-line`: ImageVector? = null
