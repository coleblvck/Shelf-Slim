...
public val DesignGroup.`Focus-2-line`: ImageVector
    get() {
        if (`_focus-2-line` != null) {
            return `_focus-2-line`!!
        }
        `_focus-2-line` = Builder(name = "Focus-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_focus-2-line`: ImageVector? = null
