...
public val SystemGroup.`Check-double-line`: ImageVector
    get() {
        if (`_check-double-line` != null) {
            return `_check-double-line`!!
        }
        `_check-double-line` = Builder(name = "Check-double-line", defaultWidth = 24.0.dp,
...
private var `_check-double-line`: ImageVector? = null
