...
public val UserGroup.`Men-fill`: ImageVector
    get() {
        if (`_men-fill` != null) {
            return `_men-fill`!!
        }
        `_men-fill` = Builder(name = "Men-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.5858f, 5.0f)
...
private var `_men-fill`: ImageVector? = null
