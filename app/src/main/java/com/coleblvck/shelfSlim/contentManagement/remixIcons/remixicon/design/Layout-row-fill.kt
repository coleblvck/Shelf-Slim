...
public val DesignGroup.`Layout-row-fill`: ImageVector
    get() {
        if (`_layout-row-fill` != null) {
            return `_layout-row-fill`!!
        }
        `_layout-row-fill` = Builder(name = "Layout-row-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_layout-row-fill`: ImageVector? = null
