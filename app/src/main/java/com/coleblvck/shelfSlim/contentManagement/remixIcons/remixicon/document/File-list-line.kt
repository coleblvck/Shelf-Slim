...
public val DocumentGroup.`File-list-line`: ImageVector
    get() {
        if (`_file-list-line` != null) {
            return `_file-list-line`!!
        }
        `_file-list-line` = Builder(name = "File-list-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-list-line`: ImageVector? = null
