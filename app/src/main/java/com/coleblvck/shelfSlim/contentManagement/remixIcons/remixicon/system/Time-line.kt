...
public val SystemGroup.`Time-line`: ImageVector
    get() {
        if (`_time-line` != null) {
            return `_time-line`!!
        }
        `_time-line` = Builder(name = "Time-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_time-line`: ImageVector? = null
