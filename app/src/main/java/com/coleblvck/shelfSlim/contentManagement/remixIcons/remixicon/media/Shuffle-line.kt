...
public val MediaGroup.`Shuffle-line`: ImageVector
    get() {
        if (`_shuffle-line` != null) {
            return `_shuffle-line`!!
        }
        `_shuffle-line` = Builder(name = "Shuffle-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_shuffle-line`: ImageVector? = null
