...
public val MediaGroup.`Play-line`: ImageVector
    get() {
        if (`_play-line` != null) {
            return `_play-line`!!
        }
        `_play-line` = Builder(name = "Play-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(16.3944f, 12.0001f)
                lineTo(10.0f, 7.7371f)
...
private var `_play-line`: ImageVector? = null
