...
public val UserGroup.`Emotion-2-fill`: ImageVector
    get() {
        if (`_emotion-2-fill` != null) {
            return `_emotion-2-fill`!!
        }
        `_emotion-2-fill` = Builder(name = "Emotion-2-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_emotion-2-fill`: ImageVector? = null
