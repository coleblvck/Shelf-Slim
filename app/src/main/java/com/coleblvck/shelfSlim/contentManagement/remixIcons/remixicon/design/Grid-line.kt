...
public val DesignGroup.`Grid-line`: ImageVector
    get() {
        if (`_grid-line` != null) {
            return `_grid-line`!!
        }
        `_grid-line` = Builder(name = "Grid-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_grid-line`: ImageVector? = null
