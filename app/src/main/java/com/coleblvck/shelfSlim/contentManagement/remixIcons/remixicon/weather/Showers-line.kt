...
public val WeatherGroup.`Showers-line`: ImageVector
    get() {
        if (`_showers-line` != null) {
            return `_showers-line`!!
        }
        `_showers-line` = Builder(name = "Showers-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_showers-line`: ImageVector? = null
