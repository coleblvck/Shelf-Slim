...
public val SystemGroup.`Lock-unlock-fill`: ImageVector
    get() {
        if (`_lock-unlock-fill` != null) {
            return `_lock-unlock-fill`!!
        }
        `_lock-unlock-fill` = Builder(name = "Lock-unlock-fill", defaultWidth = 24.0.dp,
...
private var `_lock-unlock-fill`: ImageVector? = null
