...
public val OthersGroup.`Football-line`: ImageVector
    get() {
        if (`_football-line` != null) {
            return `_football-line`!!
        }
        `_football-line` = Builder(name = "Football-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.7076f, 4.3333f)
                curveTo(8.0002f, 4.8431f, 6.5322f, 5.9076f, 5.5126f, 7.3178f)
                lineTo(6.0665f, 9.0199f)
                lineTo(8.3055f, 9.7469f)
                lineTo(10.9995f, 7.7899f)
                verticalLineTo(5.2729f)
                lineTo(9.7076f, 4.3333f)
                close()
            }
        }
        .build()
...
private var `_football-line`: ImageVector? = null
