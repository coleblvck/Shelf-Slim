...
public val BusinessGroup.`Bookmark-2-line`: ImageVector
    get() {
        if (`_bookmark-2-line` != null) {
            return `_bookmark-2-line`!!
        }
        `_bookmark-2-line` = Builder(name = "Bookmark-2-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_bookmark-2-line`: ImageVector? = null
