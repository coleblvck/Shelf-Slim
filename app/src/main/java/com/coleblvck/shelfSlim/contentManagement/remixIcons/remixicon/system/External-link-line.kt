...
public val SystemGroup.`External-link-line`: ImageVector
    get() {
        if (`_external-link-line` != null) {
            return `_external-link-line`!!
        }
        `_external-link-line` = Builder(name = "External-link-line", defaultWidth = 24.0.dp,
...
private var `_external-link-line`: ImageVector? = null
