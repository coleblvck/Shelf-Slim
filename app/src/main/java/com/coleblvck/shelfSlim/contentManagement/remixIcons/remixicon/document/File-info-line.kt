...
public val DocumentGroup.`File-info-line`: ImageVector
    get() {
        if (`_file-info-line` != null) {
            return `_file-info-line`!!
        }
        `_file-info-line` = Builder(name = "File-info-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-info-line`: ImageVector? = null
