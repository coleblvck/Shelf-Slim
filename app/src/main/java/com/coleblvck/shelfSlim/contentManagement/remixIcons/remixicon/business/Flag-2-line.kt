...
public val BusinessGroup.`Flag-2-line`: ImageVector
    get() {
        if (`_flag-2-line` != null) {
            return `_flag-2-line`!!
        }
        `_flag-2-line` = Builder(name = "Flag-2-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.1384f, 3.0f)
                ...
                close()
                moveTo(18.5536f, 5.0f)
                horizontalLineTo(4.0f)
                verticalLineTo(15.0f)
                horizontalLineTo(18.5536f)
                lineTo(15.6965f, 10.0f)
                lineTo(18.5536f, 5.0f)
                close()
            }
        }
        .build()
...
private var `_flag-2-line`: ImageVector? = null
