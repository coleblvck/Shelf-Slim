...
public val DeviceGroup.`Uninstall-line`: ImageVector
    get() {
        if (`_uninstall-line` != null) {
            return `_uninstall-line`!!
        }
        `_uninstall-line` = Builder(name = "Uninstall-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_uninstall-line`: ImageVector? = null
