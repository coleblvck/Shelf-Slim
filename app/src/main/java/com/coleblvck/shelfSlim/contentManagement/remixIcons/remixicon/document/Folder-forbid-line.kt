...
public val DocumentGroup.`Folder-forbid-line`: ImageVector
    get() {
        if (`_folder-forbid-line` != null) {
            return `_folder-forbid-line`!!
        }
        `_folder-forbid-line` = Builder(name = "Folder-forbid-line", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(22.0f, 11.2547f)
                curveTo(21.396f, 10.8334f, 20.7224f, 10.5049f, 20.0f, 10.2899f)
                verticalLineTo(7.0f)
                ...
                curveTo(11.5049f, 19.7224f, 11.8334f, 20.396f, 12.2547f, 21.0f)
...
private var `_folder-forbid-line`: ImageVector? = null
