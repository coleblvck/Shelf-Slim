...
public val DesignGroup.`Layout-horizontal-line`: ImageVector
    get() {
        if (`_layout-horizontal-line` != null) {
            return `_layout-horizontal-line`!!
        }
        `_layout-horizontal-line` = Builder(name = "Layout-horizontal-line", defaultWidth = 24.0.dp,
...
private var `_layout-horizontal-line`: ImageVector? = null
