...
public val OthersGroup.`Plug-2-line`: ImageVector
    get() {
        if (`_plug-2-line` != null) {
            return `_plug-2-line`!!
        }
        `_plug-2-line` = Builder(name = "Plug-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_plug-2-line`: ImageVector? = null
