...
public val DesignGroup.`Square-line`: ImageVector
    get() {
        if (`_square-line` != null) {
            return `_square-line`!!
        }
        `_square-line` = Builder(name = "Square-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_square-line`: ImageVector? = null
