...
public val OthersGroup.`Dice-4-fill`: ImageVector
    get() {
        if (`_dice-4-fill` != null) {
            return `_dice-4-fill`!!
        }
        `_dice-4-fill` = Builder(name = "Dice-4-fill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.5f, 15.0f)
                curveTo(10.5f, 15.8284f, 9.8284f, 16.5f, 9.0f, 16.5f)
                curveTo(8.1716f, 16.5f, 7.5f, 15.8284f, 7.5f, 15.0f)
                curveTo(7.5f, 14.1716f, 8.1716f, 13.5f, 9.0f, 13.5f)
                curveTo(9.8284f, 13.5f, 10.5f, 14.1716f, 10.5f, 15.0f)
                close()
                moveTo(16.5f, 15.0f)
                ...
                close()
                moveTo(16.5f, 9.0f)
                curveTo(16.5f, 9.8284f, 15.8284f, 10.5f, 15.0f, 10.5f)
                curveTo(14.1716f, 10.5f, 13.5f, 9.8284f, 13.5f, 9.0f)
                curveTo(13.5f, 8.1716f, 14.1716f, 7.5f, 15.0f, 7.5f)
                curveTo(15.8284f, 7.5f, 16.5f, 8.1716f, 16.5f, 9.0f)
                close()
            }
        }
        .build()
...
private var `_dice-4-fill`: ImageVector? = null
