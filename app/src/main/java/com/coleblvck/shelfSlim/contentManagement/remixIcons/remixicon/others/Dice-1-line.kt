...
public val OthersGroup.`Dice-1-line`: ImageVector
    get() {
        if (`_dice-1-line` != null) {
            return `_dice-1-line`!!
        }
        `_dice-1-line` = Builder(name = "Dice-1-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_dice-1-line`: ImageVector? = null
