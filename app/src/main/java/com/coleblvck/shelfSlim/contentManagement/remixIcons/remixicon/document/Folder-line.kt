...
public val DocumentGroup.`Folder-line`: ImageVector
    get() {
        if (`_folder-line` != null) {
            return `_folder-line`!!
        }
        `_folder-line` = Builder(name = "Folder-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_folder-line`: ImageVector? = null
