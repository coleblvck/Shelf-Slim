...
public val UserGroup.`User-shared-line`: ImageVector
    get() {
        if (`_user-shared-line` != null) {
            return `_user-shared-line`!!
        }
        `_user-shared-line` = Builder(name = "User-shared-line", defaultWidth = 24.0.dp,
...
private var `_user-shared-line`: ImageVector? = null
