...
public val OthersGroup.`Outlet-line`: ImageVector
    get() {
        if (`_outlet-line` != null) {
            return `_outlet-line`!!
        }
        `_outlet-line` = Builder(name = "Outlet-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_outlet-line`: ImageVector? = null
