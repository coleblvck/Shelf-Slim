...
public val SystemGroup.`Progress-1-line`: ImageVector
    get() {
        if (`_progress-1-line` != null) {
            return `_progress-1-line`!!
        }
        `_progress-1-line` = Builder(name = "Progress-1-line", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 12.0f)
                verticalLineTo(6.0f)
                curveTo(13.6569f, 6.0f, 15.1569f, 6.6716f, 16.2426f, 7.7574f)
                lineTo(12.0f, 12.0f)
                close()
            }
        }
...
private var `_progress-1-line`: ImageVector? = null
