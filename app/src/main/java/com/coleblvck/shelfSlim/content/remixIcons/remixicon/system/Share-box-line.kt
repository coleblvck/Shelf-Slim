...
public val SystemGroup.`Share-box-line`: ImageVector
    get() {
        if (`_share-box-line` != null) {
            return `_share-box-line`!!
        }
        `_share-box-line` = Builder(name = "Share-box-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_share-box-line`: ImageVector? = null
