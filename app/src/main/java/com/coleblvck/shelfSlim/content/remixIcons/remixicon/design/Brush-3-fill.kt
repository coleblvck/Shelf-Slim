...
public val DesignGroup.`Brush-3-fill`: ImageVector
    get() {
        if (`_brush-3-fill` != null) {
            return `_brush-3-fill`!!
        }
        `_brush-3-fill` = Builder(name = "Brush-3-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_brush-3-fill`: ImageVector? = null
