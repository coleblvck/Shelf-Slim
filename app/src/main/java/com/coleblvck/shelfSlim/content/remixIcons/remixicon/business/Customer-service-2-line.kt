...
public val BusinessGroup.`Customer-service-2-line`: ImageVector
    get() {
        if (`_customer-service-2-line` != null) {
            return `_customer-service-2-line`!!
        }
        `_customer-service-2-line` = Builder(name = "Customer-service-2-line", defaultWidth =
                24.0.dp, defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight =
                24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(19.9381f, 8.0f)
...
private var `_customer-service-2-line`: ImageVector? = null
