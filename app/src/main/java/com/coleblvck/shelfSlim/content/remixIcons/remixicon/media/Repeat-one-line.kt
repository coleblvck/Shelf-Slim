...
public val MediaGroup.`Repeat-one-line`: ImageVector
    get() {
        if (`_repeat-one-line` != null) {
            return `_repeat-one-line`!!
        }
        `_repeat-one-line` = Builder(name = "Repeat-one-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_repeat-one-line`: ImageVector? = null
