...
public val SystemGroup.`Delete-bin-line`: ImageVector
    get() {
        if (`_delete-bin-line` != null) {
            return `_delete-bin-line`!!
        }
        `_delete-bin-line` = Builder(name = "Delete-bin-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_delete-bin-line`: ImageVector? = null
