...
public val FinanceGroup.`Currency-line`: ImageVector
    get() {
        if (`_currency-line` != null) {
            return `_currency-line`!!
        }
        `_currency-line` = Builder(name = "Currency-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(17.0047f)
                close()
                moveTo(5.0073f, 8.0028f)
                lineTo(5.0051f, 20.0027f)
                horizontalLineTo(15.0047f)
                verticalLineTo(8.0028f)
                horizontalLineTo(5.0073f)
                close()
                moveTo(7.0047f, 16.0027f)
                horizontalLineTo(11.5047f)
                curveTo(11.7808f, 16.0027f, 12.0047f, 15.7789f, 12.0047f, 15.5027f)
                curveTo(12.0047f, 15.2266f, 11.7808f, 15.0027f, 11.5047f, 15.0027f)
                horizontalLineTo(8.5047f)
                curveTo(7.124f, 15.0027f, 6.0047f, 13.8835f, 6.0047f, 12.5027f)
                curveTo(6.0047f, 11.122f, 7.124f, 10.0027f, 8.5047f, 10.0027f)
                horizontalLineTo(9.0047f)
                ...
                horizontalLineTo(8.5047f)
                curveTo(8.2285f, 12.0027f, 8.0047f, 12.2266f, 8.0047f, 12.5027f)
                curveTo(8.0047f, 12.7789f, 8.2285f, 13.0027f, 8.5047f, 13.0027f)
                horizontalLineTo(11.5047f)
                curveTo(12.8854f, 13.0027f, 14.0047f, 14.122f, 14.0047f, 15.5027f)
                curveTo(14.0047f, 16.8835f, 12.8854f, 18.0027f, 11.5047f, 18.0027f)
                horizontalLineTo(11.0047f)
...
private var `_currency-line`: ImageVector? = null
