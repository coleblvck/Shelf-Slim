...
public val DocumentGroup.`File-ppt-fill`: ImageVector
    get() {
        if (`_file-ppt-fill` != null) {
            return `_file-ppt-fill`!!
        }
        `_file-ppt-fill` = Builder(name = "File-ppt-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-ppt-fill`: ImageVector? = null
