...
public val SystemGroup.`Close-line`: ImageVector
    get() {
        if (`_close-line` != null) {
            return `_close-line`!!
        }
        `_close-line` = Builder(name = "Close-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_close-line`: ImageVector? = null
