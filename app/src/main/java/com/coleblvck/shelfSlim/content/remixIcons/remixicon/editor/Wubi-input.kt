...
public val EditorGroup.`Wubi-input`: ImageVector
    get() {
        if (`_wubi-input` != null) {
            return `_wubi-input`!!
        }
        `_wubi-input` = Builder(name = "Wubi-input", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_wubi-input`: ImageVector? = null
