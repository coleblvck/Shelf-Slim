...
public val DesignGroup.`Layout-row-line`: ImageVector
    get() {
        if (`_layout-row-line` != null) {
            return `_layout-row-line`!!
        }
        `_layout-row-line` = Builder(name = "Layout-row-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_layout-row-line`: ImageVector? = null
