...
public val DeviceGroup.`Battery-low-fill`: ImageVector
    get() {
        if (`_battery-low-fill` != null) {
            return `_battery-low-fill`!!
        }
        `_battery-low-fill` = Builder(name = "Battery-low-fill", defaultWidth = 24.0.dp,
...
private var `_battery-low-fill`: ImageVector? = null
