...
public val FinanceGroup.`Bit-coin-line`: ImageVector
    get() {
        if (`_bit-coin-line` != null) {
            return `_bit-coin-line`!!
        }
        `_bit-coin-line` = Builder(name = "Bit-coin-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(15.3856f, 8.0028f, 16.5049f, 9.122f, 16.5049f, 10.5027f)
                curveTo(16.5049f, 11.0655f, 16.3189f, 11.5849f, 16.0051f, 12.0027f)
                curveTo(16.3189f, 12.4206f, 16.5049f, 12.9399f, 16.5049f, 13.5027f)
                ...
                horizontalLineTo(14.0049f)
                curveTo(14.281f, 11.0027f, 14.5049f, 10.7789f, 14.5049f, 10.5027f)
                curveTo(14.5049f, 10.2266f, 14.281f, 10.0027f, 14.0049f, 10.0027f)
                horizontalLineTo(10.0049f)
                close()
            }
        }
...
private var `_bit-coin-line`: ImageVector? = null
