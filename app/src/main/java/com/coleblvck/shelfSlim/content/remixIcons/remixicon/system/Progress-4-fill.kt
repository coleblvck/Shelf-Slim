...
public val SystemGroup.`Progress-4-fill`: ImageVector
    get() {
        if (`_progress-4-fill` != null) {
            return `_progress-4-fill`!!
        }
        `_progress-4-fill` = Builder(name = "Progress-4-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_progress-4-fill`: ImageVector? = null
