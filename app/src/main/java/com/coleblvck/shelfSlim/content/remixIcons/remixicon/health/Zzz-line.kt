...
public val HealthGroup.`Zzz-line`: ImageVector
    get() {
        if (`_zzz-line` != null) {
            return `_zzz-line`!!
        }
        `_zzz-line` = Builder(name = "Zzz-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_zzz-line`: ImageVector? = null
