...
public val BusinessGroup.`Send-plane-2-fill`: ImageVector
    get() {
        if (`_send-plane-2-fill` != null) {
            return `_send-plane-2-fill`!!
        }
        `_send-plane-2-fill` = Builder(name = "Send-plane-2-fill", defaultWidth = 24.0.dp,
...
private var `_send-plane-2-fill`: ImageVector? = null
