...
public val DeviceGroup.`Remote-control-2-line`: ImageVector
    get() {
        if (`_remote-control-2-line` != null) {
            return `_remote-control-2-line`!!
        }
        `_remote-control-2-line` = Builder(name = "Remote-control-2-line", defaultWidth = 24.0.dp,
...
private var `_remote-control-2-line`: ImageVector? = null
