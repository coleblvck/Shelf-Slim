...
public val MediaGroup.`Repeat-fill`: ImageVector
    get() {
        if (`_repeat-fill` != null) {
            return `_repeat-fill`!!
        }
        `_repeat-fill` = Builder(name = "Repeat-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_repeat-fill`: ImageVector? = null
