...
public val BusinessGroup.`Pass-pending-line`: ImageVector
    get() {
        if (`_pass-pending-line` != null) {
            return `_pass-pending-line`!!
        }
        `_pass-pending-line` = Builder(name = "Pass-pending-line", defaultWidth = 24.0.dp,
...
private var `_pass-pending-line`: ImageVector? = null
