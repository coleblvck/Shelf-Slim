...
public val BuildingsGroup.`Store-3-fill`: ImageVector
    get() {
        if (`_store-3-fill` != null) {
            return `_store-3-fill`!!
        }
        `_store-3-fill` = Builder(name = "Store-3-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_store-3-fill`: ImageVector? = null
