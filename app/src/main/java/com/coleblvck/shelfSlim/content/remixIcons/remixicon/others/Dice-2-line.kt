...
public val OthersGroup.`Dice-2-line`: ImageVector
    get() {
        if (`_dice-2-line` != null) {
            return `_dice-2-line`!!
        }
        `_dice-2-line` = Builder(name = "Dice-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_dice-2-line`: ImageVector? = null
