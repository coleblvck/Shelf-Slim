...
public val DesignGroup.`Layout-grid-2-line`: ImageVector
    get() {
        if (`_layout-grid-2-line` != null) {
            return `_layout-grid-2-line`!!
        }
        `_layout-grid-2-line` = Builder(name = "Layout-grid-2-line", defaultWidth = 24.0.dp,
...
private var `_layout-grid-2-line`: ImageVector? = null
