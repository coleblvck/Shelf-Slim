...
public val SystemGroup.`Progress-4-line`: ImageVector
    get() {
        if (`_progress-4-line` != null) {
            return `_progress-4-line`!!
        }
        `_progress-4-line` = Builder(name = "Progress-4-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_progress-4-line`: ImageVector? = null
