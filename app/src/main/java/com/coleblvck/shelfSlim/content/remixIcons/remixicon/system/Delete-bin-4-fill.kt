...
public val SystemGroup.`Delete-bin-4-fill`: ImageVector
    get() {
        if (`_delete-bin-4-fill` != null) {
            return `_delete-bin-4-fill`!!
        }
        `_delete-bin-4-fill` = Builder(name = "Delete-bin-4-fill", defaultWidth = 24.0.dp,
...
private var `_delete-bin-4-fill`: ImageVector? = null
