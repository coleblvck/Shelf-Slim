...
public val DocumentGroup.`Folder-download-line`: ImageVector
    get() {
        if (`_folder-download-line` != null) {
            return `_folder-download-line`!!
        }
        `_folder-download-line` = Builder(name = "Folder-download-line", defaultWidth = 24.0.dp,
...
private var `_folder-download-line`: ImageVector? = null
