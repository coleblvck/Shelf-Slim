...
public val ArrowsGroup.`Arrow-up-double-line`: ImageVector
    get() {
        if (`_arrow-up-double-line` != null) {
            return `_arrow-up-double-line`!!
        }
        `_arrow-up-double-line` = Builder(name = "Arrow-up-double-line", defaultWidth = 24.0.dp,
...
private var `_arrow-up-double-line`: ImageVector? = null
