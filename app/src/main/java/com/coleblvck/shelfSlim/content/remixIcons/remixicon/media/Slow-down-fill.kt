...
public val MediaGroup.`Slow-down-fill`: ImageVector
    get() {
        if (`_slow-down-fill` != null) {
            return `_slow-down-fill`!!
        }
        `_slow-down-fill` = Builder(name = "Slow-down-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_slow-down-fill`: ImageVector? = null
