...
public val CommunicationGroup.`Chat-forward-fill`: ImageVector
    get() {
        if (`_chat-forward-fill` != null) {
            return `_chat-forward-fill`!!
        }
        `_chat-forward-fill` = Builder(name = "Chat-forward-fill", defaultWidth = 24.0.dp,
...
private var `_chat-forward-fill`: ImageVector? = null
