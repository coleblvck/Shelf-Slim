...
public val MapGroup.`Passport-fill`: ImageVector
    get() {
        if (`_passport-fill` != null) {
            return `_passport-fill`!!
        }
        `_passport-fill` = Builder(name = "Passport-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_passport-fill`: ImageVector? = null
