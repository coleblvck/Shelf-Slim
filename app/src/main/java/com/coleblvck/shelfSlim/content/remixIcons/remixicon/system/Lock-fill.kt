...
public val SystemGroup.`Lock-fill`: ImageVector
    get() {
        if (`_lock-fill` != null) {
            return `_lock-fill`!!
        }
        `_lock-fill` = Builder(name = "Lock-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_lock-fill`: ImageVector? = null
