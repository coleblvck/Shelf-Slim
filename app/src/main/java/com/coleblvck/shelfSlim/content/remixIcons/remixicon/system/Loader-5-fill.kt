...
public val SystemGroup.`Loader-5-fill`: ImageVector
    get() {
        if (`_loader-5-fill` != null) {
            return `_loader-5-fill`!!
        }
        `_loader-5-fill` = Builder(name = "Loader-5-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_loader-5-fill`: ImageVector? = null
