...
public val MediaGroup.`Record-circle-line`: ImageVector
    get() {
        if (`_record-circle-line` != null) {
            return `_record-circle-line`!!
        }
        `_record-circle-line` = Builder(name = "Record-circle-line", defaultWidth = 24.0.dp,
...
private var `_record-circle-line`: ImageVector? = null
