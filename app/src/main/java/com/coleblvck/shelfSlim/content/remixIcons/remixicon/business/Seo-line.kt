...
public val BusinessGroup.`Seo-line`: ImageVector
    get() {
        if (`_seo-line` != null) {
            return `_seo-line`!!
        }
        `_seo-line` = Builder(name = "Seo-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.0f, 13.0f)
                curveTo(14.3431f, 13.0f, 13.0f, 14.3431f, 13.0f, 16.0f)
                curveTo(13.0f, 17.6569f, 14.3431f, 19.0f, 16.0f, 19.0f)
                curveTo(17.6569f, 19.0f, 19.0f, 17.6569f, 19.0f, 16.0f)
                curveTo(19.0f, 14.3431f, 17.6569f, 13.0f, 16.0f, 13.0f)
                close()
                moveTo(11.0f, 16.0f)
...
private var `_seo-line`: ImageVector? = null
