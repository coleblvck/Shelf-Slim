...
public val BusinessGroup.`Briefcase-line`: ImageVector
    get() {
        if (`_briefcase-line` != null) {
            return `_briefcase-line`!!
        }
        `_briefcase-line` = Builder(name = "Briefcase-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_briefcase-line`: ImageVector? = null
