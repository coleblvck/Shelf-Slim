...
public val SystemGroup.`Delete-back-2-fill`: ImageVector
    get() {
        if (`_delete-back-2-fill` != null) {
            return `_delete-back-2-fill`!!
        }
        `_delete-back-2-fill` = Builder(name = "Delete-back-2-fill", defaultWidth = 24.0.dp,
...
private var `_delete-back-2-fill`: ImageVector? = null
