...
public val DocumentGroup.`Folder-reduce-line`: ImageVector
    get() {
        if (`_folder-reduce-line` != null) {
            return `_folder-reduce-line`!!
        }
        `_folder-reduce-line` = Builder(name = "Folder-reduce-line", defaultWidth = 24.0.dp,
...
private var `_folder-reduce-line`: ImageVector? = null
