...
public val MediaGroup.`Order-play-fill`: ImageVector
    get() {
        if (`_order-play-fill` != null) {
            return `_order-play-fill`!!
        }
        `_order-play-fill` = Builder(name = "Order-play-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_order-play-fill`: ImageVector? = null
