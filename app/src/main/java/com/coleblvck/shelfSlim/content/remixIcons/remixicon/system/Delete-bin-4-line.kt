...
public val SystemGroup.`Delete-bin-4-line`: ImageVector
    get() {
        if (`_delete-bin-4-line` != null) {
            return `_delete-bin-4-line`!!
        }
        `_delete-bin-4-line` = Builder(name = "Delete-bin-4-line", defaultWidth = 24.0.dp,
...
private var `_delete-bin-4-line`: ImageVector? = null
