...
public val MediaGroup.`Mv-fill`: ImageVector
    get() {
        if (`_mv-fill` != null) {
            return `_mv-fill`!!
        }
        `_mv-fill` = Builder(name = "Mv-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.6872f, 12.0602f, 11.3506f, 12.0f, 11.0f, 12.0f)
                curveTo(9.3432f, 12.0f, 8.0f, 13.3431f, 8.0f, 15.0f)
                curveTo(8.0f, 16.6569f, 9.3432f, 18.0f, 11.0f, 18.0f)
                curveTo(12.6569f, 18.0f, 14.0f, 16.6569f, 14.0f, 15.0f)
                verticalLineTo(8.0f)
                horizontalLineTo(17.0f)
                verticalLineTo(6.0f)
                horizontalLineTo(12.0f)
                verticalLineTo(12.1707f)
                close()
            }
        }
        .build()
...
private var `_mv-fill`: ImageVector? = null
