...
public val UserGroup.`User-add-fill`: ImageVector
    get() {
        if (`_user-add-fill` != null) {
            return `_user-add-fill`!!
        }
        `_user-add-fill` = Builder(name = "User-add-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_user-add-fill`: ImageVector? = null
