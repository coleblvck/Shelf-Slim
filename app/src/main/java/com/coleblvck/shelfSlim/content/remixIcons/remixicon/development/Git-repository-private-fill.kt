...
public val DevelopmentGroup.`Git-repository-private-fill`: ImageVector
    get() {
        if (`_git-repository-private-fill` != null) {
            return `_git-repository-private-fill`!!
        }
        `_git-repository-private-fill` = Builder(name = "Git-repository-private-fill", defaultWidth
...
private var `_git-repository-private-fill`: ImageVector? = null
