...
public val WeatherGroup.`Windy-fill`: ImageVector
    get() {
        if (`_windy-fill` != null) {
            return `_windy-fill`!!
        }
        `_windy-fill` = Builder(name = "Windy-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_windy-fill`: ImageVector? = null
