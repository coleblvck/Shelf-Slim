...
public val MediaGroup.`Clapperboard-line`: ImageVector
    get() {
        if (`_clapperboard-line` != null) {
            return `_clapperboard-line`!!
        }
        `_clapperboard-line` = Builder(name = "Clapperboard-line", defaultWidth = 24.0.dp,
...
private var `_clapperboard-line`: ImageVector? = null
