...
public val FinanceGroup.`Price-tag-2-line`: ImageVector
    get() {
        if (`_price-tag-2-line` != null) {
            return `_price-tag-2-line`!!
        }
        `_price-tag-2-line` = Builder(name = "Price-tag-2-line", defaultWidth = 24.0.dp,
...
private var `_price-tag-2-line`: ImageVector? = null
