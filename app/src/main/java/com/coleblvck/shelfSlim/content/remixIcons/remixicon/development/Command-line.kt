...
public val DevelopmentGroup.`Command-line`: ImageVector
    get() {
        if (`_command-line` != null) {
            return `_command-line`!!
        }
        `_command-line` = Builder(name = "Command-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(8.0f, 8.0f)
                verticalLineTo(6.5f)
                curveTo(8.0f, 5.6716f, 7.3284f, 5.0f, 6.5f, 5.0f)
                curveTo(5.6716f, 5.0f, 5.0f, 5.6716f, 5.0f, 6.5f)
                curveTo(5.0f, 7.3284f, 5.6716f, 8.0f, 6.5f, 8.0f)
                horizontalLineTo(8.0f)
                close()
                moveTo(8.0f, 16.0f)
                horizontalLineTo(6.5f)
                ...
                curveTo(7.3284f, 19.0f, 8.0f, 18.3284f, 8.0f, 17.5f)
                verticalLineTo(16.0f)
                close()
                moveTo(16.0f, 8.0f)
                horizontalLineTo(17.5f)
                curveTo(18.3284f, 8.0f, 19.0f, 7.3284f, 19.0f, 6.5f)
                curveTo(19.0f, 5.6716f, 18.3284f, 5.0f, 17.5f, 5.0f)
                curveTo(16.6716f, 5.0f, 16.0f, 5.6716f, 16.0f, 6.5f)
                verticalLineTo(8.0f)
                close()
                moveTo(16.0f, 16.0f)
                verticalLineTo(17.5f)
                curveTo(16.0f, 18.3284f, 16.6716f, 19.0f, 17.5f, 19.0f)
...
private var `_command-line`: ImageVector? = null
