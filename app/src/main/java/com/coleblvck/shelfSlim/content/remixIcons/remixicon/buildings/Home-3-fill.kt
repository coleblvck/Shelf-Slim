...
public val BuildingsGroup.`Home-3-fill`: ImageVector
    get() {
        if (`_home-3-fill` != null) {
            return `_home-3-fill`!!
        }
        `_home-3-fill` = Builder(name = "Home-3-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-3-fill`: ImageVector? = null
