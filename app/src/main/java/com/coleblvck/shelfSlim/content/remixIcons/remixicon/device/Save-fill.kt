...
public val DeviceGroup.`Save-fill`: ImageVector
    get() {
        if (`_save-fill` != null) {
            return `_save-fill`!!
        }
        `_save-fill` = Builder(name = "Save-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_save-fill`: ImageVector? = null
