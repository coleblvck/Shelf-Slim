...
public val CommunicationGroup.`Feedback-fill`: ImageVector
    get() {
        if (`_feedback-fill` != null) {
            return `_feedback-fill`!!
        }
        `_feedback-fill` = Builder(name = "Feedback-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_feedback-fill`: ImageVector? = null
