...
public val SystemGroup.`Checkbox-circle-line`: ImageVector
    get() {
        if (`_checkbox-circle-line` != null) {
            return `_checkbox-circle-line`!!
        }
        `_checkbox-circle-line` = Builder(name = "Checkbox-circle-line", defaultWidth = 24.0.dp,
...
private var `_checkbox-circle-line`: ImageVector? = null
