...
public val MediaGroup.`Picture-in-picture-exit-line`: ImageVector
    get() {
        if (`_picture-in-picture-exit-line` != null) {
            return `_picture-in-picture-exit-line`!!
        }
        `_picture-in-picture-exit-line` = Builder(name = "Picture-in-picture-exit-line",
...
private var `_picture-in-picture-exit-line`: ImageVector? = null
