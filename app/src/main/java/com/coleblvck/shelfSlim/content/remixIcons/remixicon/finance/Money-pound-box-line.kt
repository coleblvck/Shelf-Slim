...
public val FinanceGroup.`Money-pound-box-line`: ImageVector
    get() {
        if (`_money-pound-box-line` != null) {
            return `_money-pound-box-line`!!
        }
        `_money-pound-box-line` = Builder(name = "Money-pound-box-line", defaultWidth = 24.0.dp,
...
private var `_money-pound-box-line`: ImageVector? = null
