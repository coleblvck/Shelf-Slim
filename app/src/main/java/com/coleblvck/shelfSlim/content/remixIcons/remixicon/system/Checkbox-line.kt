...
public val SystemGroup.`Checkbox-line`: ImageVector
    get() {
        if (`_checkbox-line` != null) {
            return `_checkbox-line`!!
        }
        `_checkbox-line` = Builder(name = "Checkbox-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_checkbox-line`: ImageVector? = null
