...
public val BusinessGroup.`Briefcase-2-fill`: ImageVector
    get() {
        if (`_briefcase-2-fill` != null) {
            return `_briefcase-2-fill`!!
        }
        `_briefcase-2-fill` = Builder(name = "Briefcase-2-fill", defaultWidth = 24.0.dp,
...
private var `_briefcase-2-fill`: ImageVector? = null
