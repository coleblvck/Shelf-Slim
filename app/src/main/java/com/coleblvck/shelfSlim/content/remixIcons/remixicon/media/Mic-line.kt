...
public val MediaGroup.`Mic-line`: ImageVector
    get() {
        if (`_mic-line` != null) {
            return `_mic-line`!!
        }
        `_mic-line` = Builder(name = "Mic-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(11.9998f, 3.0f)
                curveTo(10.3429f, 3.0f, 8.9998f, 4.3432f, 8.9998f, 6.0f)
                verticalLineTo(10.0f)
                curveTo(8.9998f, 11.6569f, 10.3429f, 13.0f, 11.9998f, 13.0f)
                curveTo(13.6566f, 13.0f, 14.9998f, 11.6569f, 14.9998f, 10.0f)
                verticalLineTo(6.0f)
                curveTo(14.9998f, 4.3432f, 13.6566f, 3.0f, 11.9998f, 3.0f)
                close()
...
private var `_mic-line`: ImageVector? = null
