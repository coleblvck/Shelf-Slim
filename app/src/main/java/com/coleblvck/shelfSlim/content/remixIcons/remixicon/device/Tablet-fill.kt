...
public val DeviceGroup.`Tablet-fill`: ImageVector
    get() {
        if (`_tablet-fill` != null) {
            return `_tablet-fill`!!
        }
        `_tablet-fill` = Builder(name = "Tablet-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_tablet-fill`: ImageVector? = null
