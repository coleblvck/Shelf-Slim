...
public val SystemGroup.`More-fill`: ImageVector
    get() {
        if (`_more-fill` != null) {
            return `_more-fill`!!
        }
        `_more-fill` = Builder(name = "More-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_more-fill`: ImageVector? = null
