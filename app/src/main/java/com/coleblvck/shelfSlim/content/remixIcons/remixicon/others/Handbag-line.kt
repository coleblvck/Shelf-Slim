...
public val OthersGroup.`Handbag-line`: ImageVector
    get() {
        if (`_handbag-line` != null) {
            return `_handbag-line`!!
        }
        `_handbag-line` = Builder(name = "Handbag-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(19.1472f, 11.0f)
                horizontalLineTo(4.8522f)
                lineTo(4.1592f, 20.0f)
                horizontalLineTo(19.8402f)
                lineTo(19.1472f, 11.0f)
                close()
...
private var `_handbag-line`: ImageVector? = null
