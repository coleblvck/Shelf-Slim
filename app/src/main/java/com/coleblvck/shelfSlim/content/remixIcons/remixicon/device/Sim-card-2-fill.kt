...
public val DeviceGroup.`Sim-card-2-fill`: ImageVector
    get() {
        if (`_sim-card-2-fill` != null) {
            return `_sim-card-2-fill`!!
        }
        `_sim-card-2-fill` = Builder(name = "Sim-card-2-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_sim-card-2-fill`: ImageVector? = null
