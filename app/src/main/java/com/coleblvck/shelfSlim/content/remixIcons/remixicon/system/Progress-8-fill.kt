...
public val SystemGroup.`Progress-8-fill`: ImageVector
    get() {
        if (`_progress-8-fill` != null) {
            return `_progress-8-fill`!!
        }
        `_progress-8-fill` = Builder(name = "Progress-8-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_progress-8-fill`: ImageVector? = null
