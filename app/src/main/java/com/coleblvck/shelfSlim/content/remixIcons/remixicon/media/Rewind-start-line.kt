...
public val MediaGroup.`Rewind-start-line`: ImageVector
    get() {
        if (`_rewind-start-line` != null) {
            return `_rewind-start-line`!!
        }
        `_rewind-start-line` = Builder(name = "Rewind-start-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.0f, 7.7369f)
                verticalLineTo(16.2628f)
                lineTo(4.6056f, 11.9999f)
                lineTo(11.0f, 7.7369f)
                close()
                moveTo(21.0f, 7.7369f)
                verticalLineTo(16.2628f)
                lineTo(14.6056f, 11.9999f)
                lineTo(21.0f, 7.7369f)
                close()
            }
        }
        .build()
...
private var `_rewind-start-line`: ImageVector? = null
