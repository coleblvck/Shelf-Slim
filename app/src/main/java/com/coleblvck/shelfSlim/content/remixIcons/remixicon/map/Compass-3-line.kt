...
public val MapGroup.`Compass-3-line`: ImageVector
    get() {
        if (`_compass-3-line` != null) {
            return `_compass-3-line`!!
        }
        `_compass-3-line` = Builder(name = "Compass-3-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_compass-3-line`: ImageVector? = null
