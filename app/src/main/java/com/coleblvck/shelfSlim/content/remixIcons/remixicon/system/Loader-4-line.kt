...
public val SystemGroup.`Loader-4-line`: ImageVector
    get() {
        if (`_loader-4-line` != null) {
            return `_loader-4-line`!!
        }
        `_loader-4-line` = Builder(name = "Loader-4-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.364f, 5.636f)
                lineTo(16.9497f, 7.0503f)
                curveTo(15.683f, 5.7835f, 13.933f, 5.0f, 12.0f, 5.0f)
                ...
                curveTo(14.4853f, 3.0f, 16.7353f, 4.0074f, 18.364f, 5.636f)
                close()
            }
        }
        .build()
...
private var `_loader-4-line`: ImageVector? = null
