...
public val MediaGroup.`Eject-line`: ImageVector
    get() {
        if (`_eject-line` != null) {
            return `_eject-line`!!
        }
        `_eject-line` = Builder(name = "Eject-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_eject-line`: ImageVector? = null
