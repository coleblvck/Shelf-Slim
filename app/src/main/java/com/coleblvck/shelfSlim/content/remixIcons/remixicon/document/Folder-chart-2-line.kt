...
public val DocumentGroup.`Folder-chart-2-line`: ImageVector
    get() {
        if (`_folder-chart-2-line` != null) {
            return `_folder-chart-2-line`!!
        }
        `_folder-chart-2-line` = Builder(name = "Folder-chart-2-line", defaultWidth = 24.0.dp,
...
private var `_folder-chart-2-line`: ImageVector? = null
