...
public val FinanceGroup.`Secure-payment-line`: ImageVector
    get() {
        if (`_secure-payment-line` != null) {
            return `_secure-payment-line`!!
        }
        `_secure-payment-line` = Builder(name = "Secure-payment-line", defaultWidth = 24.0.dp,
...
private var `_secure-payment-line`: ImageVector? = null
