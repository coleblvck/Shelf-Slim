...
public val SystemGroup.`Delete-bin-5-line`: ImageVector
    get() {
        if (`_delete-bin-5-line` != null) {
            return `_delete-bin-5-line`!!
        }
        `_delete-bin-5-line` = Builder(name = "Delete-bin-5-line", defaultWidth = 24.0.dp,
...
private var `_delete-bin-5-line`: ImageVector? = null
