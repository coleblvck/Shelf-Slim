...
public val CommunicationGroup.`Video-chat-fill`: ImageVector
    get() {
        if (`_video-chat-fill` != null) {
            return `_video-chat-fill`!!
        }
        `_video-chat-fill` = Builder(name = "Video-chat-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_video-chat-fill`: ImageVector? = null
