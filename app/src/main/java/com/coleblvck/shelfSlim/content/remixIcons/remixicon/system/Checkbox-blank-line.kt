...
public val SystemGroup.`Checkbox-blank-line`: ImageVector
    get() {
        if (`_checkbox-blank-line` != null) {
            return `_checkbox-blank-line`!!
        }
        `_checkbox-blank-line` = Builder(name = "Checkbox-blank-line", defaultWidth = 24.0.dp,
...
private var `_checkbox-blank-line`: ImageVector? = null
