...
public val BusinessGroup.`At-fill`: ImageVector
    get() {
        if (`_at-fill` != null) {
            return `_at-fill`!!
        }
        `_at-fill` = Builder(name = "At-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.4702f, 20.0f, 14.8478f, 19.6034f, 16.0316f, 18.9114f)
                lineTo(15.0237f, 17.1835f)
                curveTo(14.1359f, 17.7026f, 13.1027f, 18.0f, 12.0f, 18.0f)
                ...
                verticalLineTo(9.0f)
                horizontalLineTo(14.6458f)
                curveTo(13.9407f, 8.3776f, 13.0144f, 8.0f, 12.0f, 8.0f)
                curveTo(9.7909f, 8.0f, 8.0f, 9.7909f, 8.0f, 12.0f)
                curveTo(8.0f, 14.2091f, 9.7909f, 16.0f, 12.0f, 16.0f)
                curveTo(13.0465f, 16.0f, 13.9991f, 15.5982f, 14.7119f, 14.9404f)
                curveTo(15.2622f, 15.5886f, 16.0831f, 16.0f, 17.0f, 16.0f)
                curveTo(18.6569f, 16.0f, 20.0f, 14.6569f, 20.0f, 13.0f)
...
private var `_at-fill`: ImageVector? = null
