...
public val SystemGroup.`Progress-5-line`: ImageVector
    get() {
        if (`_progress-5-line` != null) {
            return `_progress-5-line`!!
        }
        `_progress-5-line` = Builder(name = "Progress-5-line", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.3431f, 18.0f, 8.8431f, 17.3284f, 7.7573f, 16.2426f)
                lineTo(12.0f, 12.0f)
                verticalLineTo(6.0f)
...
private var `_progress-5-line`: ImageVector? = null
