...
public val DocumentGroup.`Folder-4-fill`: ImageVector
    get() {
        if (`_folder-4-fill` != null) {
            return `_folder-4-fill`!!
        }
        `_folder-4-fill` = Builder(name = "Folder-4-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_folder-4-fill`: ImageVector? = null
