...
public val BusinessGroup.`Customer-service-fill`: ImageVector
    get() {
        if (`_customer-service-fill` != null) {
            return `_customer-service-fill`!!
        }
        `_customer-service-fill` = Builder(name = "Customer-service-fill", defaultWidth = 24.0.dp,
...
private var `_customer-service-fill`: ImageVector? = null
