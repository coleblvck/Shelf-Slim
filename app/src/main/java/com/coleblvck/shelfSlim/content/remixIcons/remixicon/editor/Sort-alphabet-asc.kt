...
public val EditorGroup.`Sort-alphabet-asc`: ImageVector
    get() {
        if (`_sort-alphabet-asc` != null) {
            return `_sort-alphabet-asc`!!
        }
        `_sort-alphabet-asc` = Builder(name = "Sort-alphabet-asc", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(6.0984f, 8.0f)
                close()
                moveTo(18.9999f, 16.0f)
                verticalLineTo(3.0f)
                horizontalLineTo(16.9999f)
                verticalLineTo(16.0f)
                horizontalLineTo(13.9999f)
                lineTo(17.9999f, 21.0f)
                lineTo(21.9999f, 16.0f)
...
private var `_sort-alphabet-asc`: ImageVector? = null
