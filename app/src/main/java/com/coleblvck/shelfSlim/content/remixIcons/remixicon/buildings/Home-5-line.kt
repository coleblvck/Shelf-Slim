...
public val BuildingsGroup.`Home-5-line`: ImageVector
    get() {
        if (`_home-5-line` != null) {
            return `_home-5-line`!!
        }
        `_home-5-line` = Builder(name = "Home-5-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-5-line`: ImageVector? = null
