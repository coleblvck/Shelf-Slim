...
public val ArrowsGroup.`Arrow-right-double-fill`: ImageVector
    get() {
        if (`_arrow-right-double-fill` != null) {
            return `_arrow-right-double-fill`!!
        }
        `_arrow-right-double-fill` = Builder(name = "Arrow-right-double-fill", defaultWidth =
...
private var `_arrow-right-double-fill`: ImageVector? = null
