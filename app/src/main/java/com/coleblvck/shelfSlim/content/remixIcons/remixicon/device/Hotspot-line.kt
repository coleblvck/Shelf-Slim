...
public val DeviceGroup.`Hotspot-line`: ImageVector
    get() {
        if (`_hotspot-line` != null) {
            return `_hotspot-line`!!
        }
        `_hotspot-line` = Builder(name = "Hotspot-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hotspot-line`: ImageVector? = null
