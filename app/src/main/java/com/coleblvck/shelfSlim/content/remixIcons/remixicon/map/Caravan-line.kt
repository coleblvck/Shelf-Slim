...
public val MapGroup.`Caravan-line`: ImageVector
    get() {
        if (`_caravan-line` != null) {
            return `_caravan-line`!!
        }
        `_caravan-line` = Builder(name = "Caravan-line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.1716f, 5.0f)
                horizontalLineTo(4.0f)
                verticalLineTo(17.0f)
                lineTo(7.1259f, 17.0002f)
                curveTo(7.5699f, 15.2749f, 9.1361f, 14.0f, 11.0f, 14.0f)
                curveTo(12.8639f, 14.0f, 14.4301f, 15.2749f, 14.874f, 17.0002f)
                lineTo(19.0f, 17.0f)
                verticalLineTo(9.8284f)
...
private var `_caravan-line`: ImageVector? = null
