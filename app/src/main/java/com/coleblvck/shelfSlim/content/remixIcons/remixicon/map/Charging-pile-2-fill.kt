...
public val MapGroup.`Charging-pile-2-fill`: ImageVector
    get() {
        if (`_charging-pile-2-fill` != null) {
            return `_charging-pile-2-fill`!!
        }
        `_charging-pile-2-fill` = Builder(name = "Charging-pile-2-fill", defaultWidth = 24.0.dp,
...
private var `_charging-pile-2-fill`: ImageVector? = null
