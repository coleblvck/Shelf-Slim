...
public val MapGroup.`Traffic-light-fill`: ImageVector
    get() {
        if (`_traffic-light-fill` != null) {
            return `_traffic-light-fill`!!
        }
        `_traffic-light-fill` = Builder(name = "Traffic-light-fill", defaultWidth = 24.0.dp,
...
private var `_traffic-light-fill`: ImageVector? = null
