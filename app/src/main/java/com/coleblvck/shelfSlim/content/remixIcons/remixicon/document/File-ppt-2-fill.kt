...
public val DocumentGroup.`File-ppt-2-fill`: ImageVector
    get() {
        if (`_file-ppt-2-fill` != null) {
            return `_file-ppt-2-fill`!!
        }
        `_file-ppt-2-fill` = Builder(name = "File-ppt-2-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_file-ppt-2-fill`: ImageVector? = null
