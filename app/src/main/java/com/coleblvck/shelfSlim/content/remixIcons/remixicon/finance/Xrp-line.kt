...
public val FinanceGroup.`Xrp-line`: ImageVector
    get() {
        if (`_xrp-line` != null) {
            return `_xrp-line`!!
        }
        `_xrp-line` = Builder(name = "Xrp-line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_xrp-line`: ImageVector? = null
