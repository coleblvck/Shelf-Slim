...
public val SystemGroup.`Progress-7-fill`: ImageVector
    get() {
        if (`_progress-7-fill` != null) {
            return `_progress-7-fill`!!
        }
        `_progress-7-fill` = Builder(name = "Progress-7-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_progress-7-fill`: ImageVector? = null
