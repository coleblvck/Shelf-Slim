...
public val DeviceGroup.`U-disk-fill`: ImageVector
    get() {
        if (`_u-disk-fill` != null) {
            return `_u-disk-fill`!!
        }
        `_u-disk-fill` = Builder(name = "U-disk-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_u-disk-fill`: ImageVector? = null
