...
public val ArrowsGroup.`Arrow-up-wide-line`: ImageVector
    get() {
        if (`_arrow-up-wide-line` != null) {
            return `_arrow-up-wide-line`!!
        }
        `_arrow-up-wide-line` = Builder(name = "Arrow-up-wide-line", defaultWidth = 24.0.dp,
...
private var `_arrow-up-wide-line`: ImageVector? = null
