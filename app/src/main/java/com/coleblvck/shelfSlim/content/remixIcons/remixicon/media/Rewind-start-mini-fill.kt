...
public val MediaGroup.`Rewind-start-mini-fill`: ImageVector
    get() {
        if (`_rewind-start-mini-fill` != null) {
            return `_rewind-start-mini-fill`!!
        }
        `_rewind-start-mini-fill` = Builder(name = "Rewind-start-mini-fill", defaultWidth = 24.0.dp,
...
private var `_rewind-start-mini-fill`: ImageVector? = null
