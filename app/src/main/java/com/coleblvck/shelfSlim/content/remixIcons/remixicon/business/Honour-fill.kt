...
public val BusinessGroup.`Honour-fill`: ImageVector
    get() {
        if (`_honour-fill` != null) {
            return `_honour-fill`!!
        }
        `_honour-fill` = Builder(name = "Honour-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_honour-fill`: ImageVector? = null
