...
public val DesignGroup.`Circle-line`: ImageVector
    get() {
        if (`_circle-line` != null) {
            return `_circle-line`!!
        }
        `_circle-line` = Builder(name = "Circle-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_circle-line`: ImageVector? = null
