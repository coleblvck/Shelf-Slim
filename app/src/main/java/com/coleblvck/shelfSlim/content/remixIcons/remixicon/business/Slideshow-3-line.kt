...
public val BusinessGroup.`Slideshow-3-line`: ImageVector
    get() {
        if (`_slideshow-3-line` != null) {
            return `_slideshow-3-line`!!
        }
        `_slideshow-3-line` = Builder(name = "Slideshow-3-line", defaultWidth = 24.0.dp,
...
private var `_slideshow-3-line`: ImageVector? = null
