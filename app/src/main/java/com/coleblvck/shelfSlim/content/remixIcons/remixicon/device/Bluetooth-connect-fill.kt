...
public val DeviceGroup.`Bluetooth-connect-fill`: ImageVector
    get() {
        if (`_bluetooth-connect-fill` != null) {
            return `_bluetooth-connect-fill`!!
        }
        `_bluetooth-connect-fill` = Builder(name = "Bluetooth-connect-fill", defaultWidth = 24.0.dp,
...
private var `_bluetooth-connect-fill`: ImageVector? = null
