...
public val BusinessGroup.`Briefcase-5-fill`: ImageVector
    get() {
        if (`_briefcase-5-fill` != null) {
            return `_briefcase-5-fill`!!
        }
        `_briefcase-5-fill` = Builder(name = "Briefcase-5-fill", defaultWidth = 24.0.dp,
...
private var `_briefcase-5-fill`: ImageVector? = null
