...
public val FinanceGroup.`Shopping-cart-2-fill`: ImageVector
    get() {
        if (`_shopping-cart-2-fill` != null) {
            return `_shopping-cart-2-fill`!!
        }
        `_shopping-cart-2-fill` = Builder(name = "Shopping-cart-2-fill", defaultWidth = 24.0.dp,
...
private var `_shopping-cart-2-fill`: ImageVector? = null
