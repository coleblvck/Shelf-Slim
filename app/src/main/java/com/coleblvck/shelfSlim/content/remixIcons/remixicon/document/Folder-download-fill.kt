...
public val DocumentGroup.`Folder-download-fill`: ImageVector
    get() {
        if (`_folder-download-fill` != null) {
            return `_folder-download-fill`!!
        }
        `_folder-download-fill` = Builder(name = "Folder-download-fill", defaultWidth = 24.0.dp,
...
private var `_folder-download-fill`: ImageVector? = null
