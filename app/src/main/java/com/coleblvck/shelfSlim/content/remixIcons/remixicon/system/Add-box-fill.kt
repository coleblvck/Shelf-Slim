...
public val SystemGroup.`Add-box-fill`: ImageVector
    get() {
        if (`_add-box-fill` != null) {
            return `_add-box-fill`!!
        }
        `_add-box-fill` = Builder(name = "Add-box-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_add-box-fill`: ImageVector? = null
