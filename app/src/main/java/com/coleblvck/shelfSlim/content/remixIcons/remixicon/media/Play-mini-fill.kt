...
public val MediaGroup.`Play-mini-fill`: ImageVector
    get() {
        if (`_play-mini-fill` != null) {
            return `_play-mini-fill`!!
        }
        `_play-mini-fill` = Builder(name = "Play-mini-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_play-mini-fill`: ImageVector? = null
