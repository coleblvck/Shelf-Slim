...
public val FoodGroup.`Cup-fill`: ImageVector
    get() {
        if (`_cup-fill` != null) {
            return `_cup-fill`!!
        }
        `_cup-fill` = Builder(name = "Cup-fill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_cup-fill`: ImageVector? = null
