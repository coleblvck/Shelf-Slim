...
public val DevelopmentGroup.`Git-repository-fill`: ImageVector
    get() {
        if (`_git-repository-fill` != null) {
            return `_git-repository-fill`!!
        }
        `_git-repository-fill` = Builder(name = "Git-repository-fill", defaultWidth = 24.0.dp,
...
private var `_git-repository-fill`: ImageVector? = null
