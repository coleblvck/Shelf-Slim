...
public val DevelopmentGroup.`Git-repository-commits-line`: ImageVector
    get() {
        if (`_git-repository-commits-line` != null) {
            return `_git-repository-commits-line`!!
        }
        `_git-repository-commits-line` = Builder(name = "Git-repository-commits-line", defaultWidth
...
private var `_git-repository-commits-line`: ImageVector? = null
