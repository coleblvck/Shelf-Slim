...
public val SystemGroup.`Function-add-line`: ImageVector
    get() {
        if (`_function-add-line` != null) {
            return `_function-add-line`!!
        }
        `_function-add-line` = Builder(name = "Function-add-line", defaultWidth = 24.0.dp,
...
private var `_function-add-line`: ImageVector? = null
