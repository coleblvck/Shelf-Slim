...
public val DocumentGroup.`Folder-received-line`: ImageVector
    get() {
        if (`_folder-received-line` != null) {
            return `_folder-received-line`!!
        }
        `_folder-received-line` = Builder(name = "Folder-received-line", defaultWidth = 24.0.dp,
...
private var `_folder-received-line`: ImageVector? = null
