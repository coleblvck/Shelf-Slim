...
public val BuildingsGroup.`Government-fill`: ImageVector
    get() {
        if (`_government-fill` != null) {
            return `_government-fill`!!
        }
        `_government-fill` = Builder(name = "Government-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_government-fill`: ImageVector? = null
