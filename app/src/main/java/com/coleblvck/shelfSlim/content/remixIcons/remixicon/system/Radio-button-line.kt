...
public val SystemGroup.`Radio-button-line`: ImageVector
    get() {
        if (`_radio-button-line` != null) {
            return `_radio-button-line`!!
        }
        `_radio-button-line` = Builder(name = "Radio-button-line", defaultWidth = 24.0.dp,
...
private var `_radio-button-line`: ImageVector? = null
