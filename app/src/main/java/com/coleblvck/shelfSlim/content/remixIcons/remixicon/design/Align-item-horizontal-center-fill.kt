...
public val DesignGroup.`Align-item-horizontal-center-fill`: ImageVector
    get() {
        if (`_align-item-horizontal-center-fill` != null) {
            return `_align-item-horizontal-center-fill`!!
        }
        `_align-item-horizontal-center-fill` = Builder(name = "Align-item-horizontal-center-fill",
...
private var `_align-item-horizontal-center-fill`: ImageVector? = null
