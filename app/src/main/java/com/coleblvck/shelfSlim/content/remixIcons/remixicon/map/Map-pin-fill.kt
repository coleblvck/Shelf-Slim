...
public val MapGroup.`Map-pin-fill`: ImageVector
    get() {
        if (`_map-pin-fill` != null) {
            return `_map-pin-fill`!!
        }
        `_map-pin-fill` = Builder(name = "Map-pin-fill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 15.0f)
                curveTo(14.2091f, 15.0f, 16.0f, 13.2091f, 16.0f, 11.0f)
                curveTo(16.0f, 8.7909f, 14.2091f, 7.0f, 12.0f, 7.0f)
                curveTo(9.7909f, 7.0f, 8.0f, 8.7909f, 8.0f, 11.0f)
                curveTo(8.0f, 13.2091f, 9.7909f, 15.0f, 12.0f, 15.0f)
                close()
                moveTo(12.0f, 13.0f)
