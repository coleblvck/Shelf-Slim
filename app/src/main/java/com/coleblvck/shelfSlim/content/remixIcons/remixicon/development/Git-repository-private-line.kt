...
public val DevelopmentGroup.`Git-repository-private-line`: ImageVector
    get() {
        if (`_git-repository-private-line` != null) {
            return `_git-repository-private-line`!!
        }
        `_git-repository-private-line` = Builder(name = "Git-repository-private-line", defaultWidth
...
private var `_git-repository-private-line`: ImageVector? = null
