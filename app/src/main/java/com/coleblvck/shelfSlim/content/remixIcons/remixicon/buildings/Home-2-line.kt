...
public val BuildingsGroup.`Home-2-line`: ImageVector
    get() {
        if (`_home-2-line` != null) {
            return `_home-2-line`!!
        }
        `_home-2-line` = Builder(name = "Home-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-2-line`: ImageVector? = null
