...
public val FinanceGroup.`Price-tag-fill`: ImageVector
    get() {
        if (`_price-tag-fill` != null) {
            return `_price-tag-fill`!!
        }
        `_price-tag-fill` = Builder(name = "Price-tag-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_price-tag-fill`: ImageVector? = null
