...
public val EditorGroup.`Timeline-view`: ImageVector
    get() {
        if (`_timeline-view` != null) {
            return `_timeline-view`!!
        }
        `_timeline-view` = Builder(name = "Timeline-view", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_timeline-view`: ImageVector? = null
