...
public val DocumentGroup.`File-marked-line`: ImageVector
    get() {
        if (`_file-marked-line` != null) {
            return `_file-marked-line`!!
        }
        `_file-marked-line` = Builder(name = "File-marked-line", defaultWidth = 24.0.dp,
...
private var `_file-marked-line`: ImageVector? = null
