...
public val SystemGroup.`Shield-cross-line`: ImageVector
    get() {
        if (`_shield-cross-line` != null) {
            return `_shield-cross-line`!!
        }
        `_shield-cross-line` = Builder(name = "Shield-cross-line", defaultWidth = 24.0.dp,
...
private var `_shield-cross-line`: ImageVector? = null
