...
public val BuildingsGroup.`Home-6-fill`: ImageVector
    get() {
        if (`_home-6-fill` != null) {
            return `_home-6-fill`!!
        }
        `_home-6-fill` = Builder(name = "Home-6-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_home-6-fill`: ImageVector? = null
