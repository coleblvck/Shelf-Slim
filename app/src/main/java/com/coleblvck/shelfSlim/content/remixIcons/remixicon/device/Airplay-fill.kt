...
public val DeviceGroup.`Airplay-fill`: ImageVector
    get() {
        if (`_airplay-fill` != null) {
            return `_airplay-fill`!!
        }
        `_airplay-fill` = Builder(name = "Airplay-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_airplay-fill`: ImageVector? = null
