...
public val DocumentGroup.`File-add-line`: ImageVector
    get() {
        if (`_file-add-line` != null) {
            return `_file-add-line`!!
        }
        `_file-add-line` = Builder(name = "File-add-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_file-add-line`: ImageVector? = null
