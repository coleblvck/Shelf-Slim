...
public val DeviceGroup.`Sd-card-fill`: ImageVector
    get() {
        if (`_sd-card-fill` != null) {
            return `_sd-card-fill`!!
        }
        `_sd-card-fill` = Builder(name = "Sd-card-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sd-card-fill`: ImageVector? = null
