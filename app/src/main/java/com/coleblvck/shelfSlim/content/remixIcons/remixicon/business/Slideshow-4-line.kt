...
public val BusinessGroup.`Slideshow-4-line`: ImageVector
    get() {
        if (`_slideshow-4-line` != null) {
            return `_slideshow-4-line`!!
        }
        `_slideshow-4-line` = Builder(name = "Slideshow-4-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(5.0f)
                horizontalLineTo(15.8293f)
                curveTo(15.4175f, 6.1652f, 14.3062f, 7.0f, 13.0f, 7.0f)
                horizontalLineTo(11.0f)
                curveTo(9.6938f, 7.0f, 8.5825f, 6.1652f, 8.1707f, 5.0f)
...
private var `_slideshow-4-line`: ImageVector? = null
