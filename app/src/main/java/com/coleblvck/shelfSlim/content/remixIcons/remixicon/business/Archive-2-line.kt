...
public val BusinessGroup.`Archive-2-line`: ImageVector
    get() {
        if (`_archive-2-line` != null) {
            return `_archive-2-line`!!
        }
        `_archive-2-line` = Builder(name = "Archive-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_archive-2-line`: ImageVector? = null
