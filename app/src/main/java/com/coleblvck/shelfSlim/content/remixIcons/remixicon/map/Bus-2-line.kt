...
public val MapGroup.`Bus-2-line`: ImageVector
    get() {
        if (`_bus-2-line` != null) {
            return `_bus-2-line`!!
        }
        `_bus-2-line` = Builder(name = "Bus-2-line", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bus-2-line`: ImageVector? = null
