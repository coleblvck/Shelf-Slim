...
public val DocumentGroup.`Folder-chart-line`: ImageVector
    get() {
        if (`_folder-chart-line` != null) {
            return `_folder-chart-line`!!
        }
        `_folder-chart-line` = Builder(name = "Folder-chart-line", defaultWidth = 24.0.dp,
...
private var `_folder-chart-line`: ImageVector? = null
