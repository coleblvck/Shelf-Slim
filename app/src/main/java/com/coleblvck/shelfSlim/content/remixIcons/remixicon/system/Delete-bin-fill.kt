...
public val SystemGroup.`Delete-bin-fill`: ImageVector
    get() {
        if (`_delete-bin-fill` != null) {
            return `_delete-bin-fill`!!
        }
        `_delete-bin-fill` = Builder(name = "Delete-bin-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_delete-bin-fill`: ImageVector? = null
