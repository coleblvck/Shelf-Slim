...
public val CommunicationGroup.`Chat-smile-2-line`: ImageVector
    get() {
        if (`_chat-smile-2-line` != null) {
            return `_chat-smile-2-line`!!
        }
        `_chat-smile-2-line` = Builder(name = "Chat-smile-2-line", defaultWidth = 24.0.dp,
...
private var `_chat-smile-2-line`: ImageVector? = null
