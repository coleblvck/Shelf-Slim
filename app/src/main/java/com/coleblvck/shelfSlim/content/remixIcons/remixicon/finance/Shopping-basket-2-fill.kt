...
public val FinanceGroup.`Shopping-basket-2-fill`: ImageVector
    get() {
        if (`_shopping-basket-2-fill` != null) {
            return `_shopping-basket-2-fill`!!
        }
        `_shopping-basket-2-fill` = Builder(name = "Shopping-basket-2-fill", defaultWidth = 24.0.dp,
...
private var `_shopping-basket-2-fill`: ImageVector? = null
