...
public val DocumentGroup.`File-4-line`: ImageVector
    get() {
        if (`_file-4-line` != null) {
            return `_file-4-line`!!
        }
        `_file-4-line` = Builder(name = "File-4-line", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.0f, 16.0f)
                lineTo(14.9968f, 22.0f)
...
private var `_file-4-line`: ImageVector? = null
