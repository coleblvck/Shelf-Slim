...
public val MapGroup.`Suitcase-2-line`: ImageVector
    get() {
        if (`_suitcase-2-line` != null) {
            return `_suitcase-2-line`!!
        }
        `_suitcase-2-line` = Builder(name = "Suitcase-2-line", defaultWidth = 24.0.dp, defaultHeight
...
private var `_suitcase-2-line`: ImageVector? = null
