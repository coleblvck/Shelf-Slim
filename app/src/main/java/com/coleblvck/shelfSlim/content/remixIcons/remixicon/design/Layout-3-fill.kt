...
public val DesignGroup.`Layout-3-fill`: ImageVector
    get() {
        if (`_layout-3-fill` != null) {
            return `_layout-3-fill`!!
        }
        `_layout-3-fill` = Builder(name = "Layout-3-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_layout-3-fill`: ImageVector? = null
