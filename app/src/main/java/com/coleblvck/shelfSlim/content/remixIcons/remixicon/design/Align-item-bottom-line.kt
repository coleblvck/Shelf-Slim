...
public val DesignGroup.`Align-item-bottom-line`: ImageVector
    get() {
        if (`_align-item-bottom-line` != null) {
            return `_align-item-bottom-line`!!
        }
        `_align-item-bottom-line` = Builder(name = "Align-item-bottom-line", defaultWidth = 24.0.dp,
...
private var `_align-item-bottom-line`: ImageVector? = null
