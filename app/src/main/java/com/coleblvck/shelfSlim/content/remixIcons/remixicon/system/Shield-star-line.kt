...
public val SystemGroup.`Shield-star-line`: ImageVector
    get() {
        if (`_shield-star-line` != null) {
            return `_shield-star-line`!!
        }
        `_shield-star-line` = Builder(name = "Shield-star-line", defaultWidth = 24.0.dp,
...
private var `_shield-star-line`: ImageVector? = null
