...
public val DevelopmentGroup.`Git-close-pull-request-line`: ImageVector
    get() {
        if (`_git-close-pull-request-line` != null) {
            return `_git-close-pull-request-line`!!
        }
        `_git-close-pull-request-line` = Builder(name = "Git-close-pull-request-line", defaultWidth
...
private var `_git-close-pull-request-line`: ImageVector? = null
