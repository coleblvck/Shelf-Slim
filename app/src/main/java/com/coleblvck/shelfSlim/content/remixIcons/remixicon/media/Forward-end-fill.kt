...
public val MediaGroup.`Forward-end-fill`: ImageVector
    get() {
        if (`_forward-end-fill` != null) {
            return `_forward-end-fill`!!
        }
        `_forward-end-fill` = Builder(name = "Forward-end-fill", defaultWidth = 24.0.dp,
...
private var `_forward-end-fill`: ImageVector? = null
