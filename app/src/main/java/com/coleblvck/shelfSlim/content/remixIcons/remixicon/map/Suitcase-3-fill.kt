...
public val MapGroup.`Suitcase-3-fill`: ImageVector
    get() {
        if (`_suitcase-3-fill` != null) {
            return `_suitcase-3-fill`!!
        }
        `_suitcase-3-fill` = Builder(name = "Suitcase-3-fill", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(15.0f, 1.0f)
                curveTo(15.5523f, 1.0f, 16.0f, 1.4477f, 16.0f, 2.0f)
                verticalLineTo(7.0f)
...
private var `_suitcase-3-fill`: ImageVector? = null
