...
public val MediaGroup.`Stop-large-fill`: ImageVector
    get() {
        if (`_stop-large-fill` != null) {
            return `_stop-large-fill`!!
        }
        `_stop-large-fill` = Builder(name = "Stop-large-fill", defaultWidth = 24.0.dp, defaultHeight
...
private var `_stop-large-fill`: ImageVector? = null
