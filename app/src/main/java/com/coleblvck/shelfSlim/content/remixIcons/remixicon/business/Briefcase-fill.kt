...
public val BusinessGroup.`Briefcase-fill`: ImageVector
    get() {
        if (`_briefcase-fill` != null) {
            return `_briefcase-fill`!!
        }
        `_briefcase-fill` = Builder(name = "Briefcase-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_briefcase-fill`: ImageVector? = null
