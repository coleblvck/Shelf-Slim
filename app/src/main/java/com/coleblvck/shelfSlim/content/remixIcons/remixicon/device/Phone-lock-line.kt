...
public val DeviceGroup.`Phone-lock-line`: ImageVector
    get() {
        if (`_phone-lock-line` != null) {
            return `_phone-lock-line`!!
        }
        `_phone-lock-line` = Builder(name = "Phone-lock-line", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.0f, 14.0f)
                curveTo(17.4919f, 14.0f, 17.0f, 14.45f, 17.0f, 15.0f)
                verticalLineTo(16.0f)
...
private var `_phone-lock-line`: ImageVector? = null
