...
public val FinanceGroup.`Coupon-2-fill`: ImageVector
    get() {
        if (`_coupon-2-fill` != null) {
            return `_coupon-2-fill`!!
        }
        `_coupon-2-fill` = Builder(name = "Coupon-2-fill", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(14.0049f, 2.9997f)
...
private var `_coupon-2-fill`: ImageVector? = null
