...
public val OthersGroup.`Weight-fill`: ImageVector
    get() {
        if (`_weight-fill` != null) {
            return `_weight-fill`!!
        }
        `_weight-fill` = Builder(name = "Weight-fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_weight-fill`: ImageVector? = null
