...
public val BusinessGroup.`Archive-stack-fill`: ImageVector
    get() {
        if (`_archive-stack-fill` != null) {
            return `_archive-stack-fill`!!
        }
        `_archive-stack-fill` = Builder(name = "Archive-stack-fill", defaultWidth = 24.0.dp,
...
private var `_archive-stack-fill`: ImageVector? = null
