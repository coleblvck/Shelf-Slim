...
public val HealthGroup.`Surgical-mask-line`: ImageVector
    get() {
        if (`_surgical-mask-line` != null) {
            return `_surgical-mask-line`!!
        }
        `_surgical-mask-line` = Builder(name = "Surgical-mask-line", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 5.0615f)
                lineTo(5.0f, 6.8115f)
                verticalLineTo(12.7918f)
                curveTo(5.0f, 14.3069f, 5.856f, 15.6919f, 7.2112f, 16.3695f)
                lineTo(12.0f, 18.7639f)
                lineTo(16.7889f, 16.3695f)
                curveTo(18.144f, 15.6919f, 19.0f, 14.3069f, 19.0f, 12.7918f)
                verticalLineTo(6.8115f)
                lineTo(12.0f, 5.0615f)
                close()
                moveTo(3.0f, 9.0f)
...
private var `_surgical-mask-line`: ImageVector? = null
