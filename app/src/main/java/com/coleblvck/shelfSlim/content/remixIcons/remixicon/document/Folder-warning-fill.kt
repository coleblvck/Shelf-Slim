...
public val DocumentGroup.`Folder-warning-fill`: ImageVector
    get() {
        if (`_folder-warning-fill` != null) {
            return `_folder-warning-fill`!!
        }
        `_folder-warning-fill` = Builder(name = "Folder-warning-fill", defaultWidth = 24.0.dp,
...
private var `_folder-warning-fill`: ImageVector? = null
